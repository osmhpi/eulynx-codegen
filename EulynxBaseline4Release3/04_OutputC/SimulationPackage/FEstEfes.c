...
{
    self->D52outEstEfesInitSubstate.Value = FEstEfes_D52outEstEfesInitSubstateValue__Unknown;
...
void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(
    FEstEfes *self, FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct *x)
{
    ...
    if (self->D20inConMdmUsed.Value)
    {
        ...
        self->D52outEstEfesInitSubstate.Value = FEstEfes_D52outEstEfesInitSubstateValue__WaitingForDataUpdate;
        self->D52outEstEfesInitSubstate.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(self, x);
        return;
    }
    if (!(self->D20inConMdmUsed.Value))
    {
        ...
        self->D52outEstEfesInitSubstate.Value = FEstEfes_D52outEstEfesInitSubstateValue__WaitingForPdiOrMaintenance;
        self->D52outEstEfesInitSubstate.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance(self,
                                                                                                                  x);
        return;
    }
}
...
void make_state_FEstEfes__root__OperatingVoltageSupplied__root(
    FEstEfes *self, FEstEfes__root__OperatingVoltageSupplied__root__state_struct *x)
{
...
void make_state_FEstEfes__root(FEstEfes *self, FEstEfes__root__state_struct *x)
{
    ...
    Cop1Init(self);
    self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__NoOperatingVoltage;
    self->D51outEstEfesState.IsSignalled = true;
    ...
    FEstEfes *self, FEstEfes__root__state_struct *x)
{
    ...
    {
        self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__Operational;
        self->D51outEstEfesState.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__Operational(self, &x->OperatingVoltageSupplied.root);
        return;
    }
    ...
    FEstEfes *self, FEstEfes__root__state_struct *x)
{
    ...
    {
        self->D52outEstEfesInitSubstate.Value = FEstEfes_D52outEstEfesInitSubstateValue__WaitingForPdi;
        self->D52outEstEfesInitSubstate.IsSignalled = true;
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(FEstEfes *self,
                                                                                        FEstEfes__root__state_struct *x)
{
    ...
    case FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate:
        transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(self,
                                                                                                                 x);
        break;
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Booting(FEstEfes *self,
                                                                             FEstEfes__root__state_struct *x)
{

    if (self->Change1191.IsTriggered)
    {
        self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__Initialising;
        self->D51outEstEfesState.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(self,
                                                                                &x->OperatingVoltageSupplied.root);
        return;
    }
    if (self->Change1226.IsTriggered)
    {
        self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__FallbackMode;
        self->D51outEstEfesState.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode(self,
                                                                                &x->OperatingVoltageSupplied.root);
        return;
    }
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Operational(FEstEfes *self,
                                                                                 FEstEfes__root__state_struct *x)
{
    ...
    if (self->Change1143.IsTriggered)
    {
        ...
        self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__Booting;
        self->D51outEstEfesState.IsSignalled = true;
        make_state_FEstEfes__root__OperatingVoltageSupplied__root__Booting(self, &x->OperatingVoltageSupplied.root);
        return;
    }
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode(FEstEfes *self,
                                                                                  FEstEfes__root__state_struct *x)
{
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(FEstEfes *self,
                                                                                  FEstEfes__root__state_struct *x)
{
