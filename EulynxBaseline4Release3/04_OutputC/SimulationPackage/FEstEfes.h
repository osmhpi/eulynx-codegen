...
typedef struct FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct
{
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state state;
    union {
    };
...
typedef struct FEstEfes__root__OperatingVoltageSupplied__root__Initialising__state_struct
{
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct root;
...
typedef struct FEstEfes__root__OperatingVoltageSupplied__root__state_struct
{
    ...
    union {
        FEstEfes__root__OperatingVoltageSupplied__root__Initialising__state_struct Initialising;
    };
...
typedef struct FEstEfes__root__state_struct
{
    ...
    union {
        FEstEfes__root__OperatingVoltageSupplied__state_struct OperatingVoltageSupplied;
    };
...
typedef struct FEstEfes
{
    ...
    MessagePort(Message__PdiConnectionEstablished__4cbf) InPdiConnectionEstablished__4cbf;
    MessagePort(Message__PdiReleasedForMaintenance__3f7c) InPdiReleasedForMaintenance__3f7c;
    MessagePort(Message__MdmCommandedMaintenance__a992) InMdmCommandedMaintenance__a992;
    ...
    // Messages -- Outgoing
    MessagePort(Message__EstReadyForMaintenance__dd9a) OutEstReadyForMaintenance__dd9a;
    MessagePort(Message__NotreadyForPdiConnection__0b73) OutNotreadyForPdiConnection__0b73;
    MessagePort(Message__ReadyForPdiConnection__6bd3) OutReadyForPdiConnection__6bd3;
