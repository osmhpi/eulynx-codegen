...
typedef struct Hilfsblock {
  ...
  MessagePort(Message__MdmCommandedMaintenance__a992)
      OutMdmCommandedMaintenance__a992;
  ...
  // Change Events
  ChangeEvent Change517; // HilfFinished_Data_Update
  ChangeEvent Change518; // HilfMDM_Maintenance_Commanded
  ChangeEvent Change519; // HilfMDM_Reboot_Required
  ChangeEvent Change520; // HilfMDM_Triggered_Reset
  ChangeEvent Change521; // HilfStatus_Update_Completed
