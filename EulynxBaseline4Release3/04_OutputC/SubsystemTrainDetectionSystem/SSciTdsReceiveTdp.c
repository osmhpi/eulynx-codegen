...
void make_state_SSciTdsReceiveTdp__root__ReceivingTdpReports(
    SSciTdsReceiveTdp *self, SSciTdsReceiveTdp__root__state_struct *region) {
...
void make_state_SSciTdsReceiveTdp__root(
    SSciTdsReceiveTdp *self, SSciTdsReceiveTdp__root__state_struct *x) {
...
void transition_from_SSciTdsReceiveTdp__root__ReceivingTdpReports(
    SSciTdsReceiveTdp *self, SSciTdsReceiveTdp__root__state_struct *x) {

  if (self->InMsgTdpStatus__b6d9.HasMessage) {
    if ((self->InMsgTdpStatus__b6d9.Value.ReportedStateOfPassing ==
...
void transition_from_SSciTdsReceiveTdp__root(
    SSciTdsReceiveTdp *self, SSciTdsReceiveTdp__root__state_struct *x) {
  switch (x->state) {
