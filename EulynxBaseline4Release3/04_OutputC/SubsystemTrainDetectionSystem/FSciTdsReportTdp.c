...
void make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root(
  ...
  if (self->D54intReportedTdpDirection.Value ==
    ...
    self->OutMsgTdpStatus__b6d9.Value.ReportedStateOfPassing =
  ...
  if (self->D54intReportedTdpDirection.Value ==
    ...
    self->OutMsgTdpStatus__b6d9.HasMessage = 1;
    make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__WithoutDirection(
        self, x);
    return;
  }
}
...
void make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Waiting(
    FSciTdsReportTdp *self,
    FSciTdsReportTdp__root__ReportingTdpStatus__root__state_struct *region) {
...
void make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed(
  ...
  make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root(
      self, &region->Passed.root);
};
...
void make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root(
    FSciTdsReportTdp *self,
    FSciTdsReportTdp__root__ReportingTdpStatus__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(FSciTdsReportTdp__root__ReportingTdpStatus__root__state_struct));

  make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Waiting(self, x);
  return;
}

void make_state_FSciTdsReportTdp__root__ReportingTdpStatus(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *region) {
  ...
  make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root(
      self, &region->ReportingTdpStatus.root);
};

void make_state_FSciTdsReportTdp__root(
...
void transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root(
  ...
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__InRefenceDirection:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__InRefenceDirection(
        self, x);
    break;
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__AgainstRefenceDirection:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__AgainstRefenceDirection(
        self, x);
    break;
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__WithoutDirection:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root__WithoutDirection(
        self, x);
    break;
  }
}

void transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Waiting(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *x) {

  if (self->InStartStatusReport__1e4e.HasMessage) {

    if (self->D53inReportedTdpStatus.Value ==
      ...
      self->OutMsgTdpStatus__b6d9.Value.ReportedDirectionOfPassing =
          DirectionOfPassing__a7c9__WithoutIndicatedDirection;
      self->OutMsgTdpStatus__b6d9.HasMessage = 1;
      make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__NotPassed(
          self, &x->ReportingTdpStatus.root);
      return;
    }
    if (self->D53inReportedTdpStatus.Value ==
        FSciTdsReportTdp_D53inReportedTdpStatusValue__Passed) {

      make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed(
          self, &x->ReportingTdpStatus.root);
      return;
    } else {
      ...
      self->OutMsgTdpStatus__b6d9.Value.ReportedDirectionOfPassing =
          DirectionOfPassing__a7c9__WithoutIndicatedDirection;
      self->OutMsgTdpStatus__b6d9.HasMessage = 1;
      make_state_FSciTdsReportTdp__root__ReportingTdpStatus__root__Disturbed(
          self, &x->ReportingTdpStatus.root);
      return;
    }
  }
...
void transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *x) {
  transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed__root(
      self, x);
...
void transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *x) {
  switch (x->ReportingTdpStatus.root.state) {
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Waiting:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Waiting(
        self, x);
    break;
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__NotPassed:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__NotPassed(
        self, x);
    break;
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Passed(
        self, x);
    break;
  case FSciTdsReportTdp__root__ReportingTdpStatus__root__Disturbed:
    transition_from_FSciTdsReportTdp__root__ReportingTdpStatus__root__Disturbed(
        self, x);
    break;
  }
}

void transition_from_FSciTdsReportTdp__root__ReportingTdpStatus(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *x) {
...
void transition_from_FSciTdsReportTdp__root(
    FSciTdsReportTdp *self, FSciTdsReportTdp__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FSciTdsReportTdp *self) {
  self->Change412.IsTriggered = IsTriggered(MakeChange(
      self->D54intReportedTdpDirection.IsSignalled,
      self->D54intReportedTdpDirection.Value ==
          FSciTdsReportTdp_D54intReportedTdpDirectionValue__AgainstReferenceDirection));
  self->Change413.IsTriggered = IsTriggered(MakeChange(
      self->D54intReportedTdpDirection.IsSignalled,
      self->D54intReportedTdpDirection.Value ==
          FSciTdsReportTdp_D54intReportedTdpDirectionValue__ReferenceDirection));
  self->Change408.IsTriggered = IsTriggered(
      MakeChange(self->D53inReportedTdpStatus.IsSignalled,
                 self->D53inReportedTdpStatus.Value ==
                     FSciTdsReportTdp_D53inReportedTdpStatusValue__Passed));
  self->Change410.IsTriggered = IsTriggered(MakeChange(
      self->D53inReportedTdpStatus.IsSignalled,
      self->D53inReportedTdpStatus.Value ==
          FSciTdsReportTdp_D53inReportedTdpStatusValue__TdpDisturbed));
  self->Change406.IsTriggered = IsTriggered(
      MakeChange(self->D53inReportedTdpStatus.IsSignalled,
                 self->D53inReportedTdpStatus.Value ==
                     FSciTdsReportTdp_D53inReportedTdpStatusValue__NotPassed));
  self->Change409.IsTriggered = IsTriggered(MakeChange(
      self->D53inReportedTdpStatus.IsSignalled,
      self->D53inReportedTdpStatus.Value ==
          FSciTdsReportTdp_D53inReportedTdpStatusValue__TdpDisturbed));
  self->Change405.IsTriggered = IsTriggered(
      MakeChange(self->D53inReportedTdpStatus.IsSignalled,
                 self->D53inReportedTdpStatus.Value ==
                     FSciTdsReportTdp_D53inReportedTdpStatusValue__NotPassed));
  self->Change407.IsTriggered = IsTriggered(
      MakeChange(self->D53inReportedTdpStatus.IsSignalled,
                 self->D53inReportedTdpStatus.Value ==
                     FSciTdsReportTdp_D53inReportedTdpStatusValue__Passed));
  self->Change314.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
