...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__state_struct
        *region) {
  LOG("[FSciTdsReportTrackCircuit] Entering state WithoutPom in region "
      "root__ReportingOccupancyStatus__root__Vacant__root");
  region->state =
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root(
  ...
  if (self->D47inReportPomStatus.Value ==
      FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyNok) {

    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedOccupancyStatus =
        OccupancyStatus__65fa__Vacant;
    self->OutMsgTvpsOccupancyStatus__b4e1.Value
        .ReportedAbilityToBeForcedToClear =
        AbilityToBeForcedToClear__8b12__NotAble;
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedpomStatus =
        PomStatus__d74a__Nok;
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.FillingLevel = 0;
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedDisturbanceStatus =
        DisturbanceStatus__fd65__NotApplicable;
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedChangeTrigger =
  ...
  if (self->D47inReportPomStatus.Value ==
    ...
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedChangeTrigger =
        ChangeTrigger__de2d__NotApplicable;
    self->OutMsgTvpsOccupancyStatus__b4e1.HasMessage = 1;
    make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__WithoutPom(
        self, x);
    return;
  }
}
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__state_struct
        *region) {
  LOG("[FSciTdsReportTrackCircuit] Entering state WithoutPom in region "
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root(
  ...
  if (self->D47inReportPomStatus.Value ==
    ...
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedChangeTrigger =
        ChangeTrigger__de2d__NotApplicable;
    self->OutMsgTvpsOccupancyStatus__b4e1.HasMessage = 1;
    make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__WithoutPom(
        self, x);
    return;
  }
}
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__state_struct
        *region) {
  LOG("[FSciTdsReportTrackCircuit] Entering state WithoutPom in region "
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root(
  ...
  if (self->D47inReportPomStatus.Value ==
    ...
    self->OutMsgTvpsOccupancyStatus__b4e1.Value.ReportedChangeTrigger =
        ChangeTrigger__de2d__TechnicalFailure;
    self->OutMsgTvpsOccupancyStatus__b4e1.HasMessage = 1;
    make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__WithoutPom(
        self, x);
    return;
  }
}
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant(
  ...
  make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root(
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied(
  ...
  make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root(
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root(
  ...
  make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Waiting(
      self, x);
  return;
}
...
void make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *region) {
  ...
  make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root(
      self, &region->ReportingOccupancyStatus.root);
};

void make_state_FSciTdsReportTrackCircuit__root(
    FSciTdsReportTrackCircuit *self,
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root(
  ...
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__PomOk:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__PomOk(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__PomNok:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__PomNok(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__WithoutPom:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root__WithoutPom(
        self, x);
    break;
  }
}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root(
  ...
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__PomNok:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__PomNok(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__PomOk:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__PomOk(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__WithoutPom:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root__WithoutPom(
        self, x);
    break;
  }
}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__WithoutPom(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root(
  ...
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__PomOk:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__PomOk(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__PomNok:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__PomNok(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__WithoutPom:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root__WithoutPom(
        self, x);
    break;
  }
}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {
  transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant__root(
      self, x);
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {
  transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied__root(
      self, x);
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {
  transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed__root(
      self, x);
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root(
  ...
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Waiting:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Waiting(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Vacant(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Occupied(
        self, x);
    break;
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root__Disturbed(
        self, x);
    break;
  }
}
...
void transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {
  transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus__root(
      self, x);
  if (self->Change310.IsTriggered) {

    make_state_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus(self,
                                                                         x);
    return;
  }
}

void transition_from_FSciTdsReportTrackCircuit__root(
    FSciTdsReportTrackCircuit *self,
    FSciTdsReportTrackCircuit__root__state_struct *x) {
  switch (x->state) {
  case FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus:
    transition_from_FSciTdsReportTrackCircuit__root__ReportingOccupancyStatus(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(FSciTdsReportTrackCircuit *self) {
  self->Change270.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyNok));
  self->Change273.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyOk));
  self->Change274.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyOk));
  self->Change271.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyNok));
  self->Change272.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyNok));
  self->Change275.IsTriggered = IsTriggered(MakeChange(
      self->D47inReportPomStatus.IsSignalled,
      self->D47inReportPomStatus.Value ==
          FSciTdsReportTrackCircuit_D47inReportPomStatusValue__PowerSupplyOk));
  self->Change265.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateOccupied));
  self->Change267.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateDisturbed));
  self->Change268.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateDisturbed));
  self->Change269.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateVacant));
  self->Change266.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateOccupied));
  self->Change264.IsTriggered = IsTriggered(MakeChange(
      self->D45inReportedTvpsOccupancyStatus.IsSignalled,
      self->D45inReportedTvpsOccupancyStatus.Value ==
          FSciTdsReportTrackCircuit_D45inReportedTvpsOccupancyStatusValue__TvpsIsInStateVacant));
  self->Change310.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
