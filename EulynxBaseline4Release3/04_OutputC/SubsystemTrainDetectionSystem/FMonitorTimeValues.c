...
void make_state_FMonitorTimeValues__root__MonitorTimeValues__root(
    FMonitorTimeValues *self, FMonitorTimeValues__root__MonitorTimeValues__root__state_struct *x)
{
    memset(x, 0, sizeof(FMonitorTimeValues__root__MonitorTimeValues__root__state_struct));

    make_state_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(self, x);
    return;
}
    ...
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x)
{
    ...
    if (self->Time20.IsTimeoutExpired)
    {
        ...
        make_state_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(self, &x->MonitorTimeValues.root);
        return;
    }
    ...
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x)
{
    ...
    if (self->Change1101.IsTriggered)
    {
        ...
        make_state_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorInhibitionTime(self,
                                                                                            &x->MonitorTimeValues.root);
        return;
    }
}

void transition_from_FMonitorTimeValues__root__MonitorTimeValues__root(FMonitorTimeValues *self,
...
{
    self->Change120.IsTriggered =
        IsTriggered(MakeChange(self->D16inLastWheelOut.IsSignalled, self->D16inLastWheelOut.Value));
    ...
    self->Change391.IsTriggered = IsTriggered(OrChange(
        MakeChange(self->D51outEstEfesState.IsSignalled,
                   self->D51outEstEfesState.Value == FMonitorTimeValues_D51outEstEfesStateValue__Booting),
        MakeChange(self->D51outEstEfesState.IsSignalled,
                   self->D51outEstEfesState.Value == FMonitorTimeValues_D51outEstEfesStateValue__NoOperatingVoltage)));
    self->Change392.IsTriggered = IsTriggered(
        MakeChange(self->D51outEstEfesState.IsSignalled,
                   self->D51outEstEfesState.Value == FMonitorTimeValues_D51outEstEfesStateValue__FallbackMode));
    self->Change402.IsTriggered = IsTriggered(
        MakeChange(self->D51outEstEfesState.IsSignalled,
                   self->D51outEstEfesState.Value == FMonitorTimeValues_D51outEstEfesStateValue__Initialising));
    self->Change386.IsTriggered =
...
#ifdef KLEE_ENABLED
#include "../../05_OutputKleeAnalysis/SubsystemTrainDetectionSystem/FMonitorTimeValues.c"
#endif
