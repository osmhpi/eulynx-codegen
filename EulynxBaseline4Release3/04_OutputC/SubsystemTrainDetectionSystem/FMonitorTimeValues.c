...
void make_state_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(
    FMonitorTimeValues *self,
    FMonitorTimeValues__root__MonitorTimeValues__root__state_struct *region) {
...
void make_state_FMonitorTimeValues__root__MonitorTimeValues__root(
    FMonitorTimeValues *self,
    FMonitorTimeValues__root__MonitorTimeValues__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(FMonitorTimeValues__root__MonitorTimeValues__root__state_struct));

  make_state_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(
      self, x);
  return;
}

void make_state_FMonitorTimeValues__root__MonitorTimeValues(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *region) {
  ...
  make_state_FMonitorTimeValues__root__MonitorTimeValues__root(
      self, &region->MonitorTimeValues.root);
};

void make_state_FMonitorTimeValues__root__WaitingForFinishBooting(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *region) {
...
void make_state_FMonitorTimeValues__root__FallbackMode(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *region) {
  LOG("[FMonitorTimeValues] Entering state FallbackMode in region root");
  region->state = FMonitorTimeValues__root__FallbackMode;
};

void make_state_FMonitorTimeValues__root__TechnicalDisturbance(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *region) {
...
void make_state_FMonitorTimeValues__root(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  memset(x, 0, sizeof(FMonitorTimeValues__root__state_struct));

  make_state_FMonitorTimeValues__root__WaitingForFinishBooting(self, x);
  return;
}

void transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  ...
  if (self->Change120.IsTriggered) {
    if (self->D28inConTDelayOfNotificationOfAvailability.Value != 0) {
      ...
      make_state_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorNotificationOfAvailability(
          self, &x->MonitorTimeValues.root);
      return;
    }
  }
  if (self->Change1102.IsTriggered) {
    if ((!(self->D16inLastWheelOut.Value)) &&
        (self->D29inConTInhibitionTime.Value != 0)) {
      self->D14outMonitoringTime.Value = true;
      make_state_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorInhibitionTime(
          self, &x->MonitorTimeValues.root);
      return;
    }
  }
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorInhibitionTime(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorNotificationOfAvailability(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__root(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  switch (x->MonitorTimeValues.root.state) {
  case FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__NoMonitoring(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__root__MonitorInhibitionTime:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorInhibitionTime(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__root__MonitorNotificationOfAvailability:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__root__MonitorNotificationOfAvailability(
        self, x);
    break;
  }
}

void transition_from_FMonitorTimeValues__root__MonitorTimeValues(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  transition_from_FMonitorTimeValues__root__MonitorTimeValues__root(self, x);
  if (self->Change233.IsTriggered) {
    self->D14outMonitoringTime.Value = false;
    make_state_FMonitorTimeValues__root__TechnicalDisturbance(self, x);
    return;
  }
  ...
  if (self->Change392.IsTriggered) {
    self->D14outMonitoringTime.Value = false;
    make_state_FMonitorTimeValues__root__FallbackMode(self, x);
    return;
  }
}

void transition_from_FMonitorTimeValues__root__WaitingForFinishBooting(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
...
void transition_from_FMonitorTimeValues__root__FallbackMode(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
...
void transition_from_FMonitorTimeValues__root__TechnicalDisturbance(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
...
void transition_from_FMonitorTimeValues__root(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FMonitorTimeValues *self) {
  self->Change120.IsTriggered = IsTriggered(MakeChange(
      self->D16inLastWheelOut.IsSignalled, self->D16inLastWheelOut.Value));
  self->Change1102.IsTriggered = IsTriggered(
      OrChange(OrChange(MakeChange(self->T37inWheelIn.IsTriggered,
                                   self->T37inWheelIn.IsTriggered),
                        MakeChange(self->T38inWheelOut.IsTriggered,
                                   self->T38inWheelOut.IsTriggered)),
               MakeChange(self->T39inUndefinedPattern.IsTriggered,
                          self->T39inUndefinedPattern.IsTriggered)));
  self->Change119.IsTriggered = IsTriggered(MakeChange(
      self->D16inLastWheelOut.IsSignalled, self->D16inLastWheelOut.Value));
  self->Change1100.IsTriggered = IsTriggered(
      OrChange(OrChange(MakeChange(self->T37inWheelIn.IsTriggered,
                                   self->T37inWheelIn.IsTriggered),
                        MakeChange(self->T38inWheelOut.IsTriggered,
                                   self->T38inWheelOut.IsTriggered)),
               MakeChange(self->T39inUndefinedPattern.IsTriggered,
                          self->T39inUndefinedPattern.IsTriggered)));
  self->Change1101.IsTriggered = IsTriggered(
      OrChange(OrChange(MakeChange(self->T37inWheelIn.IsTriggered,
                                   self->T37inWheelIn.IsTriggered),
                        MakeChange(self->T38inWheelOut.IsTriggered,
                                   self->T38inWheelOut.IsTriggered)),
  ...
  self->Change392.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
  ...
  self->Change386.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FMonitorTimeValues_D51outEstEfesStateValue__Booting));
  self->Change396.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FMonitorTimeValues_D51outEstEfesStateValue__FallbackMode));
  self->Change562.IsTriggered = IsTriggered(
