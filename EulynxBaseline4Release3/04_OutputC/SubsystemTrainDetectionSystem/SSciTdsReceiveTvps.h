...
typedef struct SSciTdsReceiveTvps
{
    ...
    DataPort(SSciTdsReceiveTvps_D75outOccupancyStatusValue, ) D75outOccupancyStatus;
    ...
    /// Trigger: False, DataPort: True, In: False, Out: True, External: False
    DataPort(SSciTdsReceiveTvps_D75outReasonForFailureValue, ) D75outReasonForFailure;
    ...
    /// Trigger: False, DataPort: True, In: False, Out: True, External: False
    DataPort(SSciTdsReceiveTvps_D84outCommandRejectedValue, ) D84outCommandRejected;
