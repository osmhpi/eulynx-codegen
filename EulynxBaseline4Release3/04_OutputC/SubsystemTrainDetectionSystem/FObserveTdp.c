...
void make_state_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
    ...
    FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__state_struct
        *region)
{
    LOG("[FObserveTdp] Entering state WaitingDelayOfNotificationOfUndefinedPattern in region "
        "root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root");
    region->state =
    ...
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    if (self->Change1238.IsTriggered)
    {
        ...
        make_state_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
            self, &x->NotFailed.root.Operational.root.TdpWithDirection.root.MonitoringTdpWithDirection.root);
        return;
    }
}
...
void transition_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    case FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUndefinedPattern:
        transition_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
            self, x);
        break;
    }
}
    ...
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    if (self->Change1239.IsTriggered)
    {
        ...
        make_state_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
            self, &x->NotFailed.root.Operational.root.TdpWithoutDirection.root.MonitoringTdpWithoutDirection.root);
        return;
    }
}
...
void transition_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    case FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUndefinedPattern:
        transition_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUndefinedPattern(
            self, x);
        break;
    }
}
...
static void evaluateChangeEvents(FObserveTdp *self)
{
    ...
    self->Change426.IsTriggered = IsTriggered(
    ...
    self->Change1236.IsTriggered = IsTriggered(OrChange(
    ...
    self->Change424.IsTriggered =
        IsTriggered(MakeChange(self->D63inCriticalFailureTdp.IsSignalled, self->D63inCriticalFailureTdp.Value));
    self->Change427.IsTriggered = IsTriggered(
        MakeChange(self->D63inCriticalFailureTdp.IsSignalled, self->D63inCriticalFailureTdp.Value == false));
    self->Change401.IsTriggered =
