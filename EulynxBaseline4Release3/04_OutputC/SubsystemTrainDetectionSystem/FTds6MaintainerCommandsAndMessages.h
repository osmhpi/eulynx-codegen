...
typedef struct FTds6MaintainerCommandsAndMessages
{
    ...
    DataPort(FTds6MaintainerCommandsAndMessages_D35inModeOfFcValue, ) D35inModeOfFc;
    ...
    DataPort(FTds6MaintainerCommandsAndMessages_D36outCommandRejectedValue, ) D36outCommandRejected;
    ...
    // Messages -- Incoming
    MessagePort(Message__ReportCommandRejected__fa56) InReportCommandRejected__fa56;
    // Messages -- Outgoing
    ...
    MessagePort(Message__RequestVisualSweepingConfirmation__2333) OutRequestVisualSweepingConfirmation__2333;

    // Change Events
    ChangeEvent Change1089; // T34in_DRFC
    ChangeEvent Change1091; // T35in_FC
    ChangeEvent Change1090; // T35in_FC
    ChangeEvent Change1151; // T41in_Visual_Sweeping_Confirmed
