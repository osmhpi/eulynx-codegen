...
static void Cop1InitialReportStatus(FSciLsReport *self) {
  if (self->D19inObservedSignalAspect.Value ==
  ...
  } else if (self->D19inObservedSignalAspect.Value ==
  ...
  if (self->D21inObservedLuminosity.Value ==
      FSciLsReport_D21inObservedLuminosityValue__Day) {

    self->OutMsgSetLuminosity__c2b4.Value.ReportedLuminosityState =
        LuminosityState__20ae__Day;
    self->OutMsgSetLuminosity__c2b4.HasMessage = 1;
  } else if (self->D21inObservedLuminosity.Value ==
...
void make_state_FSciLsReport__root__SendingLightSignalReports(
    FSciLsReport *self, FSciLsReport__root__state_struct *region) {
...
void make_state_FSciLsReport__root__InterfaceConnectionNotEstablished(
    FSciLsReport *self, FSciLsReport__root__state_struct *region) {
...
void make_state_FSciLsReport__root(FSciLsReport *self,
...
void transition_from_FSciLsReport__root__SendingLightSignalReports(
    FSciLsReport *self, FSciLsReport__root__state_struct *x) {
  transition_from_FSciLsReport__root__SendingLightSignalReports__ReportingSignalAspect(
      self, x);
  transition_from_FSciLsReport__root__SendingLightSignalReports__ReportingLuminosity(
      self, x);
...
void transition_from_FSciLsReport__root__InterfaceConnectionNotEstablished(
    FSciLsReport *self, FSciLsReport__root__state_struct *x) {
...
void transition_from_FSciLsReport__root(FSciLsReport *self,
                                        FSciLsReport__root__state_struct *x) {
  switch (x->state) {
  ...
  case FSciLsReport__root__InterfaceConnectionNotEstablished:
    transition_from_FSciLsReport__root__InterfaceConnectionNotEstablished(self,
                                                                          x);
    break;
  }
}
...
static void evaluateChangeEvents(FSciLsReport *self) {
  self->Change132.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D19inObservedSignalAspect.Value ==
          FSciLsReport_D19inObservedSignalAspectValue__MostRestrictAspect));
  ...
  self->Change169.IsTriggered =
      IsTriggered(MakeChange(self->D20inObservedIntentionallyDark.IsSignalled,
                             self->D20inObservedIntentionallyDark.Value));
  self->Change168.IsTriggered =
      IsTriggered(MakeChange(self->D20inObservedIntentionallyDark.IsSignalled,
                             self->D20inObservedIntentionallyDark.Value));
  self->Change170.IsTriggered =
      IsTriggered(MakeChange(self->D20inObservedIntentionallyDark.IsSignalled,
                             self->D20inObservedIntentionallyDark.Value));
  ...
  self->Change300.IsTriggered = IsTriggered(
      MakeChange(self->D50inPdiConnectionState.IsSignalled,
                 self->D50inPdiConnectionState.Value ==
                     FSciLsReport_D50inPdiConnectionStateValue__Established));
  self->Change554.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D20inObservedIntentionallyDark.IsSignalled,
                              self->D20inObservedIntentionallyDark.Value)));
  self->Change556.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D20inObservedIntentionallyDark.IsSignalled,
                              self->D20inObservedIntentionallyDark.Value)));
  ...
  self->Change171.IsTriggered = IsTriggered(
      MakeChange(self->D21inObservedLuminosity.IsSignalled,
                 self->D21inObservedLuminosity.Value ==
                     FSciLsReport_D21inObservedLuminosityValue__Day));
