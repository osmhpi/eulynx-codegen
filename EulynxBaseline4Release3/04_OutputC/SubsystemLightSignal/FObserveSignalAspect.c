...
void make_state_FObserveSignalAspect__root__ObservingSignalAspect__root(
  ...
  if (self->D7inSensedSignalAspect.Value ==
    ...
    self->D20outObservedIntentionallyDark.Value =
        self->D8inSensedIntentionallyDark.Value;
...
static void evaluateChangeEvents(FObserveSignalAspect *self) {
  self->Change450.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D7inSensedSignalAspect.Value ==
          FObserveSignalAspect_D7inSensedSignalAspectValue__MostRestrictAspect));
  self->Change454.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D7inSensedSignalAspect.IsSignalled,
          self->D7inSensedSignalAspect.Value ==
              FObserveSignalAspect_D7inSensedSignalAspectValue__NoSignalAspectLampFailure),
  ...
  self->Change486.IsTriggered =
      IsTriggered(MakeChange(self->D8inSensedIntentionallyDark.IsSignalled,
                             self->D8inSensedIntentionallyDark.Value));
  self->Change580.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D8inSensedIntentionallyDark.IsSignalled,
                              self->D8inSensedIntentionallyDark.Value)));
  ...
  self->Change451.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D7inSensedSignalAspect.Value ==
          FObserveSignalAspect_D7inSensedSignalAspectValue__MostRestrictAspect));
  self->Change455.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D7inSensedSignalAspect.IsSignalled,
          self->D7inSensedSignalAspect.Value ==
              FObserveSignalAspect_D7inSensedSignalAspectValue__NoSignalAspectLampFailure),
      MakeChange(
          ...
          self->D7inSensedSignalAspect.Value ==
              FObserveSignalAspect_D7inSensedSignalAspectValue__NoSignalAspectLuminosityFailure)));
  self->Change453.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D7inSensedSignalAspect.IsSignalled,
          self->D7inSensedSignalAspect.Value ==
              FObserveSignalAspect_D7inSensedSignalAspectValue__NoSignalAspectLampFailure),
  ...
  self->Change449.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D7inSensedSignalAspect.Value ==
          FObserveSignalAspect_D7inSensedSignalAspectValue__MostRestrictAspect));
  self->Change456.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D7inSensedSignalAspect.IsSignalled,
          self->D7inSensedSignalAspect.Value ==
              FObserveSignalAspect_D7inSensedSignalAspectValue__NoSignalAspectLampFailure),
  ...
  self->Change581.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D8inSensedIntentionallyDark.IsSignalled,
                              self->D8inSensedIntentionallyDark.Value)));
  self->Change331.IsTriggered = IsTriggered(
