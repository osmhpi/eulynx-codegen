...
typedef struct FSciLsReport {
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(FSciLsReport_D19inObservedSignalAspectValue, )
      D19inObservedSignalAspect;
  ...
  // Messages -- Outgoing
  MessagePort(Message__MsgIndicatedSignalAspect__e129)
      OutMsgIndicatedSignalAspect__e129;
  ...
  // Change Events
  ChangeEvent
      Change132; // d19in_Observed_Signal_Aspect = "Most Restrict Aspect"
  ...
  ChangeEvent
      Change312; // d50in_PDI_Connection_State = "READY_FOR_PDI_NO_SCP"OR
