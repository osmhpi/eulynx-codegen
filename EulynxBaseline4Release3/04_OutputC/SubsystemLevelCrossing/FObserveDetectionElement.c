...
void make_state_FObserveDetectionElement__root__Waiting(
    FObserveDetectionElement *self,
...
void make_state_FObserveDetectionElement__root__Occupied(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *region) {
...
void make_state_FObserveDetectionElement__root__Vacant(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *region) {
...
void make_state_FObserveDetectionElement__root__TechnicalFailure(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *region) {
...
void make_state_FObserveDetectionElement__root(
    FObserveDetectionElement *self,
...
void transition_from_FObserveDetectionElement__root__Waiting(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *x) {

  if (self->Change14.IsTriggered) {
    self->D7outDetectionElementStatus.Value =
...
void transition_from_FObserveDetectionElement__root__Occupied(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *x) {
...
void transition_from_FObserveDetectionElement__root__Vacant(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *x) {
...
void transition_from_FObserveDetectionElement__root__TechnicalFailure(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *x) {
...
void transition_from_FObserveDetectionElement__root(
    FObserveDetectionElement *self,
    FObserveDetectionElement__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FObserveDetectionElement *self) {
  self->Change14.IsTriggered = IsTriggered(AndChange(
      MakeChange(
          self->D108inDetectionElementStatus.IsSignalled,
      ...
      MakeChange(self->D118inConUseDetectionElement.IsSignalled,
                 self->D118inConUseDetectionElement.Value)));
  ...
  self->Change17.IsTriggered = IsTriggered(AndChange(
      ...
      MakeChange(self->D118inConUseDetectionElement.IsSignalled,
                 self->D118inConUseDetectionElement.Value)));
  self->Change19.IsTriggered = IsTriggered(AndChange(
      MakeChange(
          self->D108inDetectionElementStatus.IsSignalled,
          self->D108inDetectionElementStatus.Value ==
              FObserveDetectionElement_D108inDetectionElementStatusValue__DetectionElementFailed),
  ...
  self->Change18.IsTriggered = IsTriggered(AndChange(
      ...
      MakeChange(self->D118inConUseDetectionElement.IsSignalled,
                 self->D118inConUseDetectionElement.Value)));
  self->Change20.IsTriggered = IsTriggered(AndChange(
      MakeChange(
          self->D108inDetectionElementStatus.IsSignalled,
          self->D108inDetectionElementStatus.Value ==
              FObserveDetectionElement_D108inDetectionElementStatusValue__DetectionElementOccupied),
