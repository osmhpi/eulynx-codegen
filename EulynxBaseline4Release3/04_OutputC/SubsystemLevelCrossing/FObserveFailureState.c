...
void make_state_FObserveFailureState__root__ObserveFailureStates__LcpfFailureState(
  ...
  if ((self->D74inLcpfFailureState.Value ==
...
void make_state_FObserveFailureState__root__ObserveFailureStates(
    FObserveFailureState *self,
...
void make_state_FObserveFailureState__root__WaitingForBooting(
    FObserveFailureState *self,
    FObserveFailureState__root__state_struct *region) {
...
void make_state_FObserveFailureState__root(
...
void transition_from_FObserveFailureState__root__ObserveFailureStates__LcFailureState(
  ...
  case FObserveFailureState__root__ObserveFailureStates__LcFailureState__CriticalFailureDetected:
    transition_from_FObserveFailureState__root__ObserveFailureStates__LcFailureState__CriticalFailureDetected(
        self, x);
    break;
...
void transition_from_FObserveFailureState__root__ObserveFailureStates(
    FObserveFailureState *self, FObserveFailureState__root__state_struct *x) {
  transition_from_FObserveFailureState__root__ObserveFailureStates__LcFailureState(
      self, x);
  transition_from_FObserveFailureState__root__ObserveFailureStates__LcpfFailureState(
      self, x);
...
void transition_from_FObserveFailureState__root__WaitingForBooting(
    FObserveFailureState *self, FObserveFailureState__root__state_struct *x) {
...
void transition_from_FObserveFailureState__root(
    FObserveFailureState *self, FObserveFailureState__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FObserveFailureState *self) {
  self->Change575.IsTriggered = IsTriggered(NegateChange(MakeChange(
      self->D60inLcFailure.IsSignalled, self->D60inLcFailure.Value)));
  self->Change415.IsTriggered = IsTriggered(
      MakeChange(self->D60inLcFailure.IsSignalled, self->D60inLcFailure.Value));
  self->Change576.IsTriggered = IsTriggered(NegateChange(MakeChange(
      self->D60inLcFailure.IsSignalled, self->D60inLcFailure.Value)));
  self->Change417.IsTriggered = IsTriggered(
      MakeChange(self->D60inLcFailure.IsSignalled, self->D60inLcFailure.Value));
  self->Change435.IsTriggered = IsTriggered(MakeChange(
      self->D74inLcpfFailureState.IsSignalled,
      self->D74inLcpfFailureState.Value ==
          FObserveFailureState_D74inLcpfFailureStateValue__NoFailurePresent));
  self->Change434.IsTriggered = IsTriggered(MakeChange(
      self->D74inLcpfFailureState.IsSignalled,
      self->D74inLcpfFailureState.Value ==
          FObserveFailureState_D74inLcpfFailureStateValue__FailurePresent));
  self->Change436.IsTriggered = IsTriggered(MakeChange(
      self->D74inLcpfFailureState.IsSignalled,
      self->D74inLcpfFailureState.Value ==
          FObserveFailureState_D74inLcpfFailureStateValue__NoFailurePresent));
  self->Change433.IsTriggered = IsTriggered(MakeChange(
      self->D74inLcpfFailureState.IsSignalled,
      self->D74inLcpfFailureState.Value ==
          FObserveFailureState_D74inLcpfFailureStateValue__FailurePresent));
  self->Change350.IsTriggered = IsTriggered(MakeChange(
      self->D51inEstEfesState.IsSignalled,
      self->D51inEstEfesState.Value ==
          FObserveFailureState_D51inEstEfesStateValue__FallbackMode));
  self->Change332.IsTriggered = IsTriggered(
