...
typedef struct FObserveLcpf__root__ObserveLcpf__state_struct {
  FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__state_struct
      ObserveLcpfProtectionState;
  FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__state_struct
      ObserveLcpfObstacleDetectionState;
  FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__state_struct
      ObserveLcpfFailureState;
  FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__state_struct
...
typedef struct FObserveLcpf {
  ...
  DataPort(FObserveLcpf_D30inLcpfProtectionStateValue, )
      D30inLcpfProtectionState;

  /// d4out_Obstacle_Detection_Status
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FObserveLcpf_D4outObstacleDetectionStatusValue, )
      D4outObstacleDetectionStatus;

  /// d3out_LCPF_Protection_State
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FObserveLcpf_D3outLcpfProtectionStateValue, )
      D3outLcpfProtectionState;
  ...
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FObserveLcpf_D9outChangedMonitoringStateValue, )
      D9outChangedMonitoringState;
  ...
  // Change Events
  ChangeEvent Change204; // D30in_LCPF_Protection_State = "Idle"
  ChangeEvent Change209; // D30in_LCPF_Protection_State = "Protected"
  ChangeEvent Change205; // D30in_LCPF_Protection_State = "Idle"
  ChangeEvent Change212; // D30in_LCPF_Protection_State = "Unprotected"
  ChangeEvent Change207; // D30in_LCPF_Protection_State = "Protected"
  ChangeEvent Change214; // D30in_LCPF_Protection_State = "Unprotected"
  ChangeEvent Change206; // D30in_LCPF_Protection_State = "Idle"
  ChangeEvent Change208; // D30in_LCPF_Protection_State = "Protected"
  ChangeEvent Change213; // D30in_LCPF_Protection_State = "Unprotected"
  ChangeEvent Change226; // D31in_Obstacle_Detection_State
  ChangeEvent Change558; // NOT D31in_Obstacle_Detection_State
  ChangeEvent Change225; // D31in_Obstacle_Detection_State
  ChangeEvent Change559; // NOT D31in_Obstacle_Detection_State
  ChangeEvent Change237; // D32in_LCPF_Failure_State
  ChangeEvent Change564; // NOT D32in_LCPF_Failure_State
  ChangeEvent Change1;   //  D32in_LCPF_Failure_State
  ChangeEvent Change563; // NOT D32in_LCPF_Failure_State
  ChangeEvent Change2; //  D33in_Monitoring_State = "Monitoring Parameter Set 1"
  ChangeEvent
      Change238; // D33in_Monitoring_State = "Monitoring Parameter Set 2"
