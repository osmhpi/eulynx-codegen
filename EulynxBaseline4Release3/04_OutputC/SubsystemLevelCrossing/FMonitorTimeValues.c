...
void make_state_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay(
  ...
  make_state_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Idle(
      self, x);
  return;
}
...
void make_state_FMonitorTimeValues__root__MonitorTimeValues(
  ...
  make_state_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay(
      self, &region->MonitorTimeValues.PdiConLossDelay);
};
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime(
  ...
  case FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__Idle:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__Idle(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__ClosureTimeIsRunning:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__ClosureTimeIsRunning(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__ClosureTimeExpired:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime__ClosureTimeExpired(
        self, x);
    break;
  }
}
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Waiting(
  ...
  if (self->Change321.IsTriggered) {
    if ((!(self->D1inReceiveLcState.Value ==
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay(
  ...
  case FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Idle:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Idle(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__WaitingForDelay:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__WaitingForDelay(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__DelayReached:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__DelayReached(
        self, x);
    break;
  case FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Waiting:
    transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay__Waiting(
        self, x);
    break;
  }
}
...
void transition_from_FMonitorTimeValues__root__MonitorTimeValues(
    FMonitorTimeValues *self, FMonitorTimeValues__root__state_struct *x) {
  transition_from_FMonitorTimeValues__root__MonitorTimeValues__MonitorClosureTime(
      self, x);
  transition_from_FMonitorTimeValues__root__MonitorTimeValues__PdiConLossDelay(
      self, x);
}
...
static void evaluateChangeEvents(FMonitorTimeValues *self) {
  ...
  self->Change244.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D3inLcpfProtectionState.IsSignalled,
                 self->D3inLcpfProtectionState.Value ==
