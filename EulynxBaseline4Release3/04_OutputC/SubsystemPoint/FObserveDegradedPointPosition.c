...
map_D10inPmiCrucialPosition_to_D10inPm1CrucialPosition(FObserveDegradedPointPosition_D10inPmiCrucialPositionValue value)
{
    switch (value)
    {
...
static void evaluateChangeEvents(FObserveDegradedPointPosition *self)
{
    ...
    self->Change10.IsTriggered =
        IsTriggered(OrChange(
            OrChange(
                OrChange(OrChange(MakeChange(self->D14inObservedPointPosition.IsSignalled,
                                             self->D14inObservedPointPosition.Value ==
                                                 FObserveDegradedPointPosition_D14inObservedPointPositionValue__Left),
                                  MakeChange(self->D14inObservedPointPosition.IsSignalled,
                                             self->D14inObservedPointPosition.Value ==
    ...
    self->Change26.IsTriggered = IsTriggered(AndChange(
        AndChange(MakeChange(self->D10inPm1CrucialPosition.IsSignalled,
                             self->D10inPm1CrucialPosition.Value ==
                                 FObserveDegradedPointPosition_D10inPm1CrucialPositionValue__Left),
                  OrChange(MakeChange(self->D10inPmiCrucialPosition.IsSignalled,
                                      self->D10inPmiCrucialPosition.Value ==
                                          FObserveDegradedPointPosition_D10inPmiCrucialPositionValue__Left),
                           NegateChange(MakeChange(self->D26inConPmiCrucialActivation.IsSignalled,
                                                   self->D26inConPmiCrucialActivation.Value)))),
        OrChange(
            OrChange(MakeChange(self->D10inPmkNonCrucialPosition.IsSignalled,
                                self->D10inPmkNonCrucialPosition.Value ==
                                    FObserveDegradedPointPosition_D10inPmkNonCrucialPositionValue__NoEndPosition),
                     MakeChange(self->D10inPmkNonCrucialPosition.IsSignalled,
                                self->D10inPmkNonCrucialPosition.Value ==
