...
static FControlPoint_D10inRequiredPointPositionValue
map_D14inObservedPointPosition_to_D10inRequiredPointPosition(
...
static FControlPoint_D14inObservedPointPositionValue
map_D10inRequiredPointPosition_to_D14inObservedPointPosition(
...
static FControlPoint_D14inObservedPointPositionValue
map_MemLastRequiredPointPosition_to_D14inObservedPointPosition(
...
static FControlPoint_MemLastRequiredPointPositionValue
map_D14inObservedPointPosition_to_MemLastRequiredPointPosition(
    FControlPoint_D14inObservedPointPositionValue value) {
  switch (value) {
  case FControlPoint_D14inObservedPointPositionValue__NULL__:
...
void make_state_FControlPoint__root__Operating__root__MovingLeft(
    FControlPoint *self,
    FControlPoint__root__Operating__root__state_struct *region) {
...
void make_state_FControlPoint__root__Operating__root(
    FControlPoint *self,
...
void make_state_FControlPoint__root__Operating(
    FControlPoint *self, FControlPoint__root__state_struct *region) {
  LOG("[FControlPoint] Entering state Operating in region root");
  region->state = FControlPoint__root__Operating;
  make_state_FControlPoint__root__Operating__root(self,
                                                  &region->Operating.root);
};

void make_state_FControlPoint__root(FControlPoint *self,
                                    FControlPoint__root__state_struct *x) {
  memset(x, 0, sizeof(FControlPoint__root__state_struct));
  self->D12outRequiredPmPosition.Value =
...
void transition_from_FControlPoint__root__Operating__root__MovingLeft(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
  ...
  if (self->Change36.IsTriggered) {
    if (self->D11inObservedAbilityToMove.Value ==
      ...
      self->D12outRequiredPmPosition.IsSignalled = true;
      make_state_FControlPoint__root__Operating__root__MovingRight(
  ...
  if (self->Change37.IsTriggered) {
    self->D12outRequiredPmPosition.Value =
        FControlPoint_D12outRequiredPmPositionValue__Uncommanded;
    self->D12outRequiredPmPosition.IsSignalled = true;
    make_state_FControlPoint__root__Operating__root__Stopped(
        self, &x->Operating.root);
    return;
  }
...
void transition_from_FControlPoint__root__Operating__root__MovingRight(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
  ...
  if (self->Change34.IsTriggered) {
    if (self->D11inObservedAbilityToMove.Value ==
      ...
      self->D12outRequiredPmPosition.IsSignalled = true;
      make_state_FControlPoint__root__Operating__root__MovingLeft(
          self, &x->Operating.root);
      return;
    }
  }
...
void transition_from_FControlPoint__root__Operating__root__Stopped(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
  ...
  if (self->Change113.IsTriggered) {
    if (((self->MemLastRequiredPointPosition ==
          FControlPoint_MemLastRequiredPointPositionValue__Right) &&
...
void transition_from_FControlPoint__root__Operating__root__Waiting(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
...
void transition_from_FControlPoint__root__Operating__root(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
...
void transition_from_FControlPoint__root__Operating(
    FControlPoint *self, FControlPoint__root__state_struct *x) {
...
void transition_from_FControlPoint__root(FControlPoint *self,
                                         FControlPoint__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FControlPoint *self) {
  self->Change36.IsTriggered = IsTriggered(AndChange(
  ...
  self->Change114.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D14inObservedPointPosition.Value ==
          map_D10inRequiredPointPosition_to_D14inObservedPointPosition(
              self->D10inRequiredPointPosition.Value)));
  self->Change116.IsTriggered = IsTriggered(MakeChange(
      self->D14inObservedPointPosition.IsSignalled,
      self->D14inObservedPointPosition.Value ==
          map_MemLastRequiredPointPosition_to_D14inObservedPointPosition(
              self->MemLastRequiredPointPosition)));
  self->Change34.IsTriggered = IsTriggered(AndChange(
      MakeChange(self->D10inRequiredPointPosition.IsSignalled,
                 self->D10inRequiredPointPosition.Value ==
      ...
      MakeChange(self->D10inRequiredPointPosition.IsSignalled ||
                 ...
                 !(self->D10inRequiredPointPosition.Value ==
                   map_D14inObservedPointPosition_to_D10inRequiredPointPosition(
                       self->D14inObservedPointPosition.Value)))));
  self->Change38.IsTriggered = IsTriggered(MakeChange(
      self->D10inRequiredPointPosition.IsSignalled,
      self->D10inRequiredPointPosition.Value ==
          FControlPoint_D10inRequiredPointPositionValue__Uncommanded));
  self->Change42.IsTriggered = IsTriggered(MakeChange(
      self->D11inObservedAbilityToMove.IsSignalled,
      self->D11inObservedAbilityToMove.Value ==
          FControlPoint_D11inObservedAbilityToMoveValue__UnableToMove));
  self->Change96.IsTriggered =
      IsTriggered(MakeChange(self->D13inObservedMovementFailed.IsSignalled,
                             self->D13inObservedMovementFailed.Value));
  self->Change115.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D14inObservedPointPosition.Value ==
          map_D10inRequiredPointPosition_to_D14inObservedPointPosition(
              self->D10inRequiredPointPosition.Value)));
  self->Change117.IsTriggered = IsTriggered(MakeChange(
      self->D14inObservedPointPosition.IsSignalled,
      self->D14inObservedPointPosition.Value ==
          map_MemLastRequiredPointPosition_to_D14inObservedPointPosition(
              self->MemLastRequiredPointPosition)));
  self->Change33.IsTriggered = IsTriggered(
      MakeChange(self->D10inRequiredPointPosition.IsSignalled,
                 self->D10inRequiredPointPosition.Value ==
                     FControlPoint_D10inRequiredPointPositionValue__Left));
  ...
  self->Change112.IsTriggered = IsTriggered(MakeChange(
      ...
      !(self->D14inObservedPointPosition.Value ==
        map_MemLastRequiredPointPosition_to_D14inObservedPointPosition(
            self->MemLastRequiredPointPosition))));
  self->Change359.IsTriggered = IsTriggered(
  ...
  self->Change371.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
