...
typedef struct FObserveAbilityToMove {
  ...
  DataPort(FObserveAbilityToMove_D19inAbilityToMovePm1nCrucialValue, )
      D19inAbilityToMovePm1nCrucial;

  /// D19in_Ability_To_Move_PM1_Crucial
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveAbilityToMove_D19inAbilityToMovePm1CrucialValue, )
      D19inAbilityToMovePm1Crucial;

  /// D19in_Ability_To_Move_PM2_Non_Crucial
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveAbilityToMove_D19inAbilityToMovePm2NonCrucialValue, )
      D19inAbilityToMovePm2NonCrucial;

  /// D19in_Ability_To_Move_PM2n_Non_Crucial
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveAbilityToMove_D19inAbilityToMovePm2nNonCrucialValue, )
      D19inAbilityToMovePm2nNonCrucial;
  ...
  ChangeEvent
      Change131; // D19in_Ability_To_Move_PM1_Crucial = "UNABLE" OR
                 ...
                 // D33in_Internal_Trigger_Ability_To_Move_Point_Available
  ChangeEvent
      Change130; // D19in_Ability_To_Move_PM1_Crucial = "ABLE"  AND
