...
void make_state_FObserveMovementFailed__root__ObserveMovementFailure__root(
    FObserveMovementFailed *self, FObserveMovementFailed__root__ObserveMovementFailure__root__state_struct *x)
{
    ...
    make_state_FObserveMovementFailed__root__ObserveMovementFailure__root__Idle(self, x);
    return;
}
...
void make_state_FObserveMovementFailed__root(FObserveMovementFailed *self,
...
void transition_from_FObserveMovementFailed__root__ObserveMovementFailure__root__Idle(
    FObserveMovementFailed *self, FObserveMovementFailed__root__state_struct *x)
{
    ...
    FObserveMovementFailed *self, FObserveMovementFailed__root__state_struct *x)
{
    ...
    {
        self->D13outObservedMovementFailed.Value = false;
        make_state_FObserveMovementFailed__root__ObserveMovementFailure__root__Idle(self,
                                                                                    &x->ObserveMovementFailure.root);
        return;
    }
...
void transition_from_FObserveMovementFailed__root__ObserveMovementFailure(FObserveMovementFailed *self,
                                                                          FObserveMovementFailed__root__state_struct *x)
{
    transition_from_FObserveMovementFailed__root__ObserveMovementFailure__root(self, x);
}

void transition_from_FObserveMovementFailed__root(FObserveMovementFailed *self,
                                                  FObserveMovementFailed__root__state_struct *x)
{
    switch (x->state)
    {
...
{
    self->Change73.IsTriggered = IsTriggered(OrChange(
        MakeChange(self->D12inRequiredPmPosition.IsSignalled,
                   self->D12inRequiredPmPosition.Value == FObserveMovementFailed_D12inRequiredPmPositionValue__Left),
        MakeChange(self->D12inRequiredPmPosition.IsSignalled,
                   self->D12inRequiredPmPosition.Value == FObserveMovementFailed_D12inRequiredPmPositionValue__Right)));
    ...
    self->Change78.IsTriggered = IsTriggered(
        MakeChange(self->D12inRequiredPmPosition.IsSignalled,
                   self->D12inRequiredPmPosition.Value == FObserveMovementFailed_D12inRequiredPmPositionValue__Right));
    self->Change82.IsTriggered = IsTriggered(MakeChange(
        self->D12inRequiredPmPosition.IsSignalled,
        self->D12inRequiredPmPosition.Value == FObserveMovementFailed_D12inRequiredPmPositionValue__Uncommanded));
