...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(
    SSciAdjSec *self,
    SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root(
    SSciAdjSec *self,
    SSciAdjSec__root__Active__root__Establishing__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(SSciAdjSec__root__Active__root__Establishing__root__state_struct));

  if (self->MemPdiVersion == self->D3inConPdiVersion.Value) {

    self->OutMsgPdiVersionCheck__9827.Value.Result =
        MsgPdiVersionCheck__9827_ResultValue__Match;
    memcpy(self->OutMsgPdiVersionCheck__9827.Value.ChecksumData,
           self->D4inConChecksumData.Value,
           sizeof(self->OutMsgPdiVersionCheck__9827.Value.ChecksumData));
    self->OutMsgPdiVersionCheck__9827.Value.PDIVersion =
    ...
    make_state_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(
        self, x);
    return;
  }
  if (!(self->MemPdiVersion == self->D3inConPdiVersion.Value)) {
    ...
    self->D50outPdiConnectionState.IsSignalled = true;
    make_state_SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal(
        self, x);
    return;
  }
}

void make_state_SSciAdjSec__root__Active__root__Establishing(
    SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *region) {
  ...
  make_state_SSciAdjSec__root__Active__root__Establishing__root(
      self, &region->Establishing.root);
};

void make_state_SSciAdjSec__root__Active__root__Established(
    SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root(
    SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *x) {
...
void make_state_SSciAdjSec__root(SSciAdjSec *self,
...
void transition_from_SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus(
  ...
  if (self->Change1018.IsTriggered) {
    ...
    make_state_SSciAdjSec__root__Active__root__Established(self,
                                                           &x->Active.root);
    return;
  }
}

void transition_from_SSciAdjSec__root__Active__root__Establishing__root(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
  ...
  case SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation:
    transition_from_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(
        self, x);
    break;
  case SSciAdjSec__root__Active__root__Establishing__root__SendingSecStatus:
    transition_from_SSciAdjSec__root__Active__root__Establishing__root__SendingSecStatus(
        self, x);
    break;
  case SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal:
    transition_from_SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal(
        self, x);
    break;
  case SSciAdjSec__root__Active__root__Establishing__root__ReceivingPrimStatus:
    transition_from_SSciAdjSec__root__Active__root__Establishing__root__ReceivingPrimStatus(
        self, x);
    break;
  case SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus:
    transition_from_SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus(
        self, x);
    break;
  }
}

void transition_from_SSciAdjSec__root__Active__root__Establishing(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
  transition_from_SSciAdjSec__root__Active__root__Establishing__root(self, x);
}

void transition_from_SSciAdjSec__root__Active__root__Established(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {}

void transition_from_SSciAdjSec__root__Active__root(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
...
void transition_from_SSciAdjSec__root__RequestedNoScp(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
...
void transition_from_SSciAdjSec__root__ReadyForPdi(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
...
void transition_from_SSciAdjSec__root__Active(
    SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
  transition_from_SSciAdjSec__root__Active__root(self, x);
  if (self->InCdClosePdi__8a06.HasMessage) {
    if (self->InCdClosePdi__8a06.Value.RequestedCloseReason ==
        CloseReason__91bc__Timeout) {
      self->D60PdiCloseReason.Value =
  ...
  if (self->Change976.IsTriggered) {
    ...
    self->OutMsgResetPdi__59f4.Value.ReportedResetReason =
...
void transition_from_SSciAdjSec__root(SSciAdjSec *self,
                                      SSciAdjSec__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(SSciAdjSec *self) {
  self->Change1018.IsTriggered =
      self->T25inPrimStatusReportComplete.IsTriggered;
