...
void make_state_FSciEfesSec__root__Active__root__Establishing__root__ReadyForInitialisation(
    FSciEfesSec *self,
    FSciEfesSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_FSciEfesSec__root__Active__root__Establishing__root(
    FSciEfesSec *self,
    FSciEfesSec__root__Active__root__Establishing__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(
  ...
  if (self->MemPdiVersion == self->D3inConPdiVersion.Value) {
    ...
    make_state_FSciEfesSec__root__Active__root__Establishing__root__ReadyForInitialisation(
        self, x);
    return;
  }
  if (!(self->MemPdiVersion == self->D3inConPdiVersion.Value)) {
    ...
    self->D50outPdiConnectionState.IsSignalled = true;
    make_state_FSciEfesSec__root__Active__root__Establishing__root__VersionUnequal(
        self, x);
    return;
  }
}

void make_state_FSciEfesSec__root__Active__root__Establishing(
    FSciEfesSec *self, FSciEfesSec__root__Active__root__state_struct *region) {
  ...
  make_state_FSciEfesSec__root__Active__root__Establishing__root(
      self, &region->Establishing.root);
};

void make_state_FSciEfesSec__root__Active__root__Established(
    FSciEfesSec *self, FSciEfesSec__root__Active__root__state_struct *region) {
...
void make_state_FSciEfesSec__root__Active__root(
    FSciEfesSec *self, FSciEfesSec__root__Active__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__Active__root__Establishing__root__SendingStatus(
  ...
  if (self->InStatusReportCompleted__b457.HasMessage) {
    ...
    make_state_FSciEfesSec__root__Active__root__Established(self,
                                                            &x->Active.root);
    return;
  }
}
...
void transition_from_FSciEfesSec__root__Active__root__Establishing__root(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
  ...
  case FSciEfesSec__root__Active__root__Establishing__root__ReadyForInitialisation:
    transition_from_FSciEfesSec__root__Active__root__Establishing__root__ReadyForInitialisation(
        self, x);
    break;
  case FSciEfesSec__root__Active__root__Establishing__root__SendingStatus:
    transition_from_FSciEfesSec__root__Active__root__Establishing__root__SendingStatus(
        self, x);
    break;
  case FSciEfesSec__root__Active__root__Establishing__root__VersionUnequal:
    transition_from_FSciEfesSec__root__Active__root__Establishing__root__VersionUnequal(
        self, x);
    break;
  }
}

void transition_from_FSciEfesSec__root__Active__root__Establishing(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
  transition_from_FSciEfesSec__root__Active__root__Establishing__root(self, x);
}

void transition_from_FSciEfesSec__root__Active__root__Established(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {}

void transition_from_FSciEfesSec__root__Active__root(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__NotReadyForPdi(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__Suspended(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__ReadyForPdi(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__Active(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__NotReadyForPdiNoScp(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root__ReadyForPdiNoScp(
    FSciEfesSec *self, FSciEfesSec__root__state_struct *x) {
...
void transition_from_FSciEfesSec__root(FSciEfesSec *self,
                                       FSciEfesSec__root__state_struct *x) {
  switch (x->state) {
