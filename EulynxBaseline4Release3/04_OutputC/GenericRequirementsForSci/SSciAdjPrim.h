...
typedef struct SSciAdjPrim__root__Active__root__Establishing__root__state_struct
{
...
typedef struct SSciAdjPrim
{
    ...
    DataPort(SSciAdjPrim_D50outPdiConnectionStateValue, ) D50outPdiConnectionState;
    ...
    MessagePort(Message__PrimStatusReportCompleted__80d8) InPrimStatusReportCompleted__80d8;
    ...
    // Messages -- Outgoing
    MessagePort(Message__StartPrimStatusReport__a91c) OutStartPrimStatusReport__a91c;
    ...
    // Change Events
    ChangeEvent Change1019; // t25in_Sec_Status_Report_Complete
    ChangeEvent Change1220; // T5in_SCP_Connection_Established
    ChangeEvent Change1164; // T45in_Reset_Severe_Error
    ChangeEvent Change1216; // T5in_SCP_Connection_Established
    ChangeEvent Change738;  // T10in_SCP_Connection_Terminated
    ChangeEvent Change1165; // T45in_Reset_Severe_Error
    ChangeEvent Change741;  // T10in_SCP_Connection_Terminated
    ChangeEvent Change979;  // T20in_Protocol_Error
    ChangeEvent Change986;  // T21in_Formal_Telegram_Error
    ChangeEvent Change1000; // T22in_Content_Telegram_Error
