...
void make_state_SSciIoReceive__root__ReceivingInputAndOutputChannelStates(
    SSciIoReceive *self, SSciIoReceive__root__state_struct *region) {
  ...
  make_state_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingInputChannelStates(
      self, &region->ReceivingInputAndOutputChannelStates
                 .ReceivingInputChannelStates);
...
void make_state_SSciIoReceive__root(SSciIoReceive *self,
...
void transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingInputChannelStates__ReceivingInputChannelReports(
  ...
  if (self->InMsgStateOfInputChannels__8132.HasMessage) {
    if ((self->InMsgStateOfInputChannels__8132.Value.ResportedInputState1 ==
        ...
        (self->InMsgStateOfInputChannels__8132.Value.ResportedInputStateN ==
         InputChannelState__a4d2__SwitchedOn)) {
      self->D71outReportedInputChannelState1.Value =
      ...
      make_state_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingInputChannelStates__ReceivingInputChannelReports(
          self,
          &x->ReceivingInputAndOutputChannelStates.ReceivingInputChannelStates);
      return;
    }
  }
  if (self->InMsgStateOfInputChannels__8132.HasMessage) {
...
void transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingInputChannelStates(
    SSciIoReceive *self, SSciIoReceive__root__state_struct *x) {
  switch (x->ReceivingInputAndOutputChannelStates.ReceivingInputChannelStates
              .state) {
...
void transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingOutputChannelStates__ReceivingOutputChannelReports(
  ...
  if (self->InMsgStateOfOutputChannels__c6d6.HasMessage) {
    if ((self->InMsgStateOfOutputChannels__c6d6.Value
             .ResportedDisturbanceState1 ==
         OutputChannelDisturbanceState__bed9__PhysicallyDisturbed) &&
        (self->InMsgStateOfOutputChannels__c6d6.Value
             .ResportedDisturbanceStateN ==
         OutputChannelDisturbanceState__bed9__PhysicallyDisturbed)) {
      self->D91outReportedOutputChannelDisturbanceState1.Value =
      ...
      self->D92outReportedOutputChannelDisturbanceStaten.IsSignalled = true;
      make_state_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingOutputChannelStates__ReceivingOutputChannelReports(
          self, &x->ReceivingInputAndOutputChannelStates
                     .ReceivingOutputChannelStates);
      return;
    }
  }
...
void transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingOutputChannelStates(
    SSciIoReceive *self, SSciIoReceive__root__state_struct *x) {
  switch (x->ReceivingInputAndOutputChannelStates.ReceivingOutputChannelStates
              .state) {
...
void transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates(
    SSciIoReceive *self, SSciIoReceive__root__state_struct *x) {
  transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingInputChannelStates(
      self, x);
  transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates__ReceivingOutputChannelStates(
      self, x);
  if (self->Change297.IsTriggered) {

    make_state_SSciIoReceive__root__ReceivingInputAndOutputChannelStates(self,
                                                                         x);
    return;
  }
}

void transition_from_SSciIoReceive__root(SSciIoReceive *self,
                                         SSciIoReceive__root__state_struct *x) {
  switch (x->state) {
  case SSciIoReceive__root__ReceivingInputAndOutputChannelStates:
    transition_from_SSciIoReceive__root__ReceivingInputAndOutputChannelStates(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(SSciIoReceive *self) {
  self->Change297.IsTriggered = IsTriggered(OrChange(
      OrChange(
          OrChange(
              MakeChange(
