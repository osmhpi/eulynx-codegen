...
evaluateChangeEvents(FControlSafeStateOfAllPhysicalOutputChannel *self) {
  ...
  self->Change381.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D51inEstEfesState.Value ==
          FControlSafeStateOfAllPhysicalOutputChannel_D51inEstEfesStateValue__Operational));
  self->Change378.IsTriggered = IsTriggered(MakeChange(
      self->D51inEstEfesState.IsSignalled,
      self->D51inEstEfesState.Value ==
          FControlSafeStateOfAllPhysicalOutputChannel_D51inEstEfesStateValue__Operational));
