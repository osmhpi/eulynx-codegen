...
void count_transitions_from_FSciLcReceive__root__NationalSpecificState(int *ctr, FSciLcReceive *self,
                                                                       FSciLcReceive__root__state_struct *x)
{
    int maxSubregionTransitions = 0;
    int tmp;
...
void count_transitions_from_FSciLcReceive__root(int *ctr, FSciLcReceive *self, FSciLcReceive__root__state_struct *x)
{
    ...
    case FSciLcReceive__root__NationalSpecificState:
        count_transitions_from_FSciLcReceive__root__NationalSpecificState(ctr, self, x);
        break;
