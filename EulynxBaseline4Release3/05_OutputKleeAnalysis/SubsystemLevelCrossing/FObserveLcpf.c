...
void count_transitions_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(
    int *ctr, FObserveLcpf *self, FObserveLcpf__root__state_struct *x)
{
    int maxSubregionTransitions = 0;
    int tmp;
    ...
    int *ctr, FObserveLcpf *self, FObserveLcpf__root__state_struct *x)
{
    ...
    case FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting:
        count_transitions_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(ctr, self, x);
        break;
    }
}
