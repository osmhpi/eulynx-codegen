...
*/
    ...
    // system_inputs_t inputs4;
    // klee_make_symbolic(&inputs4, sizeof(inputs4), "inputs4");
    // klee_assume(inputs4.InCdMovePoint__342e.HasMessage == false);
    // apply_inputs(&inputs4);
    // cycle_and_assert();
