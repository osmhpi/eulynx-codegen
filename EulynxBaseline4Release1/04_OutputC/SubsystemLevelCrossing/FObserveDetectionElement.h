...
typedef struct FObserveDetectionElement
{
    ...
    ChangeEvent
        Change13; // D108in_Detection_Element_Status = "Detection element vacant" AND D118in_Con_Use_Detection_Element
    ChangeEvent
        Change11; // D108in_Detection_Element_Status = "Detection element failed" AND D118in_Con_Use_Detection_Element
    ChangeEvent
    ...
    ChangeEvent
        Change18; // D108in_Detection_Element_Status = "Detection element occupied" AND D118in_Con_Use_Detection_Element
    ChangeEvent
        Change17; // D108in_Detection_Element_Status = "Detection element failed" AND D118in_Con_Use_Detection_Element
    ChangeEvent
        Change10; // D108in_Detection_Element_Status = "Detection element occupied" AND D118in_Con_Use_Detection_Element
    ChangeEvent
