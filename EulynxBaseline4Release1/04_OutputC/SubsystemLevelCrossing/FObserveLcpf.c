    ...
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x)
{
    ...
    {
        self->D6outLcpfFailureState.Value = FObserveLcpf_D6outLcpfFailureStateValue__FailurePresent;
        self->D6outLcpfFailureState.IsSignalled = true;
    ...
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x)
{
    ...
    {
        self->D6outLcpfFailureState.Value = FObserveLcpf_D6outLcpfFailureStateValue__NoFailurePresent;
        self->D6outLcpfFailureState.IsSignalled = true;
...
static void evaluateChangeEvents(FObserveLcpf *self)
{
    self->Change220.IsTriggered = IsTriggered(MakeChange(
        self->D30inStatusLcpf.IsSignalled, self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Idle));
    self->Change228.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Protected));
    self->Change216.IsTriggered = IsTriggered(MakeChange(
        self->D30inStatusLcpf.IsSignalled, self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Idle));
    self->Change231.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Unprotected));
    self->Change230.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Protected));
    self->Change232.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__Unprotected));
    self->Change226.IsTriggered = IsTriggered(AndChange(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__ObstacleDetectedInTheConflictArea),
        MakeChange(self->D109inConUseObstacleDetection.IsSignalled, self->D109inConUseObstacleDetection.Value)));
    self->Change225.IsTriggered = IsTriggered(AndChange(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__NoObstacleInTheConflictArea),
        MakeChange(self->D109inConUseObstacleDetection.IsSignalled, self->D109inConUseObstacleDetection.Value)));
    self->Change224.IsTriggered = IsTriggered(AndChange(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__NoObstacleInTheConflictArea),
        MakeChange(self->D109inConUseObstacleDetection.IsSignalled, self->D109inConUseObstacleDetection.Value)));
    self->Change227.IsTriggered = IsTriggered(AndChange(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__ObstacleDetectedInTheConflictArea),
        MakeChange(self->D109inConUseObstacleDetection.IsSignalled, self->D109inConUseObstacleDetection.Value)));
    self->Change214.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__FailurePresent));
    self->Change223.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__NoFailurePresent));
    self->Change1.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__FailurePresent));
    self->Change222.IsTriggered =
        IsTriggered(MakeChange(self->D30inStatusLcpf.IsSignalled,
                               self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__NoFailurePresent));
    self->Change213.IsTriggered = IsTriggered(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__MonitoringParameterSet1));
    self->Change221.IsTriggered = IsTriggered(
        MakeChange(self->D30inStatusLcpf.IsSignalled,
                   self->D30inStatusLcpf.Value == FObserveLcpf_D30inStatusLcpfValue__MonitoringParameterSet2));
}
...
static void resetOutputs(FObserveLcpf *self)
{
    ...
    self->D6outLcpfFailureState.IsSignalled = false;
...
static void resetTriggers(FObserveLcpf *self)
{
    ...
    self->D30inStatusLcpf.IsSignalled = false;
