...
typedef struct FControlLocalOperation
{
    ...
    // Change Events
    ChangeEvent Change488; // d8in_Handover_To_Local_Operator_State = "Established"
    ChangeEvent Change490; // d8in_Handover_To_Local_Operator_State = "Initiated"
    ChangeEvent Change493; // d8in_Handover_To_Local_Operator_State = "No Handover"
    ChangeEvent Change487; // d8in_Handover_To_Local_Operator_State = "Established"
    ChangeEvent Change492; // d8in_Handover_To_Local_Operator_State = "No Handover"
    ChangeEvent Change494; // d8in_Handover_To_Local_Operator_State = "No Handover"
    ChangeEvent Change489; // d8in_Handover_To_Local_Operator_State = "Initiated"
    ChangeEvent Change491; // d8in_Handover_To_Local_Operator_State = "Initiated"
    ChangeEvent Change486; // d8in_Handover_To_Local_Operator_State = "Established"
    ChangeEvent Change477; // D81in_Local_Operation_Handover = "Return handover from local operator"
    ChangeEvent Change475; // D81in_Local_Operation_Handover = "Allow handover to local operator"
    ChangeEvent Change474; // D81in_Local_Operation_Handover = "Allow handover to local operator"
    ChangeEvent Change478; // D81in_Local_Operation_Handover = "Return handover from local operator"
    ChangeEvent Change482; // D82in_Request_by_Local_Operator = "Request to activate the level Crossing"
    ChangeEvent Change485; // D82in_Request_by_Local_Operator = "Request to deactivate the level Crossing"
    ChangeEvent Change484; // D82in_Request_by_Local_Operator = "Request to deactivate the level Crossing"
    ChangeEvent Change483; // D82in_Request_by_Local_Operator = "Request to activate the level Crossing"
