...
typedef struct FSciTdsReportTrackCircuit
{
    ...
    // Change Events
    ChangeEvent Change289; // d47in_Report_POM_Status = "Power supply NOK"
    ChangeEvent Change292; // d47in_Report_POM_Status = "Power supply OK"
    ChangeEvent Change294; // d47in_Report_POM_Status = "Power supply OK"
    ChangeEvent Change290; // d47in_Report_POM_Status = "Power supply NOK"
    ChangeEvent Change291; // d47in_Report_POM_Status = "Power supply NOK"
    ChangeEvent Change293; // d47in_Report_POM_Status = "Power supply OK"
    ChangeEvent Change285; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state occupied"
    ChangeEvent Change283; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state disturbed"
    ChangeEvent Change288; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state disturbed"
    ChangeEvent Change286; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state vacant"
    ChangeEvent Change284; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state occupied"
    ChangeEvent Change287; // d45in_Reported_TVPS_Occupancy_Status = "TVPS is in state vacant"
    ChangeEvent Change329; // d50in_PDI_Connection_State = "NOT_READY_FOR_PDI_NO_SCP" OR d50in_PDI_Connection_State =
