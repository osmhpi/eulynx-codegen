...
typedef struct FControlTimer
{
    ...
    ChangeEvent Change246;  // D32in_Critical_Failure_TVPS
    ChangeEvent Change404;  // d51out_EST_EfeS_State = "BOOTING" OR d51out_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
    ChangeEvent Change408;  // d51out_EST_EfeS_State = "FALLBACK_MODE"
    ChangeEvent Change418;  // d51out_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change399;  // d51out_EST_EfeS_State = "BOOTING"
    ChangeEvent Change409;  // d51out_EST_EfeS_State = "FALLBACK_MODE"
    ChangeEvent Change571;  // NOT D32in_Critical_Failure_TVPS
