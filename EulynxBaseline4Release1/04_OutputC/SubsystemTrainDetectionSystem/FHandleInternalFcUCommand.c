...
void make_state_FHandleInternalFcUCommand__root(FHandleInternalFcUCommand *self,
                                                FHandleInternalFcUCommand__root__state_struct *x)
{
    memset(x, 0, sizeof(FHandleInternalFcUCommand__root__state_struct));

    make_state_FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal(self, x);
    return;
}

void transition_from_FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal(
    FHandleInternalFcUCommand *self, FHandleInternalFcUCommand__root__state_struct *x)
{

    if (self->Change1092.IsTriggered)
    {
...
void transition_from_FHandleInternalFcUCommand__root(FHandleInternalFcUCommand *self,
                                                     FHandleInternalFcUCommand__root__state_struct *x)
{
    switch (x->state)
    {
...
{
    self->Change1092.IsTriggered = self->T33inFcU.IsTriggered;
}
