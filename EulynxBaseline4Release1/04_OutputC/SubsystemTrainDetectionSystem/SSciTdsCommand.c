...
{
    self->Change1255.IsTriggered = self->T70inFc.IsTriggered;
    self->Change1256.IsTriggered = self->T70inFc.IsTriggered;
    self->Change1254.IsTriggered = self->T70inFc.IsTriggered;
    self->Change1258.IsTriggered = self->T70inFc.IsTriggered;
    self->Change1257.IsTriggered = self->T70inFc.IsTriggered;
    self->Change1259.IsTriggered = self->T72inUpdateFillingLevel.IsTriggered;
    self->Change1260.IsTriggered = self->T73inCancel.IsTriggered;
    self->Change1261.IsTriggered = self->T74inDrfc.IsTriggered;
}
