...
typedef struct FObserveAbilityToBeForcedToClear
{
    ...
    // Change Events
    ChangeEvent Change83;  // d14n_Running_Timer
    ChangeEvent Change108; // d18in_Perform_FC_P_Or_FC_P_A
    ChangeEvent Change518; // d9in_Occupancy_Status = "vacant"
    ChangeEvent Change512; // d9in_Occupancy_Status = "occupied out"
    ChangeEvent Change515; // d9in_Occupancy_Status = "unreliable out"
    ChangeEvent Change557; // NOT d14n_Running_Timer
    ChangeEvent Change555; // NOT d14n_Running_Timer
    ChangeEvent Change556; // NOT d14n_Running_Timer
    ChangeEvent Change561; // NOT d18in_Perform_FC_P_Or_FC_P_A
    ChangeEvent Change558; // NOT d18in_Perform_FC_P_Or_FC_P_A
    ChangeEvent Change560; // NOT d18in_Perform_FC_P_Or_FC_P_A
    ChangeEvent Change245; // D32in_Critical_Failure_TVPS
    ChangeEvent Change402; // d51out_EST_EfeS_State = "BOOTING" OR d51out_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
    ChangeEvent Change410; // d51out_EST_EfeS_State = "FALLBACK_MODE"
    ChangeEvent Change417; // d51out_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change396; // d51out_EST_EfeS_State = "BOOTING"
    ChangeEvent Change407; // d51out_EST_EfeS_State = "FALLBACK_MODE"
