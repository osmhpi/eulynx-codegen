...
typedef struct FObserveTrackCircuits
{
    ...
    ChangeEvent Change297; // D49in_Failure_Of_The_POM
    ChangeEvent Change298; // D49in_Failure_Of_The_POM
    ChangeEvent Change577; // NOT D49in_Failure_Of_The_POM
    ChangeEvent Change296; // D48in_Occupancy_Detected = TRUE
    ChangeEvent Change295; // D48in_Occupancy_Detected = FALSE
    ChangeEvent Change316; // D50in_Failure_Of_The_Power_Supply
    ChangeEvent Change582; // NOT D50in_Failure_Of_The_Power_Supply
    ChangeEvent Change578; // NOT D49in_Failure_Of_The_POM
    ChangeEvent Change581; // NOT D50in_Failure_Of_The_Power_Supply
    ChangeEvent Change299; // D49in_Failure_Of_The_POM
    ChangeEvent Change315; // D50in_Failure_Of_The_Power_Supply
    ChangeEvent Change247; // D32in_Critical_Failure_TVPS
    ChangeEvent Change249; // D32in_Critical_Failure_TVPS = FALSE
    ChangeEvent Change416; // d51out_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change405; // d51out_EST_EfeS_State = "BOOTING" OR d51out_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
    ChangeEvent Change400; // d51out_EST_EfeS_State = "BOOTING"
    ChangeEvent Change406; // d51out_EST_EfeS_State = "FALLBACK_MODE"
