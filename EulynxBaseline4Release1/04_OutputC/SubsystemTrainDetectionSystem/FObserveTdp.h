...
typedef struct FObserveTdp
{
    ...
    ChangeEvent Change1233; // T60in_Passing_Against_Reference_Direction
    ChangeEvent Change1244; // T62in_Receiving_An_Undefined_Pattern
    ChangeEvent Change1204; // T59in_Passing_In_Reference_Direction
    ChangeEvent Change1237; // T60in_Passing_Against_Reference_Direction or T62in_Receiving_An_Undefined_Pattern
    ...
    ChangeEvent Change1203; // T59in_Passing_In_Reference_Direction
    ChangeEvent Change1236; // T60in_Passing_Against_Reference_Direction
    ChangeEvent Change1201; // T59in_Passing_In_Reference_Direction
    ChangeEvent Change1234; // T60in_Passing_Against_Reference_Direction
    ChangeEvent Change441;  // D63in_Critical_Failure_TDP
    ChangeEvent Change444;  // D63in_Critical_Failure_TDP = FALSE
    ChangeEvent Change1240; // T61in_Passing_Without_Direction
    ChangeEvent Change1243; // T62in_Receiving_An_Undefined_Pattern
    ChangeEvent Change1241; // T61in_Passing_Without_Direction or T62in_Receiving_An_Undefined_Pattern
    ChangeEvent Change1238; // T61in_Passing_Without_Direction
    ChangeEvent Change1239; // T61in_Passing_Without_Direction
    ChangeEvent Change442;  // D63in_Critical_Failure_TDP
    ChangeEvent Change443;  // D63in_Critical_Failure_TDP = FALSE
    ChangeEvent Change415;  // d51out_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change403;  // d51out_EST_EfeS_State = "BOOTING" OR d51out_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
    ChangeEvent Change413;  // d51out_EST_EfeS_State = "FALLBACK_MODE"
    ChangeEvent Change397;  // d51out_EST_EfeS_State = "BOOTING"
