...
typedef struct SSciTdsCommand
{
    ...
    // Change Events
    ChangeEvent Change1255; // t70in_FC
    ChangeEvent Change1256; // t70in_FC
    ChangeEvent Change1254; // t70in_FC
    ChangeEvent Change1258; // t70in_FC
    ChangeEvent Change1257; // t70in_FC
    ChangeEvent Change1259; // t72in_Update_Filling_Level
    ChangeEvent Change1260; // t73in_Cancel
    ChangeEvent Change1261; // t74in_DRFC
