...
typedef enum FControlLuminosity_D15outRespondedLuminosityValue
{
    FControlLuminosity_D15outRespondedLuminosityValue__NULL__,
    FControlLuminosity_D15outRespondedLuminosityValue__Day,
    FControlLuminosity_D15outRespondedLuminosityValue__Night,
    FControlLuminosity_D15outRespondedLuminosityValue__,
    FControlLuminosity_D15outRespondedLuminosityValue__UNKNOWN__
} FControlLuminosity_D15outRespondedLuminosityValue;
...
typedef struct FControlLuminosity
{
    ...
    /// d15out_Responded_Luminosity
    /// Trigger: False, DataPort: True, In: False, Out: True, External: False
    DataPort(FControlLuminosity_D15outRespondedLuminosityValue, ) D15outRespondedLuminosity;
    ...
    // Change Events
    ChangeEvent Change80;  // D14in_Luminosity_Night_Fault
    ChangeEvent Change81;  // D14in_Luminosity_Night_Fault
    ChangeEvent Change82;  // D14in_Luminosity_Night_Fault OR d11in_Required_Luminosity = "Day"
    ChangeEvent Change36;  // d11in_Required_Luminosity = "Day"
    ChangeEvent Change37;  // d11in_Required_Luminosity = "Night"
    ChangeEvent Change66;  // D13in_Luminosity_Day_Fault
    ChangeEvent Change65;  // D13in_Luminosity_Day_Fault
    ChangeEvent Change67;  // D13in_Luminosity_Day_Fault OR d11in_Required_Luminosity = "Night"
    ChangeEvent Change35;  // d11in_Required_Luminosity = "Day"
    ChangeEvent Change38;  // d11in_Required_Luminosity = "Night"
    ChangeEvent Change360; // d51in_EST_EfeS_State = "BOOTING" OR d51in_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change347; // d51in_EST_EfeS_State = "BOOTING"
    ChangeEvent Change379; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
