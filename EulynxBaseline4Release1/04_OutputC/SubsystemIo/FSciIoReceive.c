...
static void evaluateChangeEvents(FSciIoReceive *self)
{
    ...
    self->Change78.IsTriggered = IsTriggered(
    ...
    self->Change506.IsTriggered = IsTriggered(
        MakeChange(self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
                   self->D9inMonitoredOutputChannelDisturbanceStaten.Value ==
                       FSciIoReceive_D9inMonitoredOutputChannelDisturbanceStatenValue__NotPhysicallyDisturbed));
    self->Change552.IsTriggered =
        IsTriggered(NegateChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                                            self->D13outSwitchOffEachPhysicalOuputChannel.Value)));
    self->Change79.IsTriggered = IsTriggered(
        OrChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                            self->D13outSwitchOffEachPhysicalOuputChannel.Value),
                 MakeChange(self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
                            self->D9inMonitoredOutputChannelDisturbanceStaten.Value ==
                                FSciIoReceive_D9inMonitoredOutputChannelDisturbanceStatenValue__PhysicallyDisturbed)));
    self->Change324.IsTriggered = IsTriggered(OrChange(
        OrChange(
