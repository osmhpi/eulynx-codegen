...
typedef struct FMonitorOutputChannelDisturbanceState
{
    ...
    // Change Events
    ChangeEvent Change279; // D41in_Disturbance_ROC
    ChangeEvent Change280; // D41in_Disturbance_ROC OR D42in_Disturbance_VOC
    ChangeEvent Change575; // NOT D41in_Disturbance_ROC
    ChangeEvent Change576; // NOT D41in_Disturbance_ROC AND NOT D42in_Disturbance_VOC
