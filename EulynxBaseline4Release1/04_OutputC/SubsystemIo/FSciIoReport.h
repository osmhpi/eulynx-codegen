...
typedef struct FSciIoReport
{
    ...
    // Change Events
    ChangeEvent Change322; // d50in_PDI_Connection_State = "ESTABLISHED"
    ChangeEvent Change463; // d7in_Detected_Input_Channel_State1 = "Disturbed" AND d7in_Detected_Input_Channel_StateN =
                           // "Switched_Off"
    ChangeEvent Change464; // d7in_Detected_Input_Channel_State1 = "Disturbed" AND d7in_Detected_Input_Channel_StateN =
                           // "Switched_On"
    ChangeEvent Change462; // d7in_Detected_Input_Channel_State1 = "Disturbed" AND d7in_Detected_Input_Channel_StateN =
                           // "Disturbed"
    ChangeEvent Change465; // d7in_Detected_Input_Channel_State1 = "Switched_Off" AND d7in_Detected_Input_Channel_StateN
                           // = "Switched_Off"
    ChangeEvent Change470; // d7in_Detected_Input_Channel_State1 = "Switched_Off" AND d7in_Detected_Input_Channel_StateN
                           // = "Disturbed"
    ChangeEvent Change468; // d7in_Detected_Input_Channel_State1 = "Switched_On" AND d7in_Detected_Input_Channel_StateN
                           // = "Disturbed"
    ChangeEvent Change467; // d7in_Detected_Input_Channel_State1 = "Switched_On"AND d7in_Detected_Input_Channel_StateN =
                           // "Switched_On"
    ChangeEvent Change469; // d7in_Detected_Input_Channel_State1 = "Switched_On" AND d7in_Detected_Input_Channel_StateN
                           // = "Switched_Off"
    ChangeEvent Change466; // d7in_Detected_Input_Channel_State1 = "Switched_Off" AND d7in_Detected_Input_Channel_StateN
                           // = "Switched_On"
    ChangeEvent Change323; // d50in_PDI_Connection_State = "ESTABLISHED"
    ChangeEvent Change502; // d9in_Monitored_Output_Channel_Disturbance_State1 = "Physically_Disturbed"AND
    ...
    ChangeEvent Change501; // d9in_Monitored_Output_Channel_Disturbance_State1 = "Physically_Disturbed"AND
                           // d9in_Monitored_Output_Channel_Disturbance_StateN = "Physically_Disturbed"
    ChangeEvent Change507; // d9in_Monitored_Output_Channel_Disturbance_State1 = "Not_Physically_Disturbed"AND
                           // d9in_Monitored_Output_Channel_Disturbance_StateN = "Not_Physically_Disturbed"
    ChangeEvent Change327; // d50in_PDI_Connection_State = "NOT_READY_FOR_PDI_NO_SCP"OR d50in_PDI_Connection_State =
