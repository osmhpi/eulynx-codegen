...
typedef struct FSciIoReceive
{
    ...
    // Change Events
    ChangeEvent Change509; // d9in_Monitored_Output_Channel_Disturbance_State1 = "Not_Physically_Disturbed"
    ChangeEvent Change551; // Not d13out_Switch_Off_Each_Physical_Ouput_Channel
    ChangeEvent Change78;  // d13out_Switch_Off_Each_Physical_Ouput_Channel OR
                           // d9in_Monitored_Output_Channel_Disturbance_State1 = "Physically_Disturbed"
    ChangeEvent Change506; // d9in_Monitored_Output_Channel_Disturbance_StateN = "Not_Physically_Disturbed"
    ChangeEvent Change552; // Not d13out_Switch_Off_Each_Physical_Ouput_Channel
    ChangeEvent Change79;  // d13out_Switch_Off_Each_Physical_Ouput_Channel OR
                           // d9in_Monitored_Output_Channel_Disturbance_StateN = "Physically_Disturbed"
    ChangeEvent Change324; // d50in_PDI_Connection_State = "NOT_READY_FOR_PDI_NO_SCP" OR d50in_PDI_Connection_State =
    ...
    ChangeEvent Change321; // d50in_PDI_Connection_State = "ESTABLISHED"
