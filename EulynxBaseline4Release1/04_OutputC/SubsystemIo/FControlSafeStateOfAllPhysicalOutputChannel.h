...
typedef struct FControlSafeStateOfAllPhysicalOutputChannel
{
    ...
    ChangeEvent Change363; // d51in_EST_EfeS_State = "FALLBACK_MODE"
    ChangeEvent Change376; // d51in_EST_EfeS_State = "INITIALISING"
    ChangeEvent Change382; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
    ChangeEvent Change505; // d9in_Monitored_Output_Channel_Disturbance_StateN = "Physically_Disturbed"
    ChangeEvent Change508; // d9in_Monitored_Output_Channel_Disturbance_State1 = "Physically_Disturbed"
    ChangeEvent Change391; // d51in_EST_EfeS_State = "OPERATIONAL"
    ChangeEvent Change390; // d51in_EST_EfeS_State = "OPERATIONAL"
