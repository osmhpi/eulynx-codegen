...
typedef enum TimerOverrunState__b8ce
{
    /// NoClosureTimerOverrun
    TimerOverrunState__b8ce__NoClosureTimerOverrun,

    /// ClosureTimerOverrunOccured
    TimerOverrunState__b8ce__ClosureTimerOverrunOccured,

    /// TimerOverrunIsNotApplicable
    TimerOverrunState__b8ce__TimerOverrunIsNotApplicable
} TimerOverrunState__b8ce;
...
typedef enum PointPositionState__2e6f
{
    ...
    /// Trailed
    PointPositionState__2e6f__Trailed
...
typedef struct Message__CdDisplayAllRemindersAndBlockingSetOnARouteElementOrOnARoute__6b81
{
...
typedef struct Message__CdCancelRouteWithCoOperativeShorteningOfMovementAuthority__1ae6
{
...
typedef struct Message__InternalCdRouteReleaseInhibitionActivationRequest__3e1e
{
    void *BoundaryId;
...
{
    TimerOverrunState__b8ce ReportedTimerOverrunState;
...
typedef struct Message__MsgTimeout__ff4f
{

} Message__MsgTimeout__ff4f;
...
/// Msg_Additional_Information
/// UML Identifier: _e5995a4c-845f-412d-a606-1a6dadfdea1d
typedef struct Message__MsgAdditionalInformation__e599
{
    int Speed;
    int WheelDiameter;
} Message__MsgAdditionalInformation__e599;
