...
typedef struct FMonitorTimeValues {
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(FMonitorTimeValues_D3inLcpfProtectionStateValue, )
  ...
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FMonitorTimeValues_D6outLcMonitoringStatusValue, )
      D6outLcMonitoringStatus;

  /// d75out_LC_Failure_Status
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FMonitorTimeValues_D75outLcFailureStatusValue, )
      D75outLcFailureStatus;
