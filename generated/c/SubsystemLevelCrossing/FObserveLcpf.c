...
void make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(
  ...
  LOG("[FObserveLcpf] Entering state Waiting in region "
      "root__ObserveLcpf__ObserveLcpfProtectionState");
  region->state =
      FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting;
};
...
void make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState(
  ...
  make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(
      self, x);
  return;
}
...
void make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState(
  ...
  make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__Waiting(
      self, x);
  return;
}
...
void make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState(
    FObserveLcpf *self,
    FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__state_struct));

  make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__Waiting(
      self, x);
  return;
}
...
void make_state_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus(
    FObserveLcpf *self,
    FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__state_struct));
...
void make_state_FObserveLcpf__root__ObserveLcpf(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *region) {
  ...
  make_state_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState(
      self, &region->ObserveLcpf.ObserveLcpfFailureState);
  make_state_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus(
      self, &region->ObserveLcpf.ObserveMonitoringStatus);
};

void make_state_FObserveLcpf__root(FObserveLcpf *self,
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Unprotected(
  ...
  if (self->Change204.IsTriggered) {
    self->D3outLcpfProtectionState.Value =
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x) {
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x) {
  ...
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Unprotected:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Unprotected(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Protected:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Protected(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Idle:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Idle(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState__Waiting(
        self, x);
    break;
  }
}
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState(
  ...
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__ObstacleInConflictArea:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__ObstacleInConflictArea(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__Waiting:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState__Waiting(
        self, x);
    break;
  }
}
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__NoFailureDetected(
  ...
  if (self->Change237.IsTriggered) {
    self->D74outLcpfFailureState.Value =
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x) {
  ...
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__NoFailureDetected:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__NoFailureDetected(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__FailureDetected:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__FailureDetected(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__Waiting:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState__Waiting(
        self, x);
    break;
  }
}
...
void transition_from_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x) {
  ...
  case FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__MonitoringParameterSet2:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__MonitoringParameterSet2(
        self, x);
    break;
  case FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__MonitoringParameterSet1:
    transition_from_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus__MonitoringParameterSet1(
        self, x);
    break;
  }
}

void transition_from_FObserveLcpf__root__ObserveLcpf(
    FObserveLcpf *self, FObserveLcpf__root__state_struct *x) {
  transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfProtectionState(
      self, x);
  transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfObstacleDetectionState(
      self, x);
  transition_from_FObserveLcpf__root__ObserveLcpf__ObserveLcpfFailureState(self,
                                                                           x);
  transition_from_FObserveLcpf__root__ObserveLcpf__ObserveMonitoringStatus(self,
                                                                           x);
}

void transition_from_FObserveLcpf__root(FObserveLcpf *self,
                                        FObserveLcpf__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FObserveLcpf *self) {
  self->Change204.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Idle));
  self->Change209.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Protected));
  self->Change205.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Idle));
  self->Change212.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Unprotected));
  self->Change207.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Protected));
  self->Change214.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Unprotected));
  self->Change206.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Idle));
  self->Change208.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Protected));
  self->Change213.IsTriggered = IsTriggered(
      MakeChange(self->D30inLcpfProtectionState.IsSignalled,
                 self->D30inLcpfProtectionState.Value ==
                     FObserveLcpf_D30inLcpfProtectionStateValue__Unprotected));
  self->Change226.IsTriggered =
      IsTriggered(MakeChange(self->D31inObstacleDetectionState.IsSignalled,
                             self->D31inObstacleDetectionState.Value));
  self->Change558.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D31inObstacleDetectionState.IsSignalled,
                              self->D31inObstacleDetectionState.Value)));
  self->Change225.IsTriggered =
      IsTriggered(MakeChange(self->D31inObstacleDetectionState.IsSignalled,
                             self->D31inObstacleDetectionState.Value));
  self->Change559.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D31inObstacleDetectionState.IsSignalled,
                              self->D31inObstacleDetectionState.Value)));
  self->Change237.IsTriggered =
      IsTriggered(MakeChange(self->D32inLcpfFailureState.IsSignalled,
                             self->D32inLcpfFailureState.Value));
  self->Change564.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D32inLcpfFailureState.IsSignalled,
                              self->D32inLcpfFailureState.Value)));
  self->Change1.IsTriggered =
      IsTriggered(MakeChange(self->D32inLcpfFailureState.IsSignalled,
                             self->D32inLcpfFailureState.Value));
  self->Change563.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D32inLcpfFailureState.IsSignalled,
                              self->D32inLcpfFailureState.Value)));
  self->Change2.IsTriggered = IsTriggered(MakeChange(
      self->D33inMonitoringState.IsSignalled,
      self->D33inMonitoringState.Value ==
          FObserveLcpf_D33inMonitoringStateValue__MonitoringParameterSet1));
  self->Change238.IsTriggered = IsTriggered(MakeChange(
      self->D33inMonitoringState.IsSignalled,
      self->D33inMonitoringState.Value ==
