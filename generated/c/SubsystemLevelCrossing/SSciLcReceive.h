...
typedef enum SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue {
            SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue__NULL__,
...
SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue__NoClosureTimeOverrun,
            SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue__UNKNOWN__
        } SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue;
...
/// d5out_Msg_LC_Functional_Status
            ...
            DataPort(SSciLcReceive_D5outMsgLcFunctionalStatusValue, ) D5outMsgLcFunctionalStatus;
...
/// d91out_Msg_Obstacle_Detection_Status
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D91outMsgObstacleDetectionStatusValue, ) D91outMsgObstacleDetectionStatus;
...
/// d72out_Msg_LC_Failure_Status_Critical
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D72outMsgLcFailureStatusCriticalValue, ) D72outMsgLcFailureStatusCritical;
...
/// d18out_Msg_Detection_Element_Status
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D18outMsgDetectionElementStatusValue, ) D18outMsgDetectionElementStatus;
...
/// d9out_Msg_Local_Operation_Handover
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D9outMsgLocalOperationHandoverValue, ) D9outMsgLocalOperationHandover;
            
/// d61out_Msg_LC_Monitoring_Status_Closure_time
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimeValue, ) D61outMsgLcMonitoringStatusClosureTime;
...
/// d71out_Msg_LC_Failure_Status_Non_Critical
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D71outMsgLcFailureStatusNonCriticalValue, ) D71outMsgLcFailureStatusNonCritical;
            
/// d62out_Msg_LC_Monitoring_Status_Changed_Monitoring_Parameter
            /// Trigger: False, DataPort: True, In: False, Out: True, External: False
            DataPort(SSciLcReceive_D62outMsgLcMonitoringStatusChangedMonitoringParameterValue, ) D62outMsgLcMonitoringStatusChangedMonitoringParameter;
            

    // Messages -- Incoming
    MessagePort(Message__MsgDetectionElementStatus__aa8b) InMsgDetectionElementStatus__aa8b;
MessagePort(Message__MsgLcFailureStatus__5440) InMsgLcFailureStatus__5440;
MessagePort(Message__MsgLcFunctionalStatus__ab8c) InMsgLcFunctionalStatus__ab8c;
MessagePort(Message__MsgLcMonitoringStatus__1d45) InMsgLcMonitoringStatus__1d45;
MessagePort(Message__MsgLocalOperationHandover__0594) InMsgLocalOperationHandover__0594;
MessagePort(Message__MsgLocalRequest__daeb) InMsgLocalRequest__daeb;
MessagePort(Message__MsgObstacleDetectionStatus__734d) InMsgObstacleDetectionStatus__734d;
    // Messages -- Outgoing
