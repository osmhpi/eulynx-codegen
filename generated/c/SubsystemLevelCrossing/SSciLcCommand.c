...
void make_state_SSciLcCommand__root__SendingCommands(
    SSciLcCommand *self, SSciLcCommand__root__state_struct *region) {
  LOG("[SSciLcCommand] Entering state SendingCommands in region root");
  region->state = SSciLcCommand__root__SendingCommands;
};

void make_state_SSciLcCommand__root(SSciLcCommand *self,
...
void transition_from_SSciLcCommand__root__SendingCommands(
    SSciLcCommand *self, SSciLcCommand__root__state_struct *x) {

  if (self->Change863.IsTriggered) {
    if (((self->D1inCdActivation.Value ==
...
void transition_from_SSciLcCommand__root(SSciLcCommand *self,
                                         SSciLcCommand__root__state_struct *x) {
  switch (x->state) {
