...
void make_state_FControlLocalOperation__root__ControlLocalOperation__CommandHandoverToLocalOperation(
  ...
  make_state_FControlLocalOperation__root__ControlLocalOperation__CommandHandoverToLocalOperation__Waiting(
      self, x);
  return;
}
...
void make_state_FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator(
  ...
  make_state_FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator__Waiting(
      self, x);
  return;
}

void make_state_FControlLocalOperation__root__ControlLocalOperation(
    FControlLocalOperation *self,
  ...
  make_state_FControlLocalOperation__root__ControlLocalOperation__ReceiveInputForLocalOperationByLocalOperator(
      self, &region->ControlLocalOperation
                 .ReceiveInputForLocalOperationByLocalOperator);
...
void make_state_FControlLocalOperation__root(
    FControlLocalOperation *self,
...
void transition_from_FControlLocalOperation__root__ControlLocalOperation__ReceiveInputForLocalOperationByLocalOperator__Allow(
  ...
  if (self->Change468.IsTriggered) {
    ...
    make_state_FControlLocalOperation__root__ControlLocalOperation__ReceiveInputForLocalOperationByLocalOperator__Return(
        self,
        &x->ControlLocalOperation.ReceiveInputForLocalOperationByLocalOperator);
    return;
  }
}
...
void transition_from_FControlLocalOperation__root__ControlLocalOperation__ReceiveInputForLocalOperationByLocalOperator(
    FControlLocalOperation *self,
    FControlLocalOperation__root__state_struct *x) {
  switch (x->ControlLocalOperation.ReceiveInputForLocalOperationByLocalOperator
              .state) {
...
void transition_from_FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator(
  ...
  case FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator__Waiting:
    transition_from_FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator__Waiting(
        self, x);
    break;
...
void transition_from_FControlLocalOperation__root__ControlLocalOperation(
    FControlLocalOperation *self,
    FControlLocalOperation__root__state_struct *x) {
  transition_from_FControlLocalOperation__root__ControlLocalOperation__CommandHandoverToLocalOperation(
      self, x);
  transition_from_FControlLocalOperation__root__ControlLocalOperation__ReceiveInputForLocalOperationByLocalOperator(
      self, x);
  transition_from_FControlLocalOperation__root__ControlLocalOperation__RequestByLocalOperator(
      self, x);
}

void transition_from_FControlLocalOperation__root(
    FControlLocalOperation *self,
    FControlLocalOperation__root__state_struct *x) {
  switch (x->state) {
  case FControlLocalOperation__root__ControlLocalOperation:
    transition_from_FControlLocalOperation__root__ControlLocalOperation(self,
                                                                        x);
    break;
  }
}
...
static void evaluateChangeEvents(FControlLocalOperation *self) {
  self->Change475.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Established));
  self->Change478.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change481.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__NoHandover));
  self->Change477.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Established));
  self->Change483.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__NoHandover));
  self->Change482.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__NoHandover));
  self->Change480.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change479.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change476.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Established));
  self->Change468.IsTriggered = IsTriggered(MakeChange(
      self->D81inLocalOperationHandover.IsSignalled,
  ...
  self->Change465.IsTriggered = IsTriggered(MakeChange(
      self->D81inLocalOperationHandover.IsSignalled,
      self->D81inLocalOperationHandover.Value ==
          FControlLocalOperation_D81inLocalOperationHandoverValue__AllowHandoverToLocalOperator));
  self->Change463.IsTriggered = IsTriggered(MakeChange(
      self->D81inLocalOperationHandover.IsSignalled,
      self->D81inLocalOperationHandover.Value ==
          FControlLocalOperation_D81inLocalOperationHandoverValue__AllowHandoverToLocalOperator));
  self->Change466.IsTriggered = IsTriggered(MakeChange(
      self->D81inLocalOperationHandover.IsSignalled,
      self->D81inLocalOperationHandover.Value ==
          FControlLocalOperation_D81inLocalOperationHandoverValue__ReturnHandoverFromLocalOperator));
  self->Change471.IsTriggered = IsTriggered(MakeChange(
      self->D82inRequestByLocalOperator.IsSignalled,
  ...
  self->Change473.IsTriggered = IsTriggered(MakeChange(
      self->D82inRequestByLocalOperator.IsSignalled,
      self->D82inRequestByLocalOperator.Value ==
          FControlLocalOperation_D82inRequestByLocalOperatorValue__RequestToDeactivateTheLevelCrossing));
  self->Change474.IsTriggered = IsTriggered(MakeChange(
      self->D82inRequestByLocalOperator.IsSignalled,
      self->D82inRequestByLocalOperator.Value ==
          FControlLocalOperation_D82inRequestByLocalOperatorValue__RequestToDeactivateTheLevelCrossing));
  self->Change472.IsTriggered = IsTriggered(MakeChange(
      self->D82inRequestByLocalOperator.IsSignalled,
      self->D82inRequestByLocalOperator.Value ==
          FControlLocalOperation_D82inRequestByLocalOperatorValue__RequestToActivateTheLevelCrossing));
}
