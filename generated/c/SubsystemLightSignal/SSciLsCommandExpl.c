...
void make_state_SSciLsCommandExpl__root__SendingCommands(SSciLsCommandExpl *self, SSciLsCommandExpl__root__state_struct *region) {
...
void make_state_SSciLsCommandExpl__root(SSciLsCommandExpl *self, SSciLsCommandExpl__root__state_struct *x) {
    memset(x, 0, sizeof(SSciLsCommandExpl__root__state_struct));
                ...
                make_state_SSciLsCommandExpl__root__SendingCommands(self, x); return;
}
        ...
        void transition_from_SSciLsCommandExpl__root__SendingCommands(SSciLsCommandExpl *self, SSciLsCommandExpl__root__state_struct *x) {
            
            if (self->Change1005.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommandExpl_D23inSignalAspectValue__SignalAspect2) && (self->D9PdiConnectionState.Value == SSciLsCommandExpl_D9PdiConnectionStateValue__Established)) {
                
  self->OutCdIndicateSignalAspect__e570.Value.CommandedSignalAspectState = SignalAspectControlableState__0dcc__SignalAspect2; 
...
if (self->Change1006.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommandExpl_D23inSignalAspectValue__MostRestrictAspect) && (self->D9PdiConnectionState.Value == SSciLsCommandExpl_D9PdiConnectionStateValue__Established)) {
                
  self->OutCdIndicateSignalAspect__e570.Value.CommandedSignalAspectState = SignalAspectControlableState__0dcc__MostRestrictAspect; 
self->OutCdIndicateSignalAspect__e570.Value.CommandedDarkState = self->D24inIntentionallyDark.Value;
  self->OutCdIndicateSignalAspect__e570.HasMessage = 1;
                make_state_SSciLsCommandExpl__root__SendingCommands(self, x); return;
            }
...
if (self->Change1007.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommandExpl_D23inSignalAspectValue__SignalAspect1) && (self->D9PdiConnectionState.Value == SSciLsCommandExpl_D9PdiConnectionStateValue__Established)) {
                
  self->OutCdIndicateSignalAspect__e570.Value.CommandedSignalAspectState = SignalAspectControlableState__0dcc__SignalAspect1; 
self->OutCdIndicateSignalAspect__e570.Value.CommandedDarkState = self->D24inIntentionallyDark.Value;
  self->OutCdIndicateSignalAspect__e570.HasMessage = 1;
                make_state_SSciLsCommandExpl__root__SendingCommands(self, x); return;
            }
...
if (self->Change1015.IsTriggered) {
                if ((self->D25inLuminosity.Value == SSciLsCommandExpl_D25inLuminosityValue__Night) && (self->D9PdiConnectionState.Value == SSciLsCommandExpl_D9PdiConnectionStateValue__Established)) {
...
if (self->Change1014.IsTriggered) {
                if ((self->D25inLuminosity.Value == SSciLsCommandExpl_D25inLuminosityValue__Day) && (self->D9PdiConnectionState.Value == SSciLsCommandExpl_D9PdiConnectionStateValue__Established)) {
...
static void evaluateChangeEvents(SSciLsCommandExpl *self) {
    self->Change1005.IsTriggered = self->T23inSignalAspect.IsTriggered;
self->Change1006.IsTriggered = self->T23inSignalAspect.IsTriggered;
...
self->Change1014.IsTriggered = self->T25inLuminosity.IsTriggered;
}
