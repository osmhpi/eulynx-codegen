...
void make_state_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect__root(
  ...
  if (!(self->D6inFaultLampsMostRestrict.Value)) {
    ...
    self->D8outSetIntentionallyDark.Value =
        self->D3inRequiredIntentionallyDark.Value;
    self->MemSetAspect =
...
void make_state_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect(
    FControlSignalAspect *self,
    FControlSignalAspect__root__OperatingVoltage__root__state_struct *region) {
...
void make_state_FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspectLuminosityFailure(
    FControlSignalAspect *self,
    FControlSignalAspect__root__OperatingVoltage__root__state_struct *region) {
  LOG("[FControlSignalAspect] Entering state "
      "SetNoSignalAspectLuminosityFailure in region "
      "root__OperatingVoltage__root");
  region->state =
...
void make_state_FControlSignalAspect__root__OperatingVoltage__root(
    FControlSignalAspect *self,
    FControlSignalAspect__root__OperatingVoltage__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(FControlSignalAspect__root__OperatingVoltage__root__state_struct));
...
void make_state_FControlSignalAspect__root__NationalAspect(
    FControlSignalAspect *self,
...
void make_state_FControlSignalAspect__root__OperatingVoltage(
    FControlSignalAspect *self,
    FControlSignalAspect__root__state_struct *region) {
  ...
  make_state_FControlSignalAspect__root__OperatingVoltage__root(
      self, &region->OperatingVoltage.root);
};

void make_state_FControlSignalAspect__root(
...
void transition_from_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect(
    FControlSignalAspect *self, FControlSignalAspect__root__state_struct *x) {
  transition_from_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect__root(
      self, x);
...
void transition_from_FControlSignalAspect__root__OperatingVoltage__root(
    FControlSignalAspect *self, FControlSignalAspect__root__state_struct *x) {
  switch (x->OperatingVoltage.root.state) {
  case FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect:
    transition_from_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect(
        self, x);
    break;
  case FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspectLuminosityFailure:
    transition_from_FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspectLuminosityFailure(
        self, x);
    break;
  }
}

void transition_from_FControlSignalAspect__root__NationalAspect(
    FControlSignalAspect *self, FControlSignalAspect__root__state_struct *x) {
...
void transition_from_FControlSignalAspect__root__OperatingVoltage(
    FControlSignalAspect *self, FControlSignalAspect__root__state_struct *x) {
...
void transition_from_FControlSignalAspect__root(
    FControlSignalAspect *self, FControlSignalAspect__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FControlSignalAspect *self) {
  self->Change184.IsTriggered = IsTriggered(OrChange(
      MakeChange(
      ...
      MakeChange(self->D5inFaultLampsAspect2.IsSignalled,
                 self->D5inFaultLampsAspect2.Value)));
  self->Change186.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D2inRequiredSignalAspect.IsSignalled,
          self->D2inRequiredSignalAspect.Value ==
              FControlSignalAspect_D2inRequiredSignalAspectValue__MostRestrictAspect),
  ...
  self->Change259.IsTriggered =
      IsTriggered(MakeChange(self->D3inRequiredIntentionallyDark.IsSignalled,
                             self->D3inRequiredIntentionallyDark.Value));
  self->Change565.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D3inRequiredIntentionallyDark.IsSignalled,
                              self->D3inRequiredIntentionallyDark.Value)));
  ...
  self->Change428.IsTriggered =
      IsTriggered(MakeChange(self->D6inFaultLampsMostRestrict.IsSignalled,
                             self->D6inFaultLampsMostRestrict.Value));
  ...
  self->Change287.IsTriggered =
      IsTriggered(MakeChange(self->D4inFaultLampsAspect1.IsSignalled,
