...
void make_state_SSciLsCommand__root(SSciLsCommand *self, SSciLsCommand__root__state_struct *x) {
    memset(x, 0, sizeof(SSciLsCommand__root__state_struct));
                ...
                make_state_SSciLsCommand__root__SendingCommands(self, x); return;
}
        ...
        void transition_from_SSciLsCommand__root__SendingCommands(SSciLsCommand *self, SSciLsCommand__root__state_struct *x) {
            ...
            if (self->Change1004.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommand_D23inSignalAspectValue__SignalAspect2) && (self->D9PdiConnectionState.Value == SSciLsCommand_D9PdiConnectionStateValue__Established)) {
...
if (self->Change1008.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommand_D23inSignalAspectValue__MostRestrictAspect) && (self->D9PdiConnectionState.Value == SSciLsCommand_D9PdiConnectionStateValue__Established)) {
...
if (self->Change1003.IsTriggered) {
                if ((self->D23inSignalAspect.Value == SSciLsCommand_D23inSignalAspectValue__SignalAspect1) && (self->D9PdiConnectionState.Value == SSciLsCommand_D9PdiConnectionStateValue__Established)) {
...
if (self->Change1016.IsTriggered) {
                if ((self->D25inLuminosity.Value == SSciLsCommand_D25inLuminosityValue__Night) && (self->D9PdiConnectionState.Value == SSciLsCommand_D9PdiConnectionStateValue__Established)) {
...
if (self->Change1017.IsTriggered) {
                if ((self->D25inLuminosity.Value == SSciLsCommand_D25inLuminosityValue__Day) && (self->D9PdiConnectionState.Value == SSciLsCommand_D9PdiConnectionStateValue__Established)) {
