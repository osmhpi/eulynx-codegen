...
FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspectLuminosityFailure
...
typedef struct FControlSignalAspect__root__OperatingVoltage__root__state_struct {
    ...
    union {
        FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect__state_struct ControllingSignalAspect;
    };
...
/// Mem_Set_Aspect
    ...
    // Change Events
    ChangeEvent Change184; // d2in_Required_Signal_Aspect = "Most Restrict Aspect" OR D5in_Fault_Lamps_Aspect_2
ChangeEvent Change186; // d2in_Required_Signal_Aspect = "Most Restrict Aspect" OR D5in_Fault_Lamps_Aspect_2
ChangeEvent Change190; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change191; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change194; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change259; // d3in_Required_Intentionally_Dark
ChangeEvent Change565; // NOT d3in_Required_Intentionally_Dark
ChangeEvent Change189; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change196; // d2in_Required_Signal_Aspect = "Signal Aspect 2"
ChangeEvent Change188; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change428; // D6in_Fault_Lamps_Most_Restrict
ChangeEvent Change260; // d3in_Required_Intentionally_Dark
ChangeEvent Change566; // NOT d3in_Required_Intentionally_Dark
ChangeEvent Change193; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change195; // d2in_Required_Signal_Aspect = "Signal Aspect 2"
ChangeEvent Change192; // d2in_Required_Signal_Aspect = "Signal Aspect 1"
ChangeEvent Change577; // NOT D6in_Fault_Lamps_Most_Restrict
ChangeEvent Change187; // d2in_Required_Signal_Aspect = "Most Restrict Aspect"
ChangeEvent Change185; // d2in_Required_Signal_Aspect = "Most Restrict Aspect"
ChangeEvent Change198; // d2in_Required_Signal_Aspect = "Signal Aspect 2"
ChangeEvent Change199; // d2in_Required_Signal_Aspect = "Signal Aspect 2"
ChangeEvent Change197; // d2in_Required_Signal_Aspect = "Signal Aspect 2"
ChangeEvent Change287; // D4in_Fault_Lamps_Aspect_1
ChangeEvent Change285; // D4in_Fault_Lamps_Aspect_1
ChangeEvent Change286; // D4in_Fault_Lamps_Aspect_1
ChangeEvent Change261; // d3in_Required_Intentionally_Dark
ChangeEvent Change567; // NOT d3in_Required_Intentionally_Dark
ChangeEvent Change514; // d9in_Set_Luminosity = "Undefined"
ChangeEvent Change513; // d9in_Set_Luminosity <> "Undefined"
ChangeEvent Change335; // d51in_EST_EfeS_State = "BOOTING"
ChangeEvent Change337; // d51in_EST_EfeS_State = "BOOTING" ORd51in_EST_EfeS_State = "INITIALISING"
ChangeEvent Change368; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE" OR d51in_EST_EfeS_State = "FALLBACK_MODE"
