...
static SSciEfesPrim_MemPdiVersionResultValue map_Result_to_MemPdiVersionResult(MsgPdiVersionCheck__9827_ResultValue value) {
            switch (value) {
                case MsgPdiVersionCheck__9827_ResultValue__NULL__: return SSciEfesPrim_MemPdiVersionResultValue__NULL__;
                case MsgPdiVersionCheck__9827_ResultValue__UNKNOWN__: return SSciEfesPrim_MemPdiVersionResultValue__UNKNOWN__;
                case MsgPdiVersionCheck__9827_ResultValue__Match: return SSciEfesPrim_MemPdiVersionResultValue__Match; 
case MsgPdiVersionCheck__9827_ResultValue__NotMatch: return SSciEfesPrim_MemPdiVersionResultValue__NotMatch; 
case MsgPdiVersionCheck__9827_ResultValue__Unknown: return SSciEfesPrim_MemPdiVersionResultValue__Unknown;
                default: abort();
            }
        }
...
static void Cop1Init(SSciEfesPrim *self ) {
            self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__NoError;self->D60outPdiCloseReason.IsSignalled = true; 
...
void make_state_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForVersionCheck(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForInitialisation(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root__Establishing__root__ReceivingStatus(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root__Establishing__root__OtherVersionRequired(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root__Establishing__root(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__Establishing__root__state_struct *x) {
...
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__WaitingForVersionCheck;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForVersionCheck(self, x); return;
}



void make_state_SSciEfesPrim__root__Active__root__Establishing(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root__Established(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__state_struct *region) {
...
void make_state_SSciEfesPrim__root__Active__root(SSciEfesPrim *self, SSciEfesPrim__root__Active__root__state_struct *x) {
    memset(x, 0, sizeof(SSciEfesPrim__root__Active__root__state_struct));
                ...
                make_state_SSciEfesPrim__root__Active__root__Establishing(self, x); return;
}
...
void make_state_SSciEfesPrim__root(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
    ...
    Cop1Init(self);
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__DisconnectedNoScp;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__DisconnectedNoScp(self, x); return;
}
        ...
        void transition_from_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForVersionCheck(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
...
memcpy(self->MemChecksumData, self->InMsgPdiVersionCheck__9827.Value.ChecksumData, sizeof(self->MemChecksumData));
...
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Suspended;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Suspended(self, x); return;
            }
if (memcmp(self->MemChecksumData, self->D4inConChecksumData.Value, sizeof(self->MemChecksumData)) == 0) {
                
  
  self->OutCdInitialisationRequest__8d96.HasMessage = 1;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__WaitingForInitialisation;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForInitialisation(self, &x->Active.root.Establishing.root); return;
            }
            }
...
self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__PdiOtherVersionRequired;self->D60outPdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__OtherVersionRequired;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Establishing__root__OtherVersionRequired(self, &x->Active.root.Establishing.root); return;
            }
...
void transition_from_SSciEfesPrim__root__Active__root__Establishing__root__WaitingForInitialisation(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
            
            if (self->InMsgStartInitialisation__43d2.HasMessage) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__ReceivingStatus;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Establishing__root__ReceivingStatus(self, &x->Active.root.Establishing.root); return;
            }
        }
        
void transition_from_SSciEfesPrim__root__Active__root__Establishing__root__ReceivingStatus(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
            
            if (self->InMsgInitialisationCompleted__75d9.HasMessage) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Established;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Established(self, &x->Active.root); return;
            }
        }
        
void transition_from_SSciEfesPrim__root__Active__root__Establishing__root__OtherVersionRequired(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
            
            if (self->Change1168.IsTriggered) {
                
                make_state_SSciEfesPrim__root__Active__root__Establishing(self, &x->Active.root); return;
            }
        }
        

        void transition_from_SSciEfesPrim__root__Active__root__Establishing__root(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
...
case SSciEfesPrim__root__Active__root__Establishing__root__OtherVersionRequired:
        ...
        void transition_from_SSciEfesPrim__root__Active__root__Establishing(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
  ...
  self->OutCdClosePdi__8a06.HasMessage = 1;
self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__PdiTimeout;self->D60outPdiCloseReason.IsSignalled = true;
                make_state_SSciEfesPrim__root__Active__root__Establishing(self, &x->Active.root); return;
            }
        }
        
void transition_from_SSciEfesPrim__root__Active__root__Established(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
...
if (self->Change1217.IsTriggered) {
                ...
                make_state_SSciEfesPrim__root__Active(self, x); return;
            }
        }
...
void transition_from_SSciEfesPrim__root__ImpermissibleNoScp(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
            ...
            if (self->Change1163.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__RequestedNoScp;self->D50outPdiConnectionState.IsSignalled = true;
self->T6outEstablishScpConnection.Trigger = true;
                make_state_SSciEfesPrim__root__RequestedNoScp(self, x); return;
            }
if (self->Change1219.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Impermissible;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Impermissible(self, x); return;
            }
        }
...
void transition_from_SSciEfesPrim__root__Impermissible(SSciEfesPrim *self, SSciEfesPrim__root__state_struct *x) {
            ...
            if (self->Change742.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__ImpermissibleNoScp;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__ImpermissibleNoScp(self, x); return;
            }
...
if (self->Change1223.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Disconnected;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Disconnected(self, x); return;
            }
        }
...
if (self->InMsgResetPdi__59f4.HasMessage) {
                ...
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EfesProtocolError;self->D60outPdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Impermissible;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Impermissible(self, x); return;
            }
            }
if (self->InMsgResetPdi__59f4.HasMessage) {
                ...
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EfesContentTelegramError;self->D60outPdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Impermissible;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Impermissible(self, x); return;
            }
            }
if (self->InMsgResetPdi__59f4.HasMessage) {
                ...
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EfesFormalTelegramError;self->D60outPdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Impermissible;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Impermissible(self, x); return;
            }
            }
...
if (self->Change978.IsTriggered) {
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EilProtocolError;self->D60outPdiCloseReason.IsSignalled = true;
...
if (self->Change987.IsTriggered) {
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EilFormalTelegramError;self->D60outPdiCloseReason.IsSignalled = true;
...
if (self->Change997.IsTriggered) {
                self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__EilContentTelegramError;self->D60outPdiCloseReason.IsSignalled = true;
...
if (self->Change1170.IsTriggered) {
  ...
  self->OutCdClosePdi__8a06.HasMessage = 1;
self->D60outPdiCloseReason.Value = SSciEfesPrim_D60outPdiCloseReasonValue__PdiNormalClose;self->D60outPdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciEfesPrim_D50outPdiConnectionStateValue__Disconnected;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciEfesPrim__root__Disconnected(self, x); return;
            }
        }
