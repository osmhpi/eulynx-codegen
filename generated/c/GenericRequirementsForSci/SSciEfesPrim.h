...
typedef struct SSciEfesPrim {
  ...
  DataPort(SSciEfesPrim_D50outPdiConnectionStateValue, )
  ...
  MessagePort(Message__CdReleasePdiForMaintenance__3e43)
      OutCdReleasePdiForMaintenance__3e43;
  ...
  // Change Events
  ChangeEvent Change1168; // T47in_Con_Other_PDI_Version_Available
  ChangeEvent Change1171; // T48in_Disable_Or_Disconnect_PDI_EfeS
  ChangeEvent Change1217; // T5in_SCP_Connection_Established
  ChangeEvent Change1163; // T45in_Reset_Severe_Error
  ChangeEvent Change1219; // T5in_SCP_Connection_Established
  ChangeEvent Change742;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change1162; // T45in_Reset_Severe_Error
  ChangeEvent Change736;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change1174; // T49in_Enable_Or_Connect_PDI_EfeS
  ChangeEvent Change1173; // T49in_Enable_Or_Connect_PDI_EfeS
  ChangeEvent Change1223; // T5in_SCP_Connection_Established
  ChangeEvent Change737;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change978;  // T20in_Protocol_Error
  ChangeEvent Change987;  // T21in_Formal_Telegram_Error
  ChangeEvent Change997;  // T22in_Content_Telegram_Error
  ChangeEvent Change1155; // T44in_Initiate_Maintenance
  ChangeEvent Change1170; // T48in_Disable_Or_Disconnect_PDI_EfeS
  ChangeEvent Change744;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change1172; // T48in_Disable_Or_Disconnect_PDI_EfeS
