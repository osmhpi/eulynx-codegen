...
typedef struct SSciAdjSec {
  ...
  MessagePort(Message__SecStatusReportCompleted__339c)
      InSecStatusReportCompleted__339c;
  ...
  // Messages -- Outgoing
  MessagePort(Message__StartSecStatusReport__2c19)
      OutStartSecStatusReport__2c19;
  MessagePort(Message__MsgStatusReportCompleted__c465)
  ...
  // Change Events
  ChangeEvent Change1018; // t25in_Prim_Status_Report_Complete
  ChangeEvent Change1218; // T5in_SCP_Connection_Established
  ChangeEvent Change739;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change740;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change976;  // T20in_Protocol_Error
  ChangeEvent Change985;  // T21in_Formal_Telegram_Error
  ChangeEvent Change998;  // T22in_Content_Telegram_Error
