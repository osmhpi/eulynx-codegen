...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__SendingSecStatus(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__ReceivingPrimStatus(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Establishing__root(SSciAdjSec *self, SSciAdjSec__root__Active__root__Establishing__root__state_struct *x) {
...
memcpy(self->OutMsgPdiVersionCheck__9827.Value.ChecksumData, self->D4inConChecksumData.Value, sizeof(self->OutMsgPdiVersionCheck__9827.Value.ChecksumData)); 
...
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForInitialisation;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(self, x); return;
            }
if (!(self->MemPdiVersion == self->D3inConPdiVersion.Value)) {
...
self->OutMsgPdiVersionCheck__9827.Value.PDIVersion = self->D3inConPdiVersion.Value;
  self->OutMsgPdiVersionCheck__9827.HasMessage = 1;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__VersionUnequal;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal(self, x); return;
            }
}



void make_state_SSciAdjSec__root__Active__root__Establishing(SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root__Established(SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *region) {
...
void make_state_SSciAdjSec__root__Active__root(SSciAdjSec *self, SSciAdjSec__root__Active__root__state_struct *x) {
  ...
  self->OutEstablishingPdiConnection__41d4.HasMessage = 1;
                make_state_SSciAdjSec__root__Active__root__Establishing(self, x); return;
}
...
void make_state_SSciAdjSec__root(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
    ...
    Cop1Init(self);
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__RequestedNoScp;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__RequestedNoScp(self, x); return;
}
        ...
        void transition_from_SSciAdjSec__root__Active__root__Establishing__root__ReadyForInitialisation(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            
            if (self->InCdInitialisationRequest__8d96.HasMessage) {
                
  
  self->OutMsgStartInitialisation__43d2.HasMessage = 1;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__SendingSecStatus;self->D50outPdiConnectionState.IsSignalled = true;

  
  self->OutStartSecStatusReport__2c19.HasMessage = 1;
                make_state_SSciAdjSec__root__Active__root__Establishing__root__SendingSecStatus(self, &x->Active.root.Establishing.root); return;
            }
        }
        
void transition_from_SSciAdjSec__root__Active__root__Establishing__root__SendingSecStatus(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            
            if (self->InSecStatusReportCompleted__339c.HasMessage) {
                self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReceivingPrimStatus;self->D50outPdiConnectionState.IsSignalled = true;

  
  self->OutMsgStatusReportCompleted__c465.HasMessage = 1;
                make_state_SSciAdjSec__root__Active__root__Establishing__root__ReceivingPrimStatus(self, &x->Active.root.Establishing.root); return;
            }
        }
        
void transition_from_SSciAdjSec__root__Active__root__Establishing__root__VersionUnequal(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            
            
        }
        
void transition_from_SSciAdjSec__root__Active__root__Establishing__root__ReceivingPrimStatus(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            
            if (self->InMsgStatusReportCompleted__c465.HasMessage) {
                self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__CheckingPrimStatus;self->D50outPdiConnectionState.IsSignalled = true;
self->T27outCheckPrimStatus.Trigger = true;
                make_state_SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus(self, &x->Active.root.Establishing.root); return;
            }
        }
        
void transition_from_SSciAdjSec__root__Active__root__Establishing__root__CheckingPrimStatus(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            
            if (self->Change1018.IsTriggered) {
                
  
  self->OutMsgInitialisationCompleted__75d9.HasMessage = 1;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__Established;self->D50outPdiConnectionState.IsSignalled = true;

  
  self->OutPdiConnectionEstablished__019d.HasMessage = 1;
                make_state_SSciAdjSec__root__Active__root__Established(self, &x->Active.root); return;
            }
        }
        

        void transition_from_SSciAdjSec__root__Active__root__Establishing__root(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
...
case SSciAdjSec__root__Active__root__Established:
        ...
        void transition_from_SSciAdjSec__root__RequestedNoScp(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            ...
            if (self->Change1218.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
        }
...
void transition_from_SSciAdjSec__root__ReadyForPdi(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            ...
            if (self->InCdPdiVersionCheck__ffab.HasMessage) {
                ...
                make_state_SSciAdjSec__root__Active(self, x); return;
            }
if (self->Change739.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__RequestedNoScp;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__RequestedNoScp(self, x); return;
            }
        }
...
void transition_from_SSciAdjSec__root__Active(SSciAdjSec *self, SSciAdjSec__root__state_struct *x) {
            ...
            if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PdiTimeout;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PrimFormalTelegramError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PrimProtocolError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PdiOtherVersionRequired;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PdiChecksumMismatch;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->InCdClosePdi__8a06.HasMessage) {
                ...
                self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__PrimContentTelegramError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
            }
if (self->Change740.IsTriggered) {
                self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__RequestedNoScp;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__RequestedNoScp(self, x); return;
            }
if (self->Change976.IsTriggered) {
...
self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__SecProtocolError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
if (self->Change985.IsTriggered) {
  ...
  self->OutMsgResetPdi__59f4.HasMessage = 1;
self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__SecFormalTelegramError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
if (self->Change998.IsTriggered) {
                
  self->OutMsgResetPdi__59f4.Value.ReportedResetReason = ResetReason__44e3__ContentTelegramError;
  self->OutMsgResetPdi__59f4.HasMessage = 1;
self->D60PdiCloseReason.Value = SSciAdjSec_D60PdiCloseReasonValue__SecContentTelegramError;self->D60PdiCloseReason.IsSignalled = true;
self->D50outPdiConnectionState.Value = SSciAdjSec_D50outPdiConnectionStateValue__ReadyForPdi;self->D50outPdiConnectionState.IsSignalled = true;
                make_state_SSciAdjSec__root__ReadyForPdi(self, x); return;
            }
        }
...
static void evaluateChangeEvents(SSciAdjSec *self) {
    self->Change1018.IsTriggered = self->T25inPrimStatusReportComplete.IsTriggered;
self->Change1218.IsTriggered = self->T5inScpConnectionEstablished.IsTriggered;
self->Change739.IsTriggered = self->T10inScpConnectionTerminated.IsTriggered;
self->Change740.IsTriggered = self->T10inScpConnectionTerminated.IsTriggered;
self->Change976.IsTriggered = self->T20inProtocolError.IsTriggered;
self->Change985.IsTriggered = self->T21inFormalTelegramError.IsTriggered;
self->Change998.IsTriggered = self->T22inContentTelegramError.IsTriggered;
}
