...
ChangeEvent Change7; // (d14in_Observed_Point_Position <> Mem_Last_Reported_Point_Position) OR (d17in_Observed_Degraded_Point_Position <> Mem_Last_Reported_Degraded_Point_Position)
ChangeEvent Change95; // d13in_Observed_Movement_Failed
ChangeEvent Change316; // d50in_PDI_Connection_State = "READY_FOR_PDI_NO_SCP"OR d50in_PDI_Connection_State = "READY_FOR_PDI"OR d50in_PDI_Connection_State = "SUSPENDED"
