...
typedef struct FControlAndObserve4WPm {
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(FControlAndObserve4WPm_D12inRequiredPmPositionValue, )
  ...
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FControlAndObserve4WPm_D19outAbilityToMovePmValue, )
      D19outAbilityToMovePm;
  ...
  ChangeEvent Change372; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE" OR
                         // d51in_EST_EfeS_State = "FALLBACK_MODE"
  ChangeEvent Change176; // D26in_Internal_Trigger_Ability_To_Move_PM_Available
  ChangeEvent
      Change557; // NOT D26in_Internal_Trigger_Ability_To_Move_PM_Available
