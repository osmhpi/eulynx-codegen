...
typedef struct FObserveOverallPointPosition {
  ...
  DataPort(FObserveOverallPointPosition_D10inPm1CrucialPositionValue, )
      D10inPm1CrucialPosition;

  /// D10in_PMi_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D10inPmiCrucialPositionValue, )
      D10inPmiCrucialPosition;

  /// D10in_PM1_Non_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D10inPm1NonCrucialPositionValue, )
      D10inPm1NonCrucialPosition;

  /// D10in_PMk_Non_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D10inPmkNonCrucialPositionValue, )
  ...
  /// Trigger: False, DataPort: False, In: False, Out: False, External: False
  FObserveOverallPointPosition_MemPm1NonCrucialPositionValue
      MemPm1NonCrucialPosition;

  /// Mem_PMk_Non_Crucial_Position
  /// Trigger: False, DataPort: False, In: False, Out: False, External: False
  FObserveOverallPointPosition_MemPmkNonCrucialPositionValue
      MemPmkNonCrucialPosition;
  ...
  // Change Events
  ChangeEvent
      Change25; // D10in_PM1_Crucial_Position <> Mem_PM1_Crucial_Position
  ChangeEvent Change30; // D10in_PM1_Non_Crucial_Position <>
                        // Mem_PM1_Non_Crucial_Position
  ChangeEvent
      Change31; // D10in_PMi_Crucial_Position <> Mem_PMi_Crucial_Position
