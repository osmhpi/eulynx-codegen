...
static FSciPReport_D14inObservedPointPositionValue
map_MemLastReportedPointPosition_to_D14inObservedPointPosition(
...
static FSciPReport_MemLastReportedPointPositionValue
map_D14inObservedPointPosition_to_MemLastReportedPointPosition(
...
static PointPositionDegradedState__422e
Cop2DegradedPointPosition(FSciPReport *self) {
...
void make_state_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition(
  ...
  make_state_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition__Waiting(
      self, x);
  return;
}
...
void make_state_FSciPReport__root__ReportingOverallPointStates(
    FSciPReport *self, FSciPReport__root__state_struct *region) {
...
void make_state_FSciPReport__root__InterfaceConnectionNotEstablished(
    FSciPReport *self, FSciPReport__root__state_struct *region) {
...
void make_state_FSciPReport__root(FSciPReport *self,
...
void transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingAbilityToMove(
  ...
  case FSciPReport__root__ReportingOverallPointStates__ReportingAbilityToMove__MsgAbilityToMove:
    transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingAbilityToMove__MsgAbilityToMove(
        self, x);
    break;
  }
}
...
void transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition__MsgOverallPointPosition(
  ...
  if (self->Change8.IsTriggered) {
    if (self->D50inPdiConnectionState.Value ==
      ...
      self->OutMsgPointPosition__27c1.Value.ReportedPointPositionState =
          Cop1PointPosition(self);
      self->OutMsgPointPosition__27c1.Value.ReportedDegradedPointPosition =
          Cop2DegradedPointPosition(self);
...
void transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition(
  ...
  case FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition__Waiting:
    transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition__Waiting(
        self, x);
    break;
  }
}
...
void transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMovementFailed(
  ...
  case FSciPReport__root__ReportingOverallPointStates__ReportingMovementFailed__MsgMovementFailed:
    transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMovementFailed__MsgMovementFailed(
        self, x);
    break;
  }
}

void transition_from_FSciPReport__root__ReportingOverallPointStates(
    FSciPReport *self, FSciPReport__root__state_struct *x) {
  transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingAbilityToMove(
      self, x);
  transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMsgPointPosition(
      self, x);
  transition_from_FSciPReport__root__ReportingOverallPointStates__ReportingMovementFailed(
      self, x);
...
void transition_from_FSciPReport__root__InterfaceConnectionNotEstablished(
    FSciPReport *self, FSciPReport__root__state_struct *x) {
...
void transition_from_FSciPReport__root(FSciPReport *self,
                                       FSciPReport__root__state_struct *x) {
  switch (x->state) {
  ...
  case FSciPReport__root__InterfaceConnectionNotEstablished:
    transition_from_FSciPReport__root__InterfaceConnectionNotEstablished(self,
                                                                         x);
    break;
  }
}
...
static void evaluateChangeEvents(FSciPReport *self) {
  self->Change40.IsTriggered = IsTriggered(
      MakeChange(self->D11inObservedAbilityToMove.IsSignalled,
                 self->D11inObservedAbilityToMove.Value ==
                     FSciPReport_D11inObservedAbilityToMoveValue__AbleToMove));
  self->Change43.IsTriggered = IsTriggered(MakeChange(
      self->D11inObservedAbilityToMove.IsSignalled,
      self->D11inObservedAbilityToMove.Value ==
          FSciPReport_D11inObservedAbilityToMoveValue__UnableToMove));
  self->Change8.IsTriggered = IsTriggered(MakeChange(
      self->D14inObservedPointPosition.IsSignalled,
      !(self->D14inObservedPointPosition.Value ==
        map_MemLastReportedPointPosition_to_D14inObservedPointPosition(
            self->MemLastReportedPointPosition))));
  self->Change11.IsTriggered = IsTriggered(MakeChange(
      self->D17inObservedDegradedPointPosition.IsSignalled,
      !(self->D17inObservedDegradedPointPosition.Value ==
        map_MemLastReportedDegradedPointPosition_to_D17inObservedDegradedPointPosition(
            self->MemLastReportedDegradedPointPosition))));
  self->Change7.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D14inObservedPointPosition.IsSignalled,
          !(self->D14inObservedPointPosition.Value ==
            map_MemLastReportedPointPosition_to_D14inObservedPointPosition(
      ...
      MakeChange(
          ...
          !(self->D17inObservedDegradedPointPosition.Value ==
            map_MemLastReportedDegradedPointPosition_to_D17inObservedDegradedPointPosition(
                self->MemLastReportedDegradedPointPosition)))));
  self->Change95.IsTriggered =
      IsTriggered(MakeChange(self->D13inObservedMovementFailed.IsSignalled,
                             self->D13inObservedMovementFailed.Value));
  self->Change316.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
