...
/// Mem_Last_Required_Point_Position
    ...
    // Change Events
    ChangeEvent Change36; // d10in_Required_Point_Position = "RIGHT" AND (d10in_Required_Point_Position <> d14in_Observed_Point_Position)
...
ChangeEvent Change34; // d10in_Required_Point_Position = "LEFT" AND (d10in_Required_Point_Position <> d14in_Observed_Point_Position)
...
ChangeEvent Change371; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE" OR d51in_EST_EfeS_State = "BOOTING" OR d51in_EST_EfeS_State = "FALLBACK_MODE"
