...
static FObserveOverallPointPosition_D10inPm1CrucialPositionValue
map_MemPm1CrucialPosition_to_D10inPm1CrucialPosition(
...
static FObserveOverallPointPosition_D10inPmiCrucialPositionValue
map_MemPmiCrucialPosition_to_D10inPmiCrucialPosition(
...
static FObserveOverallPointPosition_MemPm1CrucialPositionValue
map_D10inPm1CrucialPosition_to_MemPm1CrucialPosition(
...
static FObserveOverallPointPosition_MemPmiCrucialPositionValue
map_D10inPmiCrucialPosition_to_MemPmiCrucialPosition(
...
void make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root(
  ...
  if ((((self->D10inPm1CrucialPosition.Value ==
    ...
    make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Left(
        self, x);
    return;
  }
  if ((((self->D10inPm1CrucialPosition.Value ==
    ...
    self->MemPm1CrucialPosition =
        map_D10inPm1CrucialPosition_to_MemPm1CrucialPosition(
            self->D10inPm1CrucialPosition.Value);
    Cop1MemPmPosition(self);
    make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Right(
        self, x);
    return;
  }
  if (((((self->D10inPm1CrucialPosition.Value ==
    ...
    self->MemPm1CrucialPosition =
        map_D10inPm1CrucialPosition_to_MemPm1CrucialPosition(
            self->D10inPm1CrucialPosition.Value);
    Cop1MemPmPosition(self);
    make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__UnintendedPosition(
        self, x);
    return;
  } else {
    self->D14outObservedPointPosition.Value =
    ...
    self->MemPm1CrucialPosition =
        map_D10inPm1CrucialPosition_to_MemPm1CrucialPosition(
            self->D10inPm1CrucialPosition.Value);
    Cop1MemPmPosition(self);
    make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__NoEndPosition(
        self, x);
    return;
  }
}
...
void make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition(
    FObserveOverallPointPosition *self,
    FObserveOverallPointPosition__root__state_struct *region) {
...
void make_state_FObserveOverallPointPosition__root(
    FObserveOverallPointPosition *self,
  ...
  make_state_FObserveOverallPointPosition__root__ObserveOverallPointPosition(
      self, x);
  return;
}
...
void transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root(
  ...
  case FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Left:
    transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Left(
        self, x);
    break;
  case FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Right:
    transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__Right(
        self, x);
    break;
  case FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__NoEndPosition:
    transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__NoEndPosition(
        self, x);
    break;
  case FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__UnintendedPosition:
    transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root__UnintendedPosition(
        self, x);
    break;
  }
}
...
void transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition(
    FObserveOverallPointPosition *self,
    FObserveOverallPointPosition__root__state_struct *x) {
  transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition__root(
      self, x);
...
void transition_from_FObserveOverallPointPosition__root(
    FObserveOverallPointPosition *self,
    FObserveOverallPointPosition__root__state_struct *x) {
  switch (x->state) {
  case FObserveOverallPointPosition__root__ObserveOverallPointPosition:
    transition_from_FObserveOverallPointPosition__root__ObserveOverallPointPosition(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(FObserveOverallPointPosition *self) {
  self->Change25.IsTriggered = IsTriggered(
      MakeChange(self->D10inPm1CrucialPosition.IsSignalled,
                 !(self->D10inPm1CrucialPosition.Value ==
                   map_MemPm1CrucialPosition_to_D10inPm1CrucialPosition(
                       self->MemPm1CrucialPosition))));
  ...
  self->Change31.IsTriggered = IsTriggered(
      MakeChange(self->D10inPmiCrucialPosition.IsSignalled,
                 !(self->D10inPmiCrucialPosition.Value ==
                   map_MemPmiCrucialPosition_to_D10inPmiCrucialPosition(
                       self->MemPmiCrucialPosition))));
  self->Change32.IsTriggered = IsTriggered(
      MakeChange(self->D10inPmkNonCrucialPosition.IsSignalled,
                 !(self->D10inPmkNonCrucialPosition.Value ==
                   map_MemPmkNonCrucialPosition_to_D10inPmkNonCrucialPosition(
                       self->MemPmkNonCrucialPosition))));
  self->Change369.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
...
void transition_FObserveOverallPointPosition(
    FObserveOverallPointPosition *self) {
  resetOutputs(self);
