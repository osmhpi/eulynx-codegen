...
static void evaluateChangeEvents(FControlNon4wPm *self) {
  ...
  self->Change85.IsTriggered = IsTriggered(MakeChange(
  ...
  self->Change86.IsTriggered = IsTriggered(MakeChange(
      self->D12inRequiredPmPosition.IsSignalled,
      self->D12inRequiredPmPosition.Value ==
          FControlNon4wPm_D12inRequiredPmPositionValue__Uncommanded));
  ...
  self->Change79.IsTriggered = IsTriggered(AndChange(
      ...
      OrChange(MakeChange(self->D12inRequiredPmPosition.IsSignalled ||
               ...
               AndChange(MakeChange(
                         ...
                         MakeChange(self->D37inConCommonDrive.IsSignalled,
                                    self->D37inConCommonDrive.Value)))));
  self->Change361.IsTriggered = IsTriggered(
  ...
  self->Change370.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
