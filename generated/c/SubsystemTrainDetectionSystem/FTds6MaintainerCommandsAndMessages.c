...
void make_state_FTds6MaintainerCommandsAndMessages__root__ReceivingCommandsAndReportMessages(FTds6MaintainerCommandsAndMessages *self, FTds6MaintainerCommandsAndMessages__root__state_struct *region) {
...
void make_state_FTds6MaintainerCommandsAndMessages__root(FTds6MaintainerCommandsAndMessages *self, FTds6MaintainerCommandsAndMessages__root__state_struct *x) {
    memset(x, 0, sizeof(FTds6MaintainerCommandsAndMessages__root__state_struct));
    
                make_state_FTds6MaintainerCommandsAndMessages__root__ReceivingCommandsAndReportMessages(self, x); return;
}
        ...
        void transition_from_FTds6MaintainerCommandsAndMessages__root__ReceivingCommandsAndReportMessages(FTds6MaintainerCommandsAndMessages *self, FTds6MaintainerCommandsAndMessages__root__state_struct *x) {
            
            if (self->InReportCommandRejected__fa56.HasMessage) {
                if (self->InReportCommandRejected__fa56.Value.ReportedReasonForRejection == ReasonForRejection__abec__Operational) {
                self->D36outCommandRejected.Value = FTds6MaintainerCommandsAndMessages_D36outCommandRejectedValue__Operational;self->D36outCommandRejected.IsSignalled = true;
...
if (self->InReportCommandRejected__fa56.HasMessage) {
                ...
                self->D36outCommandRejected.Value = FTds6MaintainerCommandsAndMessages_D36outCommandRejectedValue__Technical;self->D36outCommandRejected.IsSignalled = true;
self->T36outCommandRejected.Trigger = true;
                make_state_FTds6MaintainerCommandsAndMessages__root__ReceivingCommandsAndReportMessages(self, x); return;
            }
            }
...
if (self->Change1151.IsTriggered) {
  ...
  self->OutRequestVisualSweepingConfirmation__2333.HasMessage = 1;
        ...
        void transition_from_FTds6MaintainerCommandsAndMessages__root(FTds6MaintainerCommandsAndMessages *self, FTds6MaintainerCommandsAndMessages__root__state_struct *x) {
            switch (x->state) {
