...
typedef struct FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusAxleCounter__state_struct {
    FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusAxleCounter__state state;
    union {
...
typedef struct FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusTrackCircuits__state_struct {
    FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusTrackCircuits__state state;
    union {
...
typedef struct FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__state_struct {
        FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusAxleCounter__state_struct TvpsStatusAxleCounter;
FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusTrackCircuits__state_struct TvpsStatusTrackCircuits;
...
typedef struct FMonitorReportStatus__root__MonitoringReportStatus__root__state_struct {
    ...
    union {
        FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__state_struct WaitingForStatusReports;
    };
