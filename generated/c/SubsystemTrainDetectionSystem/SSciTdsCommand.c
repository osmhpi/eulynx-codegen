...
void make_state_SSciTdsCommand__root(SSciTdsCommand *self, SSciTdsCommand__root__state_struct *x) {
    memset(x, 0, sizeof(SSciTdsCommand__root__state_struct));
                ...
                make_state_SSciTdsCommand__root__SendingCommands(self, x); return;
}
        ...
        void transition_from_SSciTdsCommand__root__SendingCommands(SSciTdsCommand *self, SSciTdsCommand__root__state_struct *x) {
            ...
            if (self->Change1253.IsTriggered) {
                if ((self->D70inModeOfFc.Value == SSciTdsCommand_D70inModeOfFcValue__FcU) && (self->D50PdiConnectionState.Value == SSciTdsCommand_D50PdiConnectionStateValue__Established)) {
...
if (self->Change1252.IsTriggered) {
                if ((self->D70inModeOfFc.Value == SSciTdsCommand_D70inModeOfFcValue__FcP) && (self->D50PdiConnectionState.Value == SSciTdsCommand_D50PdiConnectionStateValue__Established)) {
...
if (self->Change1251.IsTriggered) {
                if ((self->D70inModeOfFc.Value == SSciTdsCommand_D70inModeOfFcValue__FcPA) && (self->D50PdiConnectionState.Value == SSciTdsCommand_D50PdiConnectionStateValue__Established)) {
...
if (self->Change1249.IsTriggered) {
                if ((self->D70inModeOfFc.Value == SSciTdsCommand_D70inModeOfFcValue__AcknowledgementAfterFcPACommand) && (self->D50PdiConnectionState.Value == SSciTdsCommand_D50PdiConnectionStateValue__Established)) {
...
if (self->Change1250.IsTriggered) {
                if ((self->D70inModeOfFc.Value == SSciTdsCommand_D70inModeOfFcValue__FcC) && (self->D50PdiConnectionState.Value == SSciTdsCommand_D50PdiConnectionStateValue__Established)) {
...
static void evaluateChangeEvents(SSciTdsCommand *self) {
    self->Change1253.IsTriggered = self->T70inFc.IsTriggered;
self->Change1252.IsTriggered = self->T70inFc.IsTriggered;
self->Change1251.IsTriggered = self->T70inFc.IsTriggered;
self->Change1249.IsTriggered = self->T70inFc.IsTriggered;
self->Change1250.IsTriggered = self->T70inFc.IsTriggered;
self->Change1254.IsTriggered = self->T72inUpdateFillingLevel.IsTriggered;
self->Change1255.IsTriggered = self->T73inCancel.IsTriggered;
self->Change1256.IsTriggered = self->T74inDrfc.IsTriggered;
}
