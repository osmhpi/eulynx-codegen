...
void make_state_FSciTdsReceive__root__ReceivingCommands(FSciTdsReceive *self, FSciTdsReceive__root__state_struct *region) {
...
void make_state_FSciTdsReceive__root(FSciTdsReceive *self, FSciTdsReceive__root__state_struct *x) {
    memset(x, 0, sizeof(FSciTdsReceive__root__state_struct));
    
                make_state_FSciTdsReceive__root__ReceivingCommands(self, x); return;
}
        ...
        void transition_from_FSciTdsReceive__root__ReceivingCommands(FSciTdsReceive *self, FSciTdsReceive__root__state_struct *x) {
...
if (self->InCdDrfc__15c7.HasMessage) {
  ...
  self->OutRequestDrfc__a48b.Value.ReportedSource = SourceOfCommand__d5a9__Eil;
...
if (self->InCdFc__ec57.HasMessage) {
  ...
  self->OutRequestFcU__bd99.Value.ReportedSource = SourceOfCommand__d5a9__Eil;
...
if (self->InCdFc__ec57.HasMessage) {
  ...
  self->OutRequestFcC__f902.Value.ReportedSource = SourceOfCommand__d5a9__Eil;
...
if (self->InCdUpdateFillingLevel__d24d.HasMessage) {
  ...
  self->OutRequestUfl__f416.HasMessage = 1;
        ...
        void transition_from_FSciTdsReceive__root(FSciTdsReceive *self, FSciTdsReceive__root__state_struct *x) {
            switch (x->state) {
