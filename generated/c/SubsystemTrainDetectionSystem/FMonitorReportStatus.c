...
void make_state_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__Tdp(
  ...
  make_state_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__Tdp__Waiting(
      self, x);
  return;
}
...
void make_state_FMonitorReportStatus__root__MonitoringReportStatus__root(
    FMonitorReportStatus *self,
    FMonitorReportStatus__root__MonitoringReportStatus__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          FMonitorReportStatus__root__MonitoringReportStatus__root__state_struct));

  make_state_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForReportStatus(
      self, x);
  return;
}

void make_state_FMonitorReportStatus__root__MonitoringReportStatus(
    FMonitorReportStatus *self,
  ...
  make_state_FMonitorReportStatus__root__MonitoringReportStatus__root(
      self, &region->MonitoringReportStatus.root);
};

void make_state_FMonitorReportStatus__root(
...
void transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusAxleCounter__Waiting(
  ...
  if (self->InMsgTvpsOccupancyStatus__b4e1.HasMessage) {
    ...
    make_state_FMonitorReportStatus__root__MonitoringReportStatus__root__Join0(
...
void transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusAxleCounter(
    FMonitorReportStatus *self, FMonitorReportStatus__root__state_struct *x) {
  switch (x->MonitoringReportStatus.root.WaitingForStatusReports
              .TvpsStatusAxleCounter.state) {
...
void transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports(
  ...
  transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__TvpsStatusTrackCircuits(
      self, x);
  transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports__Tdp(
      self, x);
}
...
void transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root(
  ...
  case FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForReportStatus:
    transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForReportStatus(
        self, x);
    break;
  case FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports:
    transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root__WaitingForStatusReports(
        self, x);
    break;
  }
}

void transition_from_FMonitorReportStatus__root__MonitoringReportStatus(
    FMonitorReportStatus *self, FMonitorReportStatus__root__state_struct *x) {
  transition_from_FMonitorReportStatus__root__MonitoringReportStatus__root(self,
                                                                           x);
}

void transition_from_FMonitorReportStatus__root(
    FMonitorReportStatus *self, FMonitorReportStatus__root__state_struct *x) {
  switch (x->state) {
