...
void make_state_FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root(
  ...
  if ((self->D49inPowerMonitoringFailure.Value) &&
      (self->D50inConPomUsed.Value)) {
    self->D45outReportTvpsOccupancyStatus.Value =
...
void transition_from_FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root(
    FObserveTrackCircuits *self, FObserveTrackCircuits__root__state_struct *x) {
  switch (x->ReportOccupancyStatus.root.Operating.root.Observing.root.Occupied
              .root.state) {
...
void transition_from_FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root(
    FObserveTrackCircuits *self, FObserveTrackCircuits__root__state_struct *x) {
  switch (x->ReportOccupancyStatus.root.Operating.root.Observing.root.Vacant
              .root.state) {
...
static void evaluateChangeEvents(FObserveTrackCircuits *self) {
  self->Change278.IsTriggered =
      IsTriggered(MakeChange(self->D49inPowerMonitoringFailure.IsSignalled,
                             self->D49inPowerMonitoringFailure.Value));
  self->Change572.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D49inPowerMonitoringFailure.IsSignalled,
                              self->D49inPowerMonitoringFailure.Value)));
  ...
  self->Change236.IsTriggered =
      IsTriggered(MakeChange(self->D32inCriticalFailureTvps.IsSignalled,
                             self->D32inCriticalFailureTvps.Value == false));
  self->Change400.IsTriggered = IsTriggered(MakeChange(
  ...
  self->Change387.IsTriggered = IsTriggered(OrChange(
  ...
  self->Change383.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FObserveTrackCircuits_D51outEstEfesStateValue__Booting));
  self->Change395.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
