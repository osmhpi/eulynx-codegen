...
static void evaluateChangeEvents(FObserveOccupancyStatus *self) {
  ...
  self->Change536.IsTriggered = IsTriggered(
      MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
  self->Change534.IsTriggered = IsTriggered(
      MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
  ...
  self->Change546.IsTriggered = IsTriggered(NegateChange(MakeChange(
      self->D14inMonitoringTime.IsSignalled, self->D14inMonitoringTime.Value)));
  ...
  self->Change389.IsTriggered = IsTriggered(OrChange(
  ...
  self->Change397.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
  ...
  self->Change382.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FObserveOccupancyStatus_D51outEstEfesStateValue__Booting));
  self->Change404.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
          FObserveOccupancyStatus_D51outEstEfesStateValue__Initialising));
  self->Change394.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
          FObserveOccupancyStatus_D51outEstEfesStateValue__FallbackMode));
