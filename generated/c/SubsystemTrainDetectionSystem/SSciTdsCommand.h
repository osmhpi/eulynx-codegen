...
typedef struct SSciTdsCommand {
  ...
  MessagePort(Message__CdUpdateFillingLevel__d24d)
      OutCdUpdateFillingLevel__d24d;
  MessagePort(Message__CdCancel__6acf) OutCdCancel__6acf;
  MessagePort(Message__CdDrfc__15c7) OutCdDrfc__15c7;

  // Change Events
  ChangeEvent Change1253; // t70in_FC
  ChangeEvent Change1252; // t70in_FC
  ChangeEvent Change1251; // t70in_FC
  ChangeEvent Change1249; // t70in_FC
  ChangeEvent Change1250; // t70in_FC
  ChangeEvent Change1254; // t72in_Update_Filling_Level
  ChangeEvent Change1255; // t73in_Cancel
  ChangeEvent Change1256; // t74in_DRFC
