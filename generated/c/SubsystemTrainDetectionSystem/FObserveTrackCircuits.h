...
typedef struct FObserveTrackCircuits {
  ...
  DataPort(FObserveTrackCircuits_D45outReportTvpsOccupancyStatusValue, )
      D45outReportTvpsOccupancyStatus;
  ...
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FObserveTrackCircuits_D47outReportPomStatusValue, )
      D47outReportPomStatus;
  ...
  ChangeEvent Change387; // d51out_EST_EfeS_State = "BOOTING" OR
