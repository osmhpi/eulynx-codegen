...
FObserveTrackCircuits_D47outReportPomStatusValue__NotApplicable,
...
typedef enum FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root__state {
...
} FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root__state;



typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root__state_struct {
    FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root__state state;
    union {
...
typedef enum FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root__state {
...
} FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root__state;



typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root__state_struct {
    FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root__state state;
    union {
...
FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant
} FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__state;


typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__state_struct {
        FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__root__state_struct root;
} FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__state_struct;


typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__state_struct {
        FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__root__state_struct root;
} FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__state_struct;
...
typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__state_struct {
    ...
    union {
        FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Occupied__state_struct Occupied;
FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__Observing__root__Vacant__state_struct Vacant;
    };
...
typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__TechnicallyDisturbed__root__state_struct {
...
typedef struct FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__TechnicallyDisturbed__state_struct {
        FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__TechnicallyDisturbed__root__state_struct root;
...
FObserveTrackCircuits__root__ReportOccupancyStatus__root__Operating__root__TechnicallyDisturbed__state_struct TechnicallyDisturbed;
    };
...
/// D49in_Power_Monitoring_Failure
            /// Trigger: False, DataPort: True, In: True, Out: False, External: True
            DataPort(bool, ) D49inPowerMonitoringFailure;
...
/// D50in_Con_POM_used
    ...
    // Change Events
    ChangeEvent Change278; // D49in_Power_Monitoring_Failure
ChangeEvent Change572; // NOT D49in_Power_Monitoring_Failure
ChangeEvent Change570; // NOT D49in_Power_Monitoring_Failure
ChangeEvent Change279; // D49in_Power_Monitoring_Failure
ChangeEvent Change276; // D48in_Occupancy_Detected = FALSE
ChangeEvent Change277; // D48in_Occupancy_Detected = TRUE
ChangeEvent Change571; // NOT D49in_Power_Monitoring_Failure
ChangeEvent Change280; // D49in_Power_Monitoring_Failure
ChangeEvent Change232; // D32in_Critical_Failure_TVPS
ChangeEvent Change236; // D32in_Critical_Failure_TVPS = FALSE
ChangeEvent Change400; // d51out_EST_EfeS_State = "INITIALISING"
ChangeEvent Change387; // d51out_EST_EfeS_State = "BOOTING" OR d51out_EST_EfeS_State = "NO_OPERATING_VOLTAGE"
ChangeEvent Change383; // d51out_EST_EfeS_State = "BOOTING"
ChangeEvent Change395; // d51out_EST_EfeS_State = "FALLBACK_MODE"
