...
static void Cop1Init(FEstEfes *self) {
  self->D52outEstEfesInitSubstate.Value =
      FEstEfes_D52outEstEfesInitSubstateValue__Unknown;
  self->D52outEstEfesInitSubstate.IsSignalled = true;
}

void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct
        *region) {
  LOG("[FEstEfes] Entering state WaitingForDataUpdate in region "
...
void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct
        *region) {
  LOG("[FEstEfes] Entering state WaitingForPdiOrMaintenance in region "
      "root__OperatingVoltageSupplied__root__Initialising__root");
  region->state =
      FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance;
};

void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct
        *region) {
  LOG("[FEstEfes] Entering state WaitingForNoMaintenanceTimeout in region "
      "root__OperatingVoltageSupplied__root__Initialising__root");
  region->state =
      FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout;
};

void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__state_struct
        *x) {
  memset(
  ...
  if (self->D20inConMdmUsed.Value) {
    ...
    self->D52outEstEfesInitSubstate.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(
        self, x);
    return;
  }
  if (!(self->D20inConMdmUsed.Value)) {
...
void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Booting(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__state_struct *region) {
...
void make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(
  ...
  make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(
      self, &region->Initialising.root);
};

void make_state_FEstEfes__root__OperatingVoltageSupplied__root(
    FEstEfes *self,
    FEstEfes__root__OperatingVoltageSupplied__root__state_struct *x) {
  memset(x, 0,
         sizeof(FEstEfes__root__OperatingVoltageSupplied__root__state_struct));
  self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__Booting;
  self->D51outEstEfesState.IsSignalled = true;
  make_state_FEstEfes__root__OperatingVoltageSupplied__root__Booting(self, x);
  return;
}

void make_state_FEstEfes__root__NoOperatingVoltage(
    FEstEfes *self, FEstEfes__root__state_struct *region) {
  LOG("[FEstEfes] Entering state NoOperatingVoltage in region root");
  region->state = FEstEfes__root__NoOperatingVoltage;
};

void make_state_FEstEfes__root__OperatingVoltageSupplied(
    FEstEfes *self, FEstEfes__root__state_struct *region) {
  LOG("[FEstEfes] Entering state OperatingVoltageSupplied in region root");
  region->state = FEstEfes__root__OperatingVoltageSupplied;
  make_state_FEstEfes__root__OperatingVoltageSupplied__root(
      self, &region->OperatingVoltageSupplied.root);
};

void make_state_FEstEfes__root(FEstEfes *self,
  ...
  self->D51outEstEfesState.IsSignalled = true;
  make_state_FEstEfes__root__NoOperatingVoltage(self, x);
  return;
}

void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdi(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  ...
  if (self->InPdiConnectionEstablished__4cbf.HasMessage) {
    ...
    self->D51outEstEfesState.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__Operational(
        self, &x->OperatingVoltageSupplied.root);
    return;
  }
  if (self->InPdiReleasedForMaintenance__3f7c.HasMessage) {
    if (!(self->D20inConMdmUsed.Value)) {
      ...
      self->OutNotreadyForPdiConnection__0b73.HasMessage = 1;
      make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout(
          self, &x->OperatingVoltageSupplied.root.Initialising.root);
      return;
    }
  }
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  ...
  if (self->InPdiConnectionStarted__f9c3.HasMessage) {
    ...
    self->D52outEstEfesInitSubstate.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdi(
        self, &x->OperatingVoltageSupplied.root.Initialising.root);
    return;
  }
}

void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  ...
  case FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForDataUpdate(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdi:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdi(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForPdiOrMaintenance(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root__WaitingForNoMaintenanceTimeout(
        self, x);
    break;
  }
}

void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Booting(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  ...
  if (self->Change1191.IsTriggered) {
    ...
    self->D51outEstEfesState.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(
        self, &x->OperatingVoltageSupplied.root);
    return;
  }
  if (self->Change1226.IsTriggered) {
    ...
    self->D51outEstEfesState.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode(
        self, &x->OperatingVoltageSupplied.root);
    return;
  }
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Operational(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  ...
  if (self->InPdiConnectionClosed__d803.HasMessage) {
    self->D52outEstEfesInitSubstate.Value =
        FEstEfes_D52outEstEfesInitSubstateValue__WaitingForPdiOrMaintenance;
    self->D52outEstEfesInitSubstate.IsSignalled = true;
    x->OperatingVoltageSupplied.root.state =
  ...
  if (self->Change1143.IsTriggered) {
    ...
    self->D51outEstEfesState.Value = FEstEfes_D51outEstEfesStateValue__Booting;
    self->D51outEstEfesState.IsSignalled = true;
    make_state_FEstEfes__root__OperatingVoltageSupplied__root__Booting(
        self, &x->OperatingVoltageSupplied.root);
    return;
  }
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising__root(
      self, x);
...
void transition_from_FEstEfes__root__OperatingVoltageSupplied__root(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
  switch (x->OperatingVoltageSupplied.root.state) {
  case FEstEfes__root__OperatingVoltageSupplied__root__Booting:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Booting(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__Operational:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Operational(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__FallbackMode(
        self, x);
    break;
  case FEstEfes__root__OperatingVoltageSupplied__root__Initialising:
    transition_from_FEstEfes__root__OperatingVoltageSupplied__root__Initialising(
        self, x);
    break;
  }
}

void transition_from_FEstEfes__root__NoOperatingVoltage(
    FEstEfes *self, FEstEfes__root__state_struct *x) {

  if (self->Change869.IsTriggered) {

    make_state_FEstEfes__root__OperatingVoltageSupplied(self, x);
    return;
  }
}

void transition_from_FEstEfes__root__OperatingVoltageSupplied(
    FEstEfes *self, FEstEfes__root__state_struct *x) {
...
void transition_from_FEstEfes__root(FEstEfes *self,
                                    FEstEfes__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FEstEfes *self) {
  ...
  self->Change1266.IsTriggered =
      self->T7inInvalidOrMissingBasicData.IsTriggered;
