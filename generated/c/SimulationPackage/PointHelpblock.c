...
void make_state_PointHelpblock__root__AtomicState(
    PointHelpblock *self, PointHelpblock__root__state_struct *region) {
  LOG("[PointHelpblock] Entering state AtomicState in region root");
  region->state = PointHelpblock__root__AtomicState;
};

void make_state_PointHelpblock__root(PointHelpblock *self,
                                     PointHelpblock__root__state_struct *x) {
  memset(x, 0, sizeof(PointHelpblock__root__state_struct));
  self->DoutConstantTrue.Value = true;
  make_state_PointHelpblock__root__AtomicState(self, x);
  return;
}

void transition_from_PointHelpblock__root__AtomicState(
    PointHelpblock *self, PointHelpblock__root__state_struct *x) {}

void transition_from_PointHelpblock__root(
    PointHelpblock *self, PointHelpblock__root__state_struct *x) {
  switch (x->state) {
