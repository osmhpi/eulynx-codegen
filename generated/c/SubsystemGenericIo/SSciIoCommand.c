...
void make_state_SSciIoCommand__root__SendingOutputChannelCommand(
    SSciIoCommand *self, SSciIoCommand__root__state_struct *region) {
...
void make_state_SSciIoCommand__root(SSciIoCommand *self,
...
void transition_from_SSciIoCommand__root__SendingOutputChannelCommand(
    SSciIoCommand *self, SSciIoCommand__root__state_struct *x) {

  if (self->Change1084.IsTriggered) {
    if (((self->D31inRequiredChannelState1.Value ==
          SSciIoCommand_D31inRequiredChannelState1Value__SwitchedOff) &&
         (self->D32inRequiredChannelStaten.Value ==
...
void transition_from_SSciIoCommand__root(SSciIoCommand *self,
                                         SSciIoCommand__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(SSciIoCommand *self) {
  self->Change1084.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1083.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1082.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1081.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1078.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1077.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1076.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1079.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
  self->Change1080.IsTriggered =
      self->T30inNewOutputChannelStateRequired.IsTriggered;
}
