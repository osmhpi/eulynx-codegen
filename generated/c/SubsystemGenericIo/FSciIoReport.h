...
typedef struct FSciIoReport {
  ...
  ChangeEvent
      Change441; // d7in_Detected_Input_Channel_State1 = "Switched_Off" AND
                 // d7in_Detected_Input_Channel_StateN = "Switched_Off"
  ...
  ChangeEvent Change445; // d7in_Detected_Input_Channel_State1 = "Switched_On"
                         // AND d7in_Detected_Input_Channel_StateN = "Disturbed"
  ChangeEvent
      Change442; // d7in_Detected_Input_Channel_State1 = "Switched_On"AND
                 // d7in_Detected_Input_Channel_StateN = "Switched_On"
  ChangeEvent
      Change440; // d7in_Detected_Input_Channel_State1 = "Switched_On" AND
                 // d7in_Detected_Input_Channel_StateN = "Switched_Off"
  ChangeEvent
      Change444; // d7in_Detected_Input_Channel_State1 = "Switched_Off" AND
                 // d7in_Detected_Input_Channel_StateN = "Switched_On"
  ...
  ChangeEvent Change497; // d9in_Monitored_Output_Channel_Disturbance_State1 =
                         ...
                         // "Not_Physically_Disturbed"
  ChangeEvent
      Change313; // d50in_PDI_Connection_State = "READY_FOR_PDI_NO_SCP"OR
