...
static void evaluateChangeEvents(FSciIoReceive *self) {
  self->Change498.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D9inMonitoredOutputChannelDisturbanceState1.Value ==
          FSciIoReceive_D9inMonitoredOutputChannelDisturbanceState1Value__NotPhysicallyDisturbed));
  self->Change543.IsTriggered = IsTriggered(NegateChange(
      MakeChange(self->D13inSwitchOffEachPhysicalOutputChannel.IsSignalled,
                 self->D13inSwitchOffEachPhysicalOutputChannel.Value)));
  self->Change104.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D13inSwitchOffEachPhysicalOutputChannel.IsSignalled,
                 self->D13inSwitchOffEachPhysicalOutputChannel.Value),
      MakeChange(
          self->D9inMonitoredOutputChannelDisturbanceState1.IsSignalled,
  ...
  self->Change493.IsTriggered = IsTriggered(MakeChange(
      self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
      self->D9inMonitoredOutputChannelDisturbanceStaten.Value ==
          FSciIoReceive_D9inMonitoredOutputChannelDisturbanceStatenValue__NotPhysicallyDisturbed));
  self->Change542.IsTriggered = IsTriggered(NegateChange(
      MakeChange(self->D13inSwitchOffEachPhysicalOutputChannel.IsSignalled,
                 self->D13inSwitchOffEachPhysicalOutputChannel.Value)));
  self->Change106.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D13inSwitchOffEachPhysicalOutputChannel.IsSignalled,
                 self->D13inSwitchOffEachPhysicalOutputChannel.Value),
      MakeChange(
          self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
