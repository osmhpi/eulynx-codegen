...
void make_state_FMonitorOutputChannelDisturbanceState__root__NotPhysicallyDisturbed(
    FMonitorOutputChannelDisturbanceState *self,
    FMonitorOutputChannelDisturbanceState__root__state_struct *region) {
...
void make_state_FMonitorOutputChannelDisturbanceState__root(
    FMonitorOutputChannelDisturbanceState *self,
    FMonitorOutputChannelDisturbanceState__root__state_struct *x) {
  memset(x, 0,
         sizeof(FMonitorOutputChannelDisturbanceState__root__state_struct));
  ...
  make_state_FMonitorOutputChannelDisturbanceState__root__NotPhysicallyDisturbed(
      self, x);
  return;
}
...
void transition_from_FMonitorOutputChannelDisturbanceState__root__NotPhysicallyDisturbed(
  ...
  if (true) {
    ...
    self->D9outMonitoredDisturbanceState.IsSignalled = true;
    make_state_FMonitorOutputChannelDisturbanceState__root__PhysicallyDisturbed(
        self, x);
    return;
  }
  if (true) {
...
void transition_from_FMonitorOutputChannelDisturbanceState__root(
  ...
  case FMonitorOutputChannelDisturbanceState__root__NotPhysicallyDisturbed:
    transition_from_FMonitorOutputChannelDisturbanceState__root__NotPhysicallyDisturbed(
        self, x);
    break;
  case FMonitorOutputChannelDisturbanceState__root__PhysicallyDisturbed:
    transition_from_FMonitorOutputChannelDisturbanceState__root__PhysicallyDisturbed(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(FMonitorOutputChannelDisturbanceState *self) {
  self->Change262.IsTriggered = IsTriggered(MakeChange(
      self->D41inDisturbanceRoc.IsSignalled, self->D41inDisturbanceRoc.Value));
  self->Change263.IsTriggered =
      IsTriggered(OrChange(MakeChange(self->D41inDisturbanceRoc.IsSignalled,
                                      self->D41inDisturbanceRoc.Value),
                           MakeChange(self->D42inDisturbanceVoc.IsSignalled,
                                      self->D42inDisturbanceVoc.Value)));
  self->Change568.IsTriggered = IsTriggered(NegateChange(MakeChange(
      self->D41inDisturbanceRoc.IsSignalled, self->D41inDisturbanceRoc.Value)));
  self->Change569.IsTriggered = IsTriggered(
      AndChange(NegateChange(MakeChange(self->D41inDisturbanceRoc.IsSignalled,
                                        self->D41inDisturbanceRoc.Value)),
                NegateChange(MakeChange(self->D42inDisturbanceVoc.IsSignalled,
                                        self->D42inDisturbanceVoc.Value))));
}
...
void transition_FMonitorOutputChannelDisturbanceState(
    FMonitorOutputChannelDisturbanceState *self) {
  resetOutputs(self);
  evaluateChangeEvents(self);
  transition_from_FMonitorOutputChannelDisturbanceState__root(self,
                                                              &self->state);
  resetTriggers(self);
}

void new_FMonitorOutputChannelDisturbanceState(
    FMonitorOutputChannelDisturbanceState *self) {
