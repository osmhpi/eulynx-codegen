...
typedef struct SSciEfesPrim {
  ...
  ChangeEvent Change1226; // T5in_SCP_Connection_Established
  ChangeEvent Change1171; // T45in_Reset_Severe_Error
  ChangeEvent Change1224; // T5in_SCP_Connection_Established
  ChangeEvent Change751;  // T10in_SCP_Connection_Terminated
  ...
  ChangeEvent Change1230; // T5in_SCP_Connection_Established
  ChangeEvent Change754;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change984;  // T20in_Protocol_Error
  ChangeEvent Change993;  // T21in_Formal_Telegram_Error
  ChangeEvent Change1006; // T22in_Content_Telegram_Error
  ChangeEvent Change1162; // T44in_Initiate_Maintenance
  ChangeEvent Change1178; // T48in_Disable_Or_Disconnect_PDI_EfeS
  ChangeEvent Change752;  // T10in_SCP_Connection_Terminated
