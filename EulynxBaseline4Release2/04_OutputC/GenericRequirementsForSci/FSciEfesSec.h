...
typedef struct FSciEfesSec {
  ...
  DataPort(FSciEfesSec_D50outPdiConnectionStateValue, )
  ...
  MessagePort(Message__PdiConnectionStarted__f9c3)
      OutPdiConnectionStarted__f9c3;
  ...
  ChangeEvent Change750;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change747;  // T10in_SCP_Connection_Terminated
  ChangeEvent Change985;  // T20in_Protocol_Error
  ChangeEvent Change991;  // T21in_Formal_Telegram_Error
  ChangeEvent Change1007; // T22in_Content_Telegram_Error
