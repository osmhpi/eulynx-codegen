...
void make_state_SSciAdjPrim__root__Active__root__Establishing__root(
    SSciAdjPrim *self, SSciAdjPrim__root__Active__root__Establishing__root__state_struct *x)
{
    ...
    self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__WaitingForVersionCheck;
    self->D50outPdiConnectionState.IsSignalled = true;
    make_state_SSciAdjPrim__root__Active__root__Establishing__root__WaitingForVersionCheck(self, x);
    return;
}

void make_state_SSciAdjPrim__root__Active__root__Establishing(SSciAdjPrim *self,
                                                              SSciAdjPrim__root__Active__root__state_struct *region)
{
...
void make_state_SSciAdjPrim__root__Active__root__Established(SSciAdjPrim *self,
                                                             SSciAdjPrim__root__Active__root__state_struct *region)
{
...
void make_state_SSciAdjPrim__root(SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    Cop1Init(self);
    self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__RequestedNoScp;
    self->D50outPdiConnectionState.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->InMsgPdiVersionCheck__9827.HasMessage)
    {
                    ...
                    sizeof(self->InMsgPdiVersionCheck__9827.Value.ChecksumData)) == 0))
        {
            ...
            self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__WaitingForInitialisation;
            self->D50outPdiConnectionState.IsSignalled = true;
    ...
    if (self->InMsgPdiVersionCheck__9827.HasMessage)
    {
        if ((self->InMsgPdiVersionCheck__9827.Value.Result == MsgPdiVersionCheck__9827_ResultValue__Match) &&
            (!(memcmp(self->InMsgPdiVersionCheck__9827.Value.ChecksumData, self->D4inConChecksumData.Value,
                      sizeof(self->InMsgPdiVersionCheck__9827.Value.ChecksumData)) == 0)))
        {
            self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PdiChecksumMismatch;
            ...
            self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__Impermissible;
            self->D50outPdiConnectionState.IsSignalled = true;
    ...
    if (self->InMsgPdiVersionCheck__9827.HasMessage)
    {
        ...
        {
            self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PdiOtherVersionRequired;
            self->D60outPdiCloseReason.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    {
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__ReceivingSecStatus;
        self->D50outPdiConnectionState.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->InMsgStatusReportCompleted__c465.HasMessage)
    {
        ...
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__CheckingSecStatus;
        self->D50outPdiConnectionState.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->Change1026.IsTriggered)
    {

        self->OutStartPrimStatusReport__a91c.HasMessage = 1;
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__SendingPrimStatus;
        self->D50outPdiConnectionState.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->InPrimStatusReportCompleted__80d8.HasMessage)
    {
        ...
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__WaitingForInitCompletion;
        self->D50outPdiConnectionState.IsSignalled = true;
    ...
    SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    {
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__Established;
        self->D50outPdiConnectionState.IsSignalled = true;

        self->OutPdiConnectionEstablished__019d.HasMessage = 1;
        make_state_SSciAdjPrim__root__Active__root__Established(self, &x->Active.root);
        return;
    }
}

void transition_from_SSciAdjPrim__root__Active__root__Establishing__root(SSciAdjPrim *self,
...
void transition_from_SSciAdjPrim__root__Active__root__Establishing(SSciAdjPrim *self,
                                                                   SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->Time22.IsTimeoutExpired)
    {
        ...
        self->OutCdClosePdi__8a06.HasMessage = 1;
        self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PdiTimeout;
        self->D60outPdiCloseReason.IsSignalled = true;
        make_state_SSciAdjPrim__root__Active__root__Establishing(self, &x->Active.root);
        return;
    }
}
...
void transition_from_SSciAdjPrim__root__Impermissible(SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    {
        self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__ImpermissibleNoScp;
        self->D50outPdiConnectionState.IsSignalled = true;
        make_state_SSciAdjPrim__root__ImpermissibleNoScp(self, x);
        return;
    }
    if (self->Change1169.IsTriggered)
    {
...
void transition_from_SSciAdjPrim__root__Active(SSciAdjPrim *self, SSciAdjPrim__root__state_struct *x)
{
    ...
    if (self->InMsgResetPdi__59f4.HasMessage)
    {
        ...
        {
            self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__SecProtocolError;
            self->D60outPdiCloseReason.IsSignalled = true;
            self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__Impermissible;
            self->D50outPdiConnectionState.IsSignalled = true;
            make_state_SSciAdjPrim__root__Impermissible(self, x);
    ...
    if (self->InMsgResetPdi__59f4.HasMessage)
    {
        ...
        {
            self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__SecContentTelegramError;
            self->D60outPdiCloseReason.IsSignalled = true;
            self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__Impermissible;
            self->D50outPdiConnectionState.IsSignalled = true;
            make_state_SSciAdjPrim__root__Impermissible(self, x);
    ...
    if (self->InMsgResetPdi__59f4.HasMessage)
    {
        ...
        {
            self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__SecFormalTelegramError;
            self->D60outPdiCloseReason.IsSignalled = true;
            self->D50outPdiConnectionState.Value = SSciAdjPrim_D50outPdiConnectionStateValue__Impermissible;
            self->D50outPdiConnectionState.IsSignalled = true;
            make_state_SSciAdjPrim__root__Impermissible(self, x);
    ...
    {
        self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PrimProtocolError;
        self->D60outPdiCloseReason.IsSignalled = true;
    ...
    if (self->Change994.IsTriggered)
    {
        self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PrimFormalTelegramError;
        self->D60outPdiCloseReason.IsSignalled = true;
    ...
    {
        self->D60outPdiCloseReason.Value = SSciAdjPrim_D60outPdiCloseReasonValue__PrimContentTelegramError;
        self->D60outPdiCloseReason.IsSignalled = true;
...
{
    self->Change1026.IsTriggered = self->T25inSecStatusReportComplete.IsTriggered;
    self->Change1223.IsTriggered = self->T5inScpConnectionEstablished.IsTriggered;
    self->Change1170.IsTriggered = self->T45inResetSevereError.IsTriggered;
    self->Change1229.IsTriggered = self->T5inScpConnectionEstablished.IsTriggered;
    self->Change744.IsTriggered = self->T10inScpConnectionTerminated.IsTriggered;
    self->Change1169.IsTriggered = self->T45inResetSevereError.IsTriggered;
    self->Change748.IsTriggered = self->T10inScpConnectionTerminated.IsTriggered;
    self->Change986.IsTriggered = self->T20inProtocolError.IsTriggered;
    self->Change994.IsTriggered = self->T21inFormalTelegramError.IsTriggered;
    self->Change1005.IsTriggered = self->T22inContentTelegramError.IsTriggered;
}
