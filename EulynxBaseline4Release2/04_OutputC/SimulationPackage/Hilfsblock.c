...
void make_state_Hilfsblock__root__AtomicState(
    Hilfsblock *self, Hilfsblock__root__state_struct *region) {
  LOG("[Hilfsblock] Entering state AtomicState in region root");
  region->state = Hilfsblock__root__AtomicState;
};

void make_state_Hilfsblock__root(Hilfsblock *self,
                                 Hilfsblock__root__state_struct *x) {
...
void transition_from_Hilfsblock__root__AtomicState(
    Hilfsblock *self, Hilfsblock__root__state_struct *x) {
...
void transition_from_Hilfsblock__root(Hilfsblock *self,
                                      Hilfsblock__root__state_struct *x) {
  switch (x->state) {
