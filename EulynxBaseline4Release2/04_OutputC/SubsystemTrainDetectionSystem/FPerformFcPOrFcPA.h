...
typedef struct FPerformFcPOrFcPA {
  ...
  // Messages -- Incoming
  MessagePort(Message__ExecuteVisualSweepingConfirmation__251f)
      InExecuteVisualSweepingConfirmation__251f;
  MessagePort(Message__ConfirmAcknowledgement__3cca)
      InConfirmAcknowledgement__3cca;
  ...
  // Change Events
  ChangeEvent Change1165; // T44in_Out_Permitted_Wheel
  ChangeEvent Change1163; // T44in_Out_Permitted_Wheel
  ChangeEvent Change1155; // T40in_Sweeping_Successful
  ChangeEvent Change1160; // T42in_In_Permitted_Wheel
  ChangeEvent Change1159; // T42in_In_Permitted_Wheel
  ChangeEvent Change1164; // T44in_Out_Permitted_Wheel
  ChangeEvent
      Change1161; // T42in_In_Permitted_Wheel OR T44in_Out_Permitted_Wheel
