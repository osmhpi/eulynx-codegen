...
void make_state_FControlTimer__root__ObserveTimer__root__NoTimer(
    FControlTimer *self,
    FControlTimer__root__ObserveTimer__root__state_struct *region) {
...
void make_state_FControlTimer__root__ObserveTimer__root(
    FControlTimer *self,
...
void make_state_FControlTimer__root__ObserveTimer(
    FControlTimer *self, FControlTimer__root__state_struct *region) {
  LOG("[FControlTimer] Entering state ObserveTimer in region root");
  region->state = FControlTimer__root__ObserveTimer;
  make_state_FControlTimer__root__ObserveTimer__root(
      self, &region->ObserveTimer.root);
};

void make_state_FControlTimer__root__WaitingForFinishBooting(
    FControlTimer *self, FControlTimer__root__state_struct *region) {
...
void make_state_FControlTimer__root__FallbackMode(
    FControlTimer *self, FControlTimer__root__state_struct *region) {
  LOG("[FControlTimer] Entering state FallbackMode in region root");
  region->state = FControlTimer__root__FallbackMode;
};

void make_state_FControlTimer__root__TechnicalDisturbance(
    FControlTimer *self, FControlTimer__root__state_struct *region) {
...
void make_state_FControlTimer__root(FControlTimer *self,
...
void transition_from_FControlTimer__root__ObserveTimer__root__NoTimer(
  ...
  if (self->Change1109.IsTriggered) {
    if ((!(self->D8inLastWheelOut.Value)) &&
        (self->D29inConTInhibitionTimer.Value != 0)) {
      self->D14outRunningTimer.Value = true;
      make_state_FControlTimer__root__ObserveTimer__root__InhibitionRunningTimer(
          self, &x->ObserveTimer.root);
      return;
    }
  }
...
void transition_from_FControlTimer__root__ObserveTimer__root__InhibitionRunningTimer(
  ...
  if (self->Time20.IsTimeoutExpired) {
    ...
    make_state_FControlTimer__root__ObserveTimer__root__NoTimer(
        self, &x->ObserveTimer.root);
    return;
  }
...
void transition_from_FControlTimer__root__ObserveTimer__root(
    FControlTimer *self, FControlTimer__root__state_struct *x) {
  ...
  case FControlTimer__root__ObserveTimer__root__InhibitionRunningTimer:
    transition_from_FControlTimer__root__ObserveTimer__root__InhibitionRunningTimer(
        self, x);
    break;
  case FControlTimer__root__ObserveTimer__root__NotificationOfAvailabilityRunningTimer:
    transition_from_FControlTimer__root__ObserveTimer__root__NotificationOfAvailabilityRunningTimer(
        self, x);
    break;
  }
}

void transition_from_FControlTimer__root__ObserveTimer(
    FControlTimer *self, FControlTimer__root__state_struct *x) {
...
void transition_from_FControlTimer__root__WaitingForFinishBooting(
    FControlTimer *self, FControlTimer__root__state_struct *x) {
...
void transition_from_FControlTimer__root__FallbackMode(
    FControlTimer *self, FControlTimer__root__state_struct *x) {
...
void transition_from_FControlTimer__root__TechnicalDisturbance(
    FControlTimer *self, FControlTimer__root__state_struct *x) {
...
void transition_from_FControlTimer__root(FControlTimer *self,
                                         FControlTimer__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FControlTimer *self) {
  self->Change492.IsTriggered = IsTriggered(MakeChange(
      self->D8inLastWheelOut.IsSignalled, self->D8inLastWheelOut.Value));
  ...
  self->Change415.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
  ...
  self->Change407.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FControlTimer_D51outEstEfesStateValue__Booting));
  self->Change413.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FControlTimer_D51outEstEfesStateValue__FallbackMode));
