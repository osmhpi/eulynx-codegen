...
void make_state_FSciTdsReceive__root__ReceivingCommands(FSciTdsReceive *self,
                                                        FSciTdsReceive__root__state_struct *region)
{
...
void transition_from_FSciTdsReceive__root__ReceivingCommands(FSciTdsReceive *self,
