...
static void Cop2ReportIncorrectCount(FPerformFcPOrFcPA *self) {
  if (self->MemLastCommand == FPerformFcPOrFcPA_MemLastCommandValue__FcP) {
    ...
    self->OutReasonFcPFailed__bfdd.Value.ReportedReasonForFailure =
        ReasonForFailure__b02d__IncorrectCount;
    self->OutReasonFcPFailed__bfdd.HasMessage = 1;
  } else if (self->MemLastCommand ==
...
void make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForSweepingTrain(
    FPerformFcPOrFcPA *self,
    FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__state_struct *region) {
...
void make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root(
    FPerformFcPOrFcPA *self,
    FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__state_struct *x) {
  memset(x, 0,
         sizeof(FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__state_struct));
  self->D19outProcessState.Value =
      FPerformFcPOrFcPA_D19outProcessStateValue__WaitingForSweepingTrain;
  self->D19outProcessState.IsSignalled = true;
  make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForSweepingTrain(
      self, x);
  return;
}

void make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *region) {
  ...
  make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root(
      self, &region->PerformFcPOrFcPA.root);
};

void make_state_FPerformFcPOrFcPA__root__Waiting(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *region) {
  LOG("[FPerformFcPOrFcPA] Entering state Waiting in region root");
  region->state = FPerformFcPOrFcPA__root__Waiting;
};

void make_state_FPerformFcPOrFcPA__root__Failed(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *region) {
  LOG("[FPerformFcPOrFcPA] Entering state Failed in region root");
  region->state = FPerformFcPOrFcPA__root__Failed;
};

void make_state_FPerformFcPOrFcPA__root(
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected__MonitorLastCountingAction__Incoming(
  ...
  if (self->Change1163.IsTriggered) {
    ...
    make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected__MonitorLastCountingAction__Outgoing(
        self, &x->PerformFcPOrFcPA.root.SweepingTrainDetected
                   .MonitorLastCountingAction);
    return;
  }
}
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected__MonitorLastCountingAction__Outgoing(
  ...
  if (self->Change1155.IsTriggered) {
    ...
    make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SuccessfulSweeping(
        self, &x->PerformFcPOrFcPA.root);
    return;
  }
  if (self->Change1160.IsTriggered) {
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected__MonitorLastCountingAction(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
  switch (x->PerformFcPOrFcPA.root.SweepingTrainDetected
              .MonitorLastCountingAction.state) {
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForSweepingTrain(
  ...
  if (self->Change1159.IsTriggered) {
    self->D19outProcessState.Value =
        FPerformFcPOrFcPA_D19outProcessStateValue__SweepingTrainDetected;
    self->D19outProcessState.IsSignalled = true;
    make_state_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected(
        self, &x->PerformFcPOrFcPA.root);
    return;
  }
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
  transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected__MonitorTMin(
      self, x);
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForAcknowledgement(
  ...
  if (self->Change1161.IsTriggered) {
    Cop2ReportIncorrectCount(self);
    make_state_FPerformFcPOrFcPA__root__Failed(self, x);
    return;
  }
...
void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
  switch (x->PerformFcPOrFcPA.root.state) {
  case FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForSweepingTrain:
    transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForSweepingTrain(
        self, x);
    break;
  case FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected:
    transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SweepingTrainDetected(
        self, x);
    break;
  case FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForAcknowledgement:
    transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__WaitingForAcknowledgement(
        self, x);
    break;
  case FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SuccessfulSweeping:
    transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA__root__SuccessfulSweeping(
        self, x);
    break;
  }
}

void transition_from_FPerformFcPOrFcPA__root__PerformFcPOrFcPA(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
  ...
  if (self->Change1122.IsTriggered) {
    self->D18outPerformFcPOrFcA.Value = false;
    Cop2ReportIncorrectCount(self);
    make_state_FPerformFcPOrFcPA__root__Failed(self, x);
    return;
  }
  if (self->Change1274.IsTriggered) {
    self->D18outPerformFcPOrFcA.Value = false;
...
void transition_from_FPerformFcPOrFcPA__root__Waiting(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
...
void transition_from_FPerformFcPOrFcPA__root__Failed(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
...
void transition_from_FPerformFcPOrFcPA__root(
    FPerformFcPOrFcPA *self, FPerformFcPOrFcPA__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FPerformFcPOrFcPA *self) {
  self->Change1165.IsTriggered = self->T44inOutPermittedWheel.IsTriggered;
  self->Change1163.IsTriggered = self->T44inOutPermittedWheel.IsTriggered;
  self->Change1155.IsTriggered = self->T40inSweepingSuccessful.IsTriggered;
  self->Change1160.IsTriggered = self->T42inInPermittedWheel.IsTriggered;
  self->Change1159.IsTriggered = self->T42inInPermittedWheel.IsTriggered;
  self->Change1164.IsTriggered = self->T44inOutPermittedWheel.IsTriggered;
  self->Change1161.IsTriggered = IsTriggered(
      OrChange(MakeChange(self->T42inInPermittedWheel.IsTriggered,
                          self->T42inInPermittedWheel.IsTriggered),
               MakeChange(self->T44inOutPermittedWheel.IsTriggered,
                          self->T44inOutPermittedWheel.IsTriggered)));
  self->Change258.IsTriggered =
      IsTriggered(MakeChange(self->D32inCriticalFailureTvps.IsSignalled,
                             self->D32inCriticalFailureTvps.Value));
  self->Change1122.IsTriggered = self->T39inUndefinedPattern.IsTriggered;
  self->Change1274.IsTriggered = IsTriggered(
      OrChange(MakeChange(self->T88inInNotPermittedWheel.IsTriggered,
                          self->T88inInNotPermittedWheel.IsTriggered),
               MakeChange(self->T43inOutNotPermittedWheel.IsTriggered,
                          self->T43inOutNotPermittedWheel.IsTriggered)));
}
