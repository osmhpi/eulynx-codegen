...
static void Cop2ReportCtInitial(FObserveOccupancyStatus *self) {
  ...
  self->OutChangeTrigger__e05e.Value.ReportedChangeTrigger =
...
void make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus__root(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__ObserveTvpsStatus__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          FObserveOccupancyStatus__root__ObserveTvpsStatus__root__state_struct));
  ...
  if (self->D26inConVariantAIsUsed.Value) {
    ...
    self->D9outOccupancyStatus.Value =
...
void make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus(
    FObserveOccupancyStatus *self,
  ...
  make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus__root(
      self, &region->ObserveTvpsStatus.root);
};

void make_state_FObserveOccupancyStatus__root__FallbackMode(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *region) {
...
void make_state_FObserveOccupancyStatus__root__TechnicalDisturbance(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *region) {
...
void make_state_FObserveOccupancyStatus__root(
    FObserveOccupancyStatus *self,
...
void transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__UnreliableIncoming(
  ...
  if (self->InExecuteFc__ffe5.HasMessage) {
    ...
    make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__Vacant(
        self, &x->ObserveTvpsStatus.root);
    return;
  }
...
void transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__Vacant(
  ...
  if (self->Change1104.IsTriggered) {
    ...
    self->D9outOccupancyStatus.IsSignalled = true;
    make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedIncoming(
        self, &x->ObserveTvpsStatus.root);
    return;
  }
...
void transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedIncoming(
  ...
  if (self->InExecuteDrfc__4da5.HasMessage) {
    ...
    self->D9outOccupancyStatus.IsSignalled = true;
    make_state_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedOutgoing(
        self, &x->ObserveTvpsStatus.root);
    return;
  }
  if (self->InExecuteFc__ffe5.HasMessage) {
...
void transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root(
  ...
  case FObserveOccupancyStatus__root__ObserveTvpsStatus__root__UnreliableIncoming:
    transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__UnreliableIncoming(
        self, x);
    break;
  case FObserveOccupancyStatus__root__ObserveTvpsStatus__root__UnreliableOutgoing:
    transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__UnreliableOutgoing(
        self, x);
    break;
  case FObserveOccupancyStatus__root__ObserveTvpsStatus__root__Vacant:
    transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__Vacant(
        self, x);
    break;
  case FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedIncoming:
    transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedIncoming(
        self, x);
    break;
  case FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedOutgoing:
    transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root__OccupiedOutgoing(
        self, x);
    break;
...
void transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *x) {
  transition_from_FObserveOccupancyStatus__root__ObserveTvpsStatus__root(self,
                                                                         x);
...
void transition_from_FObserveOccupancyStatus__root__FallbackMode(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *x) {
...
void transition_from_FObserveOccupancyStatus__root__TechnicalDisturbance(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *x) {
...
void transition_from_FObserveOccupancyStatus__root(
    FObserveOccupancyStatus *self,
    FObserveOccupancyStatus__root__state_struct *x) {
  switch (x->state) {
  ...
  case FObserveOccupancyStatus__root__WaitingForFinishBooting:
    transition_from_FObserveOccupancyStatus__root__WaitingForFinishBooting(self,
                                                                           x);
    break;
  case FObserveOccupancyStatus__root__TechnicalDisturbance:
    transition_from_FObserveOccupancyStatus__root__TechnicalDisturbance(self,
                                                                        x);
    break;
  }
}
...
static void evaluateChangeEvents(FObserveOccupancyStatus *self) {
  self->Change1116.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change1101.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change1110.IsTriggered = IsTriggered(
      OrChange(MakeChange(self->T37inWheelIn.IsTriggered,
                          self->T37inWheelIn.IsTriggered),
               MakeChange(self->T39inUndefinedPattern.IsTriggered,
                          self->T39inUndefinedPattern.IsTriggered)));
  self->Change1112.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change1104.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change1111.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change1121.IsTriggered = self->T39inUndefinedPattern.IsTriggered;
  self->Change1114.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change1120.IsTriggered = self->T39inUndefinedPattern.IsTriggered;
  self->Change1105.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change542.IsTriggered = IsTriggered(
      MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
  self->Change543.IsTriggered = IsTriggered(
      MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
  self->Change1106.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change1119.IsTriggered = self->T39inUndefinedPattern.IsTriggered;
  self->Change1117.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change552.IsTriggered = IsTriggered(NegateChange(MakeChange(
      self->D14nRunningTimer.IsSignalled, self->D14nRunningTimer.Value)));
  self->Change1102.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change1115.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change1118.IsTriggered = self->T39inUndefinedPattern.IsTriggered;
  self->Change257.IsTriggered =
      IsTriggered(MakeChange(self->D32inCriticalFailureTvps.IsSignalled,
                             self->D32inCriticalFailureTvps.Value));
  self->Change411.IsTriggered = IsTriggered(OrChange(
  ...
  self->Change418.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
          FObserveOccupancyStatus_D51outEstEfesStateValue__FallbackMode));
  self->Change1103.IsTriggered = self->T37inWheelIn.IsTriggered;
  self->Change1113.IsTriggered = self->T38inWheelOut.IsTriggered;
  self->Change405.IsTriggered = IsTriggered(
      MakeChange(self->D51outEstEfesState.IsSignalled,
                 self->D51outEstEfesState.Value ==
                     FObserveOccupancyStatus_D51outEstEfesStateValue__Booting));
  self->Change424.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
          FObserveOccupancyStatus_D51outEstEfesStateValue__Initialising));
  self->Change416.IsTriggered = IsTriggered(MakeChange(
      self->D51outEstEfesState.IsSignalled,
      self->D51outEstEfesState.Value ==
          FObserveOccupancyStatus_D51outEstEfesStateValue__FallbackMode));
  self->Change569.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D32inCriticalFailureTvps.IsSignalled,
                              self->D32inCriticalFailureTvps.Value)));
}
