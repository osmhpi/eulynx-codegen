...
static void evaluateChangeEvents(FObserveOccupancyStatus *self)
{
    ...
    self->Change542.IsTriggered = IsTriggered(MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
    self->Change543.IsTriggered = IsTriggered(MakeChange(self->MemDifference.IsSignalled, self->MemDifference == 0));
    ...
    self->Change411.IsTriggered = IsTriggered(
    ...
    self->Change418.IsTriggered = IsTriggered(
        MakeChange(self->D51outEstEfesState.IsSignalled,
    ...
    self->Change416.IsTriggered = IsTriggered(
        MakeChange(self->D51outEstEfesState.IsSignalled,
                   self->D51outEstEfesState.Value == FObserveOccupancyStatus_D51outEstEfesStateValue__FallbackMode));
