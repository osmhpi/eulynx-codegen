...
void make_state_FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal(
    FHandleInternalFcUCommand *self,
    FHandleInternalFcUCommand__root__state_struct *region) {
...
void make_state_FHandleInternalFcUCommand__root(
    FHandleInternalFcUCommand *self,
    FHandleInternalFcUCommand__root__state_struct *x) {
  memset(x, 0, sizeof(FHandleInternalFcUCommand__root__state_struct));

  make_state_FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal(
      self, x);
  return;
}
...
void transition_from_FHandleInternalFcUCommand__root(
    FHandleInternalFcUCommand *self,
    FHandleInternalFcUCommand__root__state_struct *x) {
  switch (x->state) {
  case FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal:
    transition_from_FHandleInternalFcUCommand__root__ReceivingCommandsFromInternal(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(FHandleInternalFcUCommand *self) {
  self->Change1094.IsTriggered = self->T33inFcU.IsTriggered;
}
