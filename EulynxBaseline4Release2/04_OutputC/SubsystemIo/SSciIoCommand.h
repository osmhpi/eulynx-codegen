...
typedef struct SSciIoCommand {
  ...
  DataPort(SSciIoCommand_D31inRequiredChannelState1Value, )
      D31inRequiredChannelState1;

  /// d50in_PDI_Connection_State
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(SSciIoCommand_D50inPdiConnectionStateValue, )
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(SSciIoCommand_D32inRequiredChannelStatenValue, )
      D32inRequiredChannelStaten;
  ...
  ChangeEvent Change1085; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1086; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1083; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1087; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1091; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1090; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1088; // t30in_New_Output_Channel_State_Required
  ChangeEvent Change1089; // t30in_New_Output_Channel_State_Required
