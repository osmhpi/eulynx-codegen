...
typedef struct FMonitorOutputChannelDisturbanceState {
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FMonitorOutputChannelDisturbanceState_D4inConChannelTypeValue, )
      D4inConChannelType;
  ...
  // Change Events
  ChangeEvent Change285; // D41in_Disturbance_ROC
  ChangeEvent Change286; // D41in_Disturbance_ROC OR D42in_Disturbance_VOC
  ChangeEvent Change576; // NOT D41in_Disturbance_ROC
  ChangeEvent
      Change577; // NOT D41in_Disturbance_ROC AND NOT D42in_Disturbance_VOC
...
void new_FMonitorOutputChannelDisturbanceState(
    FMonitorOutputChannelDisturbanceState *x);
