...
typedef struct SSciIoReceive__root__state_struct {
  ...
  union {
    SSciIoReceive__root__ReceivingInputAndOutputChannelStates__state_struct
        ReceivingInputAndOutputChannelStates;
  };
...
typedef struct SSciIoReceive {
  ...
  DataPort(SSciIoReceive_D71outReportedInputChannelState1Value, )
      D71outReportedInputChannelState1;
  ...
  DataPort(SSciIoReceive_D50inPdiConnectionStateValue, )
      D50inPdiConnectionState;

  /// d72out_Reported_Input_Channel_StateN
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(SSciIoReceive_D72outReportedInputChannelStatenValue, )
      D72outReportedInputChannelStaten;
  ...
  MessagePort(Message__MsgStateOfInputChannels__8132)
      InMsgStateOfInputChannels__8132;
  MessagePort(Message__MsgStateOfOutputChannels__c6d6)
      InMsgStateOfOutputChannels__c6d6;
  // Messages -- Outgoing

  // Change Events
  ChangeEvent Change323; // d50in_PDI_Connection_State = "DISCONNECTED"OR
