    ...
    FSciIoReceive *self, FSciIoReceive__root__state_struct *x)
{
    ...
    {
        if (!(self->D13outSwitchOffEachPhysicalOuputChannel.Value))
        {
...
{
    self->Change502.IsTriggered = IsTriggered(
    ...
    self->Change548.IsTriggered =
        IsTriggered(NegateChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                                            self->D13outSwitchOffEachPhysicalOuputChannel.Value)));
    self->Change100.IsTriggered = IsTriggered(
        OrChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                            self->D13outSwitchOffEachPhysicalOuputChannel.Value),
                 MakeChange(self->D9inMonitoredOutputChannelDisturbanceState1.IsSignalled,
                            self->D9inMonitoredOutputChannelDisturbanceState1.Value ==
                                FSciIoReceive_D9inMonitoredOutputChannelDisturbanceState1Value__PhysicallyDisturbed)));
    self->Change500.IsTriggered = IsTriggered(
    ...
    self->Change549.IsTriggered =
        IsTriggered(NegateChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                                            self->D13outSwitchOffEachPhysicalOuputChannel.Value)));
    self->Change99.IsTriggered = IsTriggered(
        OrChange(MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                            self->D13outSwitchOffEachPhysicalOuputChannel.Value),
                 MakeChange(self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
                            self->D9inMonitoredOutputChannelDisturbanceStaten.Value ==
                                FSciIoReceive_D9inMonitoredOutputChannelDisturbanceStatenValue__PhysicallyDisturbed)));
    self->Change336.IsTriggered = IsTriggered(OrChange(
        OrChange(
