...
void make_state_FSciIoReceive__root__ReceivingCommands(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *region) {
...
void make_state_FSciIoReceive__root__InterfaceConnectionClosed(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *region) {
...
void make_state_FSciIoReceive__root(FSciIoReceive *self,
...
void transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelState1(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *x) {
  ...
  case FSciIoReceive__root__ReceivingCommands__OutputChannelState1__ReceivingCommandsChannel1:
    transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelState1__ReceivingCommandsChannel1(
        self, x);
    break;
  }
}
...
void transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelStateN(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *x) {
  ...
  case FSciIoReceive__root__ReceivingCommands__OutputChannelStateN__ReceivingCommandsChannelN:
    transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelStateN__ReceivingCommandsChannelN(
        self, x);
    break;
  }
}

void transition_from_FSciIoReceive__root__ReceivingCommands(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *x) {
  transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelState1(
      self, x);
  transition_from_FSciIoReceive__root__ReceivingCommands__OutputChannelStateN(
      self, x);
...
void transition_from_FSciIoReceive__root__InterfaceConnectionClosed(
    FSciIoReceive *self, FSciIoReceive__root__state_struct *x) {
...
void transition_from_FSciIoReceive__root(FSciIoReceive *self,
                                         FSciIoReceive__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FSciIoReceive *self) {
  self->Change502.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D9inMonitoredOutputChannelDisturbanceState1.Value ==
          FSciIoReceive_D9inMonitoredOutputChannelDisturbanceState1Value__NotPhysicallyDisturbed));
  self->Change548.IsTriggered = IsTriggered(NegateChange(
      MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                 self->D13outSwitchOffEachPhysicalOuputChannel.Value)));
  self->Change100.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                 self->D13outSwitchOffEachPhysicalOuputChannel.Value),
      MakeChange(
          self->D9inMonitoredOutputChannelDisturbanceState1.IsSignalled,
  ...
  self->Change500.IsTriggered = IsTriggered(MakeChange(
      self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
      self->D9inMonitoredOutputChannelDisturbanceStaten.Value ==
          FSciIoReceive_D9inMonitoredOutputChannelDisturbanceStatenValue__NotPhysicallyDisturbed));
  self->Change549.IsTriggered = IsTriggered(NegateChange(
      MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                 self->D13outSwitchOffEachPhysicalOuputChannel.Value)));
  self->Change99.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D13outSwitchOffEachPhysicalOuputChannel.IsSignalled,
                 self->D13outSwitchOffEachPhysicalOuputChannel.Value),
      MakeChange(
          self->D9inMonitoredOutputChannelDisturbanceStaten.IsSignalled,
