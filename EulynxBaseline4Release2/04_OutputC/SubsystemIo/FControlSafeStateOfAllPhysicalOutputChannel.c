...
void make_state_FControlSafeStateOfAllPhysicalOutputChannel__root(
  ...
  memset(
      x, 0,
      sizeof(FControlSafeStateOfAllPhysicalOutputChannel__root__state_struct));
  self->D13outSwitchOffEachPhysicalOuputChannel.Value = false;
  make_state_FControlSafeStateOfAllPhysicalOutputChannel__root__NotSwitchedOffAllPhysicalOutputChannel(
      self, x);
  return;
}
...
void transition_from_FControlSafeStateOfAllPhysicalOutputChannel__root__NotSwitchedOffAllPhysicalOutputChannel(
  ...
  if (self->Change357.IsTriggered) {
    ...
    make_state_FControlSafeStateOfAllPhysicalOutputChannel__root__SwitchedOffAllPhysicalOutputChannel(
        self, x);
    return;
  }
...
void transition_from_FControlSafeStateOfAllPhysicalOutputChannel__root(
  ...
  case FControlSafeStateOfAllPhysicalOutputChannel__root__NotSwitchedOffAllPhysicalOutputChannel:
    transition_from_FControlSafeStateOfAllPhysicalOutputChannel__root__NotSwitchedOffAllPhysicalOutputChannel(
        self, x);
    break;
  case FControlSafeStateOfAllPhysicalOutputChannel__root__SwitchedOffAllPhysicalOutputChannel:
    transition_from_FControlSafeStateOfAllPhysicalOutputChannel__root__SwitchedOffAllPhysicalOutputChannel(
        self, x);
    break;
  }
}
...
static void
evaluateChangeEvents(FControlSafeStateOfAllPhysicalOutputChannel *self) {
...
void transition_FControlSafeStateOfAllPhysicalOutputChannel(
  ...
  transition_from_FControlSafeStateOfAllPhysicalOutputChannel__root(
      self, &self->state);
  resetTriggers(self);
}
...
void new_FControlSafeStateOfAllPhysicalOutputChannel(
    FControlSafeStateOfAllPhysicalOutputChannel *self) {
  make_state_FControlSafeStateOfAllPhysicalOutputChannel__root(self,
                                                               &self->state);
}
