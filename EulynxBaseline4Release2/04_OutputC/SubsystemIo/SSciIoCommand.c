...
static void evaluateChangeEvents(SSciIoCommand *self)
{
    ...
    self->Change1085.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1086.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1083.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1087.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1091.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1090.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1088.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
    self->Change1089.IsTriggered = self->T30inNewOutputChannelStateRequired.IsTriggered;
}
...
#ifdef KLEE_ENABLED
#include "../../05_OutputKleeAnalysis/SubsystemIo/SSciIoCommand.c"
#endif
