...
void make_state_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root(
  ...
  if (((self->D12inConLuminosity.Value == false) &&
       (!(self->D14inLuminosityNightFault.Value))) ||
      ((((self->D13inLuminosityDayFault.Value) &&
         (self->D12inConLuminosity.Value == true)) &&
        (!(self->D14inLuminosityNightFault.Value))) &&
       (!(self->D16inLuminositySetUnchangeable.Value)))) {
    self->D9outSetLuminosity.Value =
...
void make_state_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity(
    FControlLuminosity *self,
    FControlLuminosity__root__OperatingVoltage__root__state_struct *region) {
...
void make_state_FControlLuminosity__root__OperatingVoltage__root(
    FControlLuminosity *self,
    FControlLuminosity__root__OperatingVoltage__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(FControlLuminosity__root__OperatingVoltage__root__state_struct));

  make_state_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity(
      self, x);
  return;
}

void make_state_FControlLuminosity__root__NoOperatingVoltage(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *region) {
...
void make_state_FControlLuminosity__root__OperatingVoltage(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *region) {
  ...
  make_state_FControlLuminosity__root__OperatingVoltage__root(
      self, &region->OperatingVoltage.root);
};

void make_state_FControlLuminosity__root(
...
void transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Night(
  ...
  if (self->Change101.IsTriggered) {
    if ((!(self->D51inEstEfesState.Value ==
...
void transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root(
  ...
  case FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Night:
    transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Night(
        self, x);
    break;
  case FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Day:
    transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Day(
        self, x);
    break;
  case FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Undefined:
    transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root__Undefined(
        self, x);
    break;
  }
}
...
void transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *x) {
  transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity__root(
      self, x);
...
void transition_from_FControlLuminosity__root__OperatingVoltage__root(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *x) {
  switch (x->OperatingVoltage.root.state) {
  case FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity:
    transition_from_FControlLuminosity__root__OperatingVoltage__root__ControllingLuminosity(
        self, x);
    break;
  }
}

void transition_from_FControlLuminosity__root__NoOperatingVoltage(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *x) {
...
void transition_from_FControlLuminosity__root__OperatingVoltage(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *x) {
...
void transition_from_FControlLuminosity__root(
    FControlLuminosity *self, FControlLuminosity__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FControlLuminosity *self) {
  self->Change101.IsTriggered =
      IsTriggered(MakeChange(self->D14inLuminosityNightFault.IsSignalled,
                             self->D14inLuminosityNightFault.Value));
  self->Change102.IsTriggered =
      IsTriggered(MakeChange(self->D14inLuminosityNightFault.IsSignalled,
                             self->D14inLuminosityNightFault.Value));
  self->Change103.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D14inLuminosityNightFault.IsSignalled,
                 self->D14inLuminosityNightFault.Value),
      MakeChange(self->D11inRequiredLuminosity.IsSignalled,
                 self->D11inRequiredLuminosity.Value ==
                     FControlLuminosity_D11inRequiredLuminosityValue__Day)));
  self->Change83.IsTriggered =
      IsTriggered(MakeChange(self->D13inLuminosityDayFault.IsSignalled,
                             self->D13inLuminosityDayFault.Value));
  self->Change84.IsTriggered =
      IsTriggered(MakeChange(self->D13inLuminosityDayFault.IsSignalled,
                             self->D13inLuminosityDayFault.Value));
  self->Change85.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D13inLuminosityDayFault.IsSignalled,
                 self->D13inLuminosityDayFault.Value),
      MakeChange(self->D11inRequiredLuminosity.IsSignalled,
                 self->D11inRequiredLuminosity.Value ==
                     FControlLuminosity_D11inRequiredLuminosityValue__Night)));
  self->Change366.IsTriggered = IsTriggered(OrChange(
  ...
  self->Change352.IsTriggered = IsTriggered(
      MakeChange(self->D51inEstEfesState.IsSignalled,
                 self->D51inEstEfesState.Value ==
                     FControlLuminosity_D51inEstEfesStateValue__Booting));
  self->Change385.IsTriggered = IsTriggered(MakeChange(
