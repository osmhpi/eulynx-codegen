...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__ReceivingSignalAspects(
    FSciLsReceive *self, FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__state_struct *region)
{
...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect(
    FSciLsReceive *self, FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__state_struct *x)
{
    memset(x, 0, sizeof(FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__state_struct));
    self->D2outRequiredSignalAspect.Value = FSciLsReceive_D2outRequiredSignalAspectValue__Unknown;
    self->D2outRequiredSignalAspect.IsSignalled = true;
    make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__ReceivingSignalAspects(self,
                                                                                                                x);
    return;
}
...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingIntentionallyDark__ReceivingIntentionallyDark(
    FSciLsReceive *self,
    FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingIntentionallyDark__state_struct *region)
{
...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingIntentionallyDark(
    FSciLsReceive *self, FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingIntentionallyDark__state_struct *x)
{
...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__ReceivingLuminosity(
    FSciLsReceive *self, FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__state_struct *region)
{
...
void make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity(
    FSciLsReceive *self, FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__state_struct *x)
{
    memset(x, 0, sizeof(FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__state_struct));
    self->D11outRequiredLuminosity.Value = FSciLsReceive_D11outRequiredLuminosityValue__Unknown;
    self->D11outRequiredLuminosity.IsSignalled = true;
    make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__ReceivingLuminosity(self, x);
    return;
}
    ...
    FSciLsReceive *self, FSciLsReceive__root__state_struct *x)
{
    ...
    if (self->InCdIndicateSignalAspect__e570.HasMessage)
    {
        ...
        {
            self->D2outRequiredSignalAspect.Value = FSciLsReceive_D2outRequiredSignalAspectValue__SignalAspect2;
            self->D2outRequiredSignalAspect.IsSignalled = true;
            make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__ReceivingSignalAspects(
                self, &x->ReceivingLightSignalCommands.ReceivingSignalAspect);
            return;
    ...
    if (self->InCdIndicateSignalAspect__e570.HasMessage)
    {
        ...
        {
            self->D2outRequiredSignalAspect.Value = FSciLsReceive_D2outRequiredSignalAspectValue__MostRestrictAspect;
            self->D2outRequiredSignalAspect.IsSignalled = true;
            make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__ReceivingSignalAspects(
                self, &x->ReceivingLightSignalCommands.ReceivingSignalAspect);
            return;
    ...
    if (self->InCdIndicateSignalAspect__e570.HasMessage)
    {
        ...
        {
            self->D2outRequiredSignalAspect.Value = FSciLsReceive_D2outRequiredSignalAspectValue__SignalAspect1;
            self->D2outRequiredSignalAspect.IsSignalled = true;
            make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingSignalAspect__ReceivingSignalAspects(
                self, &x->ReceivingLightSignalCommands.ReceivingSignalAspect);
            return;
    ...
    FSciLsReceive *self, FSciLsReceive__root__state_struct *x)
{
    ...
    if (self->InCdSetLuminosity__4570.HasMessage)
    {
        ...
        {
            self->D11outRequiredLuminosity.Value = FSciLsReceive_D11outRequiredLuminosityValue__Day;
            self->D11outRequiredLuminosity.IsSignalled = true;
            make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__ReceivingLuminosity(
                self, &x->ReceivingLightSignalCommands.ReceivingLuminosity);
            return;
    ...
    if (self->InCdSetLuminosity__4570.HasMessage)
    {
        ...
        {
            self->D11outRequiredLuminosity.Value = FSciLsReceive_D11outRequiredLuminosityValue__Night;
            self->D11outRequiredLuminosity.IsSignalled = true;
            make_state_FSciLsReceive__root__ReceivingLightSignalCommands__ReceivingLuminosity__ReceivingLuminosity(
                self, &x->ReceivingLightSignalCommands.ReceivingLuminosity);
            return;
...
void transition_from_FSciLsReceive__root__ReceivingLightSignalCommands(FSciLsReceive *self,
...
{
    self->Change311.IsTriggered = IsTriggered(
        OrChange(OrChange(MakeChange(self->D4inFaultLampsAspect1.IsSignalled, self->D4inFaultLampsAspect1.Value),
                          MakeChange(self->D5inFaultLampsAspect2.IsSignalled, self->D5inFaultLampsAspect2.Value)),
                 MakeChange(self->D6inFaultLampsMostRestrict.IsSignalled, self->D6inFaultLampsMostRestrict.Value)));
    self->Change581.IsTriggered = IsTriggered(
        NegateChange(MakeChange(self->D4inFaultLampsAspect1.IsSignalled, self->D4inFaultLampsAspect1.Value)));
    self->Change584.IsTriggered = IsTriggered(
        NegateChange(MakeChange(self->D5inFaultLampsAspect2.IsSignalled, self->D5inFaultLampsAspect2.Value)));
    self->Change587.IsTriggered = IsTriggered(
    ...
    self->Change86.IsTriggered = IsTriggered(
        OrChange(MakeChange(self->D13inLuminosityDayFault.IsSignalled, self->D13inLuminosityDayFault.Value),
                 MakeChange(self->D14inLuminosityNightFault.IsSignalled, self->D14inLuminosityNightFault.Value)));
    self->Change547.IsTriggered = IsTriggered(
    ...
    self->Change332.IsTriggered = IsTriggered(OrChange(
        OrChange(
            ...
            MakeChange(self->D50inPdiConnectionState.IsSignalled,
                       self->D50inPdiConnectionState.Value == FSciLsReceive_D50inPdiConnectionStateValue__ReadyForPdi)),
        MakeChange(self->D50inPdiConnectionState.IsSignalled,
                   self->D50inPdiConnectionState.Value == FSciLsReceive_D50inPdiConnectionStateValue__Suspended)));
}
