...
static void evaluateChangeEvents(FObserveLuminosity *self) {
  self->Change192.IsTriggered = IsTriggered(
      MakeChange(self->D22inSensedLuminosity.IsSignalled,
                 self->D22inSensedLuminosity.Value ==
                     FObserveLuminosity_D22inSensedLuminosityValue__Night));
  self->Change191.IsTriggered = IsTriggered(
      MakeChange(self->D22inSensedLuminosity.IsSignalled,
                 self->D22inSensedLuminosity.Value ==
                     FObserveLuminosity_D22inSensedLuminosityValue__Day));
  self->Change190.IsTriggered = IsTriggered(
      MakeChange(self->D22inSensedLuminosity.IsSignalled,
                 self->D22inSensedLuminosity.Value ==
                     FObserveLuminosity_D22inSensedLuminosityValue__Day));
  self->Change193.IsTriggered = IsTriggered(
      MakeChange(self->D22inSensedLuminosity.IsSignalled,
                 self->D22inSensedLuminosity.Value ==
                     FObserveLuminosity_D22inSensedLuminosityValue__Night));
  self->Change351.IsTriggered = IsTriggered(
  ...
  self->Change360.IsTriggered = IsTriggered(OrChange(
      MakeChange(self->D51inEstEfesState.IsSignalled,
                 self->D51inEstEfesState.Value ==
                     FObserveLuminosity_D51inEstEfesStateValue__Booting),
      MakeChange(self->D51inEstEfesState.IsSignalled,
  ...
  self->Change383.IsTriggered = IsTriggered(MakeChange(
