...
typedef struct FSciLsReceive {
  ...
  DataPort(FSciLsReceive_D50inPdiConnectionStateValue, )
      D50inPdiConnectionState;

  /// d2out_Required_Signal_Aspect
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FSciLsReceive_D2outRequiredSignalAspectValue, )
      D2outRequiredSignalAspect;
  ...
  /// Trigger: False, DataPort: True, In: False, Out: True, External: False
  DataPort(FSciLsReceive_D11outRequiredLuminosityValue, )
      D11outRequiredLuminosity;
  ...
  // Messages -- Incoming
  MessagePort(Message__CdIndicateSignalAspect__e570)
      InCdIndicateSignalAspect__e570;
  MessagePort(Message__CdSetLuminosity__4570) InCdSetLuminosity__4570;
  // Messages -- Outgoing

  // Change Events
  ChangeEvent
      Change311; // D4in_Fault_Lamps_Aspect_1 OR D5in_Fault_Lamps_Aspect_2 OR
                 // D6in_Fault_Lamps_Most_Restrict
  ...
  ChangeEvent
      Change86; // D13in_Luminosity_Day_Fault OR D14in_Luminosity_Night_Fault
  ChangeEvent Change547; // NOT D13in_Luminosity_Day_Fault
  ChangeEvent Change550; // NOT D14in_Luminosity_Night_Fault
  ChangeEvent
      Change332; // d50in_PDI_Connection_State = "NOT_READY_FOR_PDI_NO_SCP" OR
