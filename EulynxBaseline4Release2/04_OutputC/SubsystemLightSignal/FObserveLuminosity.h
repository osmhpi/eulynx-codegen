...
typedef struct FObserveLuminosity {
  ...
  DataPort(FObserveLuminosity_D21outObservedLuminosityValue, )
      D21outObservedLuminosity;

  /// D22in_Sensed_Luminosity
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveLuminosity_D22inSensedLuminosityValue, )
      D22inSensedLuminosity;
  ...
  // Change Events
  ChangeEvent Change192; // D22in_Sensed_Luminosity = "Night"
  ChangeEvent Change191; // D22in_Sensed_Luminosity = "Day"
