...
void transition_from_FControlSignalAspect__root__OperatingVoltage__root__ControllingSignalAspect(
  ...
  if (self->Change521.IsTriggered) {
    ...
    self->D7outSetSignalAspect.IsSignalled = true;
    make_state_FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspect(
...
void transition_from_FControlSignalAspect__root__OperatingVoltage__root(
  ...
  case FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspect:
    transition_from_FControlSignalAspect__root__OperatingVoltage__root__SetNoSignalAspect(
        self, x);
    break;
  }
}
...
static void evaluateChangeEvents(FControlSignalAspect *self) {
  self->Change210.IsTriggered = IsTriggered(OrChange(
      MakeChange(
      ...
      MakeChange(self->D5inFaultLampsAspect2.IsSignalled,
                 self->D5inFaultLampsAspect2.Value)));
  self->Change211.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D2inRequiredSignalAspect.IsSignalled,
          self->D2inRequiredSignalAspect.Value ==
              FControlSignalAspect_D2inRequiredSignalAspectValue__MostRestrictAspect),
  ...
  self->Change282.IsTriggered =
      IsTriggered(MakeChange(self->D3inRequiredIntentionallyDark.IsSignalled,
                             self->D3inRequiredIntentionallyDark.Value));
  self->Change575.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D3inRequiredIntentionallyDark.IsSignalled,
                              self->D3inRequiredIntentionallyDark.Value)));
  ...
  self->Change588.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D6inFaultLampsMostRestrict.IsSignalled,
                              self->D6inFaultLampsMostRestrict.Value)));
  self->Change212.IsTriggered = IsTriggered(MakeChange(
      self->D2inRequiredSignalAspect.IsSignalled,
      self->D2inRequiredSignalAspect.Value ==
          FControlSignalAspect_D2inRequiredSignalAspectValue__MostRestrictAspect));
  self->Change213.IsTriggered = IsTriggered(MakeChange(
      self->D2inRequiredSignalAspect.IsSignalled,
      self->D2inRequiredSignalAspect.Value ==
          FControlSignalAspect_D2inRequiredSignalAspectValue__MostRestrictAspect));
  ...
  self->Change350.IsTriggered = IsTriggered(
