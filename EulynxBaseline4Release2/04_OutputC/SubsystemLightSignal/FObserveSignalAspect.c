...
void make_state_FObserveSignalAspect__root__ObservingSignalAspect__root(
    FObserveSignalAspect *self,
    FObserveSignalAspect__root__ObservingSignalAspect__root__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          FObserveSignalAspect__root__ObservingSignalAspect__root__state_struct));

  make_state_FObserveSignalAspect__root__ObservingSignalAspect__root__Waiting(
      self, x);
  return;
}

void make_state_FObserveSignalAspect__root__NationalAspect(
    FObserveSignalAspect *self,
...
void make_state_FObserveSignalAspect__root__ObservingSignalAspect(
    FObserveSignalAspect *self,
    FObserveSignalAspect__root__state_struct *region) {
  ...
  make_state_FObserveSignalAspect__root__ObservingSignalAspect__root(
      self, &region->ObservingSignalAspect.root);
};

void make_state_FObserveSignalAspect__root(
...
void transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__SignalAspect2(
  ...
  if (self->Change115.IsTriggered) {
    ...
    self->D20outObservedIntentionallyDark.Value =
        self->D18inSensedIntentionallyDark.Value;
...
void transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root(
  ...
  case FObserveSignalAspect__root__ObservingSignalAspect__root__SignalAspect2:
    transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__SignalAspect2(
        self, x);
    break;
  case FObserveSignalAspect__root__ObservingSignalAspect__root__NoSignalAspect:
    transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__NoSignalAspect(
        self, x);
    break;
  case FObserveSignalAspect__root__ObservingSignalAspect__root__Waiting:
    transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__Waiting(
        self, x);
    break;
  case FObserveSignalAspect__root__ObservingSignalAspect__root__MostRestrictAspect:
    transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__MostRestrictAspect(
        self, x);
    break;
  case FObserveSignalAspect__root__ObservingSignalAspect__root__SignalAspect1:
    transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root__SignalAspect1(
        self, x);
    break;
  }
}

void transition_from_FObserveSignalAspect__root__NationalAspect(
    FObserveSignalAspect *self, FObserveSignalAspect__root__state_struct *x) {
...
void transition_from_FObserveSignalAspect__root__ObservingSignalAspect(
    FObserveSignalAspect *self, FObserveSignalAspect__root__state_struct *x) {
  transition_from_FObserveSignalAspect__root__ObservingSignalAspect__root(self,
                                                                          x);
...
void transition_from_FObserveSignalAspect__root(
    FObserveSignalAspect *self, FObserveSignalAspect__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FObserveSignalAspect *self) {
  ...
  self->Change119.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D17inSensedSignalAspect.IsSignalled,
          self->D17inSensedSignalAspect.Value ==
  ...
  self->Change134.IsTriggered =
      IsTriggered(MakeChange(self->D18inSensedIntentionallyDark.IsSignalled,
                             self->D18inSensedIntentionallyDark.Value));
  self->Change560.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D18inSensedIntentionallyDark.IsSignalled,
                              self->D18inSensedIntentionallyDark.Value)));
  ...
  self->Change112.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D17inSensedSignalAspect.Value ==
          FObserveSignalAspect_D17inSensedSignalAspectValue__MostRestrictAspect));
  self->Change116.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D17inSensedSignalAspect.IsSignalled,
          self->D17inSensedSignalAspect.Value ==
              FObserveSignalAspect_D17inSensedSignalAspectValue__NoSignalAspectLampFailure),
      MakeChange(
          ...
          self->D17inSensedSignalAspect.Value ==
              FObserveSignalAspect_D17inSensedSignalAspectValue__NoSignalAspect)));
  self->Change118.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D17inSensedSignalAspect.IsSignalled,
          self->D17inSensedSignalAspect.Value ==
              FObserveSignalAspect_D17inSensedSignalAspectValue__NoSignalAspectLampFailure),
  ...
  self->Change114.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D17inSensedSignalAspect.Value ==
          FObserveSignalAspect_D17inSensedSignalAspectValue__MostRestrictAspect));
  self->Change117.IsTriggered = IsTriggered(OrChange(
      MakeChange(
          self->D17inSensedSignalAspect.IsSignalled,
          self->D17inSensedSignalAspect.Value ==
              FObserveSignalAspect_D17inSensedSignalAspectValue__NoSignalAspectLampFailure),
  ...
  self->Change124.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D17inSensedSignalAspect.Value ==
          FObserveSignalAspect_D17inSensedSignalAspectValue__SignalAspect2));
  self->Change136.IsTriggered =
      IsTriggered(MakeChange(self->D18inSensedIntentionallyDark.IsSignalled,
                             self->D18inSensedIntentionallyDark.Value));
  self->Change561.IsTriggered = IsTriggered(
      NegateChange(MakeChange(self->D18inSensedIntentionallyDark.IsSignalled,
                              self->D18inSensedIntentionallyDark.Value)));
  self->Change349.IsTriggered = IsTriggered(
