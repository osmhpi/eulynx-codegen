...
typedef struct SSciLsCommandExpl {
  ...
  MessagePort(Message__CdIndicateSignalAspect__e570)
      OutCdIndicateSignalAspect__e570;
  MessagePort(Message__CdSetLuminosity__4570) OutCdSetLuminosity__4570;

  // Change Events
  ChangeEvent Change1015; // t23in_Signal_Aspect
  ChangeEvent Change1010; // t23in_Signal_Aspect
  ChangeEvent Change1014; // t23in_Signal_Aspect
  ChangeEvent Change1021; // t25in_Luminosity
  ChangeEvent Change1023; // t25in_Luminosity
