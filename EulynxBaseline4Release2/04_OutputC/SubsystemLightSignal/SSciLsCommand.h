...
typedef struct SSciLsCommand {
  ...
  // Change Events
  ChangeEvent Change1012; // t23in_Signal_Aspect
  ChangeEvent Change1013; // t23in_Signal_Aspect
  ChangeEvent Change1011; // t23in_Signal_Aspect
  ChangeEvent Change1024; // t25in_Luminosity
  ChangeEvent Change1022; // t25in_Luminosity
