...
typedef struct FObserveSignalAspect {
  ...
  DataPort(FObserveSignalAspect_D19outObservedSignalAspectValue, )
      D19outObservedSignalAspect;
  ...
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveSignalAspect_D17inSensedSignalAspectValue, )
      D17inSensedSignalAspect;
  ...
  ChangeEvent
      Change119; // D17in_Sensed_Signal_Aspect = "No Signal Aspect - lamp
                 // failure" OR D17in_Sensed_Signal_Aspect = "No Signal Aspect"
  ...
  ChangeEvent
      Change116; // D17in_Sensed_Signal_Aspect = "No Signal Aspect - lamp
                 // failure" OR D17in_Sensed_Signal_Aspect = "No Signal Aspect"
  ChangeEvent
      Change118; // D17in_Sensed_Signal_Aspect = "No Signal Aspect - lamp
                 // failure" OR D17in_Sensed_Signal_Aspect = "No Signal Aspect"
  ...
  ChangeEvent
      Change117; // D17in_Sensed_Signal_Aspect = "No Signal Aspect - lamp
                 // failure" OR D17in_Sensed_Signal_Aspect = "No Signal Aspect"
  ...
  ChangeEvent Change358; // d51in_EST_EfeS_State = "BOOTING"
                         // ORd51in_EST_EfeS_State = "INITIALISING"
  ChangeEvent Change393; // d51in_EST_EfeS_State = "NO_OPERATING_VOLTAGE" OR
