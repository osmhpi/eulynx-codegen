...
void make_state_SSciLsReceive__root__ReceivingLightSignalReports(
    SSciLsReceive *self, SSciLsReceive__root__state_struct *region) {
...
void make_state_SSciLsReceive__root(SSciLsReceive *self,
...
void transition_from_SSciLsReceive__root__ReceivingLightSignalReports(
    SSciLsReceive *self, SSciLsReceive__root__state_struct *x) {

  if (self->InMsgIndicatedSignalAspect__e129.HasMessage) {
    if ((self->InMsgIndicatedSignalAspect__e129.Value
             .ReportedSignalAspectState ==
         SignalAspectState__f566__SignalAspect1) &&
        (!(self->InMsgIndicatedSignalAspect__e129.Value.ReportedDarkState))) {
      self->D26outSignalAspect.Value =
  ...
  if (self->InMsgSetLuminosity__c2b4.HasMessage) {
    if (self->InMsgSetLuminosity__c2b4.Value.ReportedLuminosityState ==
...
void transition_from_SSciLsReceive__root(SSciLsReceive *self,
                                         SSciLsReceive__root__state_struct *x) {
  switch (x->state) {
