...
typedef struct SSciPReceive__root__Operating__PointPositionObserving__state_struct
{
...
typedef struct SSciPReceive__root__Operating__AbilityToMoveObserving__state_struct
{
...
typedef struct SSciPReceive__root__Operating__MovementFailedObserving__state_struct
{
...
{
    SSciPReceive__root__Operating__PointPositionObserving__state_struct PointPositionObserving;
    SSciPReceive__root__Operating__AbilityToMoveObserving__state_struct AbilityToMoveObserving;
    SSciPReceive__root__Operating__MovementFailedObserving__state_struct MovementFailedObserving;
