...
static FObserveOverallPointPosition_D22inPm1CrucialPositionValue
map_MemPm1CrucialPosition_to_D22inPm1CrucialPosition(
...
map_MemPm1nCrucialPosition_to_D23inPm1nCrucialPosition(
    FObserveOverallPointPosition_MemPm1nCrucialPositionValue value) {
  switch (value) {
...
map_D22inPm1CrucialPosition_to_MemPm1CrucialPosition(
...
static FObserveOverallPointPosition_MemPm1nCrucialPositionValue
map_D23inPm1nCrucialPosition_to_MemPm1nCrucialPosition(
...
static void evaluateChangeEvents(FObserveOverallPointPosition *self) {
  self->Change185.IsTriggered = IsTriggered(
      MakeChange(self->D22inPm1CrucialPosition.IsSignalled,
                 !(self->D22inPm1CrucialPosition.Value ==
                   map_MemPm1CrucialPosition_to_D22inPm1CrucialPosition(
                       self->MemPm1CrucialPosition))));
