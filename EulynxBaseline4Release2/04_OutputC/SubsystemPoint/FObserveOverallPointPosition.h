...
typedef struct FObserveOverallPointPosition {
  ...
  DataPort(FObserveOverallPointPosition_D14outObservedPointPositionValue, )
      D14outObservedPointPosition;

  /// D22in_PM1_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D22inPm1CrucialPositionValue, )
      D22inPm1CrucialPosition;

  /// D23in_PM1n_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D23inPm1nCrucialPositionValue, )
      D23inPm1nCrucialPosition;

  /// D24in_PM2_Non_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D24inPm2NonCrucialPositionValue, )
      D24inPm2NonCrucialPosition;

  /// D25in_PM2n_Non_Crucial_Position
  /// Trigger: False, DataPort: True, In: True, Out: False, External: True
  DataPort(FObserveOverallPointPosition_D25inPm2nNonCrucialPositionValue, )
      D25inPm2nNonCrucialPosition;

  /// d51in_EST_EfeS_State
  /// Trigger: False, DataPort: True, In: True, Out: False, External: False
  DataPort(FObserveOverallPointPosition_D51inEstEfesStateValue, )
      D51inEstEfesState;
  ...
  DataPort(
      FObserveOverallPointPosition_D19outObservedLastPointEndPositionValue, )
      D19outObservedLastPointEndPosition;
  ...
  /// Trigger: False, DataPort: False, In: False, Out: False, External: False
  FObserveOverallPointPosition_MemPm1nCrucialPositionValue
      MemPm1nCrucialPosition;

  /// Mem_PM2_Non_Crucial_Position
  /// Trigger: False, DataPort: False, In: False, Out: False, External: False
  FObserveOverallPointPosition_MemPm2NonCrucialPositionValue
      MemPm2NonCrucialPosition;

  /// Mem_PM2n_Non_Crucial_Position
  /// Trigger: False, DataPort: False, In: False, Out: False, External: False
  FObserveOverallPointPosition_MemPm2nNonCrucialPositionValue
      MemPm2nNonCrucialPosition;
  ...
  // Change Events
  ChangeEvent
      Change185; // D22in_PM1_Crucial_Position <> Mem_PM1_Crucial_Position
  ChangeEvent
      Change194; // D23in_PM1n_Crucial_Position <> Mem_PM1n_Crucial_Position
