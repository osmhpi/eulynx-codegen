...
static FControlNon4wPm_D12inRequiredPmPositionValue
map_D35inPmPosition_to_D12inRequiredPmPosition(
...
void make_state_FControlNon4wPm__root__Operating__root__MovingLeft(
    FControlNon4wPm *self,
    FControlNon4wPm__root__Operating__root__state_struct *region) {
...
void make_state_FControlNon4wPm__root__Operating__root(
    FControlNon4wPm *self,
...
void make_state_FControlNon4wPm__root__Operating(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *region) {
  LOG("[FControlNon4wPm] Entering state Operating in region root");
  region->state = FControlNon4wPm__root__Operating;
  make_state_FControlNon4wPm__root__Operating__root(self,
                                                    &region->Operating.root);
};

void make_state_FControlNon4wPm__root(FControlNon4wPm *self,
...
void transition_from_FControlNon4wPm__root__Operating__root__MovingLeft(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {

  if (self->Change70.IsTriggered) {
    if ((!(self->D12inRequiredPmPosition.Value ==
           map_D35inPmPosition_to_D12inRequiredPmPosition(
               self->D35inPmPosition.Value))) ||
      ...
      make_state_FControlNon4wPm__root__Operating__root__MovingRight(
  ...
  if (self->Change76.IsTriggered) {
    ...
    self->D38outMoveRight.Value = false;
    self->D34outDriveStop.Value = true;
    make_state_FControlNon4wPm__root__Operating__root__Stopped(
        self, &x->Operating.root);
    return;
  }
...
void transition_from_FControlNon4wPm__root__Operating__root__MovingRight(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
  ...
  if (self->Change62.IsTriggered) {
    if ((!(self->D12inRequiredPmPosition.Value ==
      ...
      self->D34outDriveStop.Value = false;
      make_state_FControlNon4wPm__root__Operating__root__MovingLeft(
          self, &x->Operating.root);
      return;
    }
  }
...
void transition_from_FControlNon4wPm__root__Operating__root__Stopped(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
...
void transition_from_FControlNon4wPm__root__Operating__root__Waiting(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
...
void transition_from_FControlNon4wPm__root__Operating__root(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
  ...
  case FControlNon4wPm__root__Operating__root__MovingRight:
    transition_from_FControlNon4wPm__root__Operating__root__MovingRight(self,
                                                                        x);
    break;
...
void transition_from_FControlNon4wPm__root__Operating(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
...
void transition_from_FControlNon4wPm__root(
    FControlNon4wPm *self, FControlNon4wPm__root__state_struct *x) {
  switch (x->state) {
...
static void evaluateChangeEvents(FControlNon4wPm *self) {
  ...
  self->Change80.IsTriggered =
      IsTriggered(MakeChange(self->D12inRequiredPmPosition.IsSignalled ||
                                 self->D35inPmPosition.IsSignalled,
                             self->D12inRequiredPmPosition.Value ==
                                 map_D35inPmPosition_to_D12inRequiredPmPosition(
                                     self->D35inPmPosition.Value)));
  ...
  self->Change77.IsTriggered = IsTriggered(MakeChange(
      self->D12inRequiredPmPosition.IsSignalled,
      self->D12inRequiredPmPosition.Value ==
          FControlNon4wPm_D12inRequiredPmPositionValue__Uncommanded));
  self->Change79.IsTriggered =
      IsTriggered(MakeChange(self->D12inRequiredPmPosition.IsSignalled ||
                                 self->D35inPmPosition.IsSignalled,
                             self->D12inRequiredPmPosition.Value ==
                                 map_D35inPmPosition_to_D12inRequiredPmPosition(
                                     self->D35inPmPosition.Value)));
  self->Change64.IsTriggered = IsTriggered(AndChange(
      MakeChange(self->D12inRequiredPmPosition.IsSignalled,
                 self->D12inRequiredPmPosition.Value ==
                     FControlNon4wPm_D12inRequiredPmPositionValue__Left),
      OrChange(MakeChange(self->D12inRequiredPmPosition.IsSignalled ||
                              self->D35inPmPosition.IsSignalled,
                          !(self->D12inRequiredPmPosition.Value ==
                            map_D35inPmPosition_to_D12inRequiredPmPosition(
                                self->D35inPmPosition.Value))),
               AndChange(MakeChange(
                             self->D12inRequiredPmPosition.IsSignalled ||
                                 self->D35inPmPosition.IsSignalled,
                             self->D12inRequiredPmPosition.Value ==
                                 map_D35inPmPosition_to_D12inRequiredPmPosition(
                                     self->D35inPmPosition.Value)),
                         MakeChange(self->D37inConCommonDrive.IsSignalled,
                                    self->D37inConCommonDrive.Value)))));
  self->Change71.IsTriggered = IsTriggered(AndChange(
      MakeChange(self->D12inRequiredPmPosition.IsSignalled,
                 self->D12inRequiredPmPosition.Value ==
                     FControlNon4wPm_D12inRequiredPmPositionValue__Right),
      OrChange(MakeChange(self->D12inRequiredPmPosition.IsSignalled ||
  ...
  self->Change394.IsTriggered = IsTriggered(OrChange(
      OrChange(
          MakeChange(
