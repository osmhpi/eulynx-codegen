...
void make_state_SSciPReceive__root__Operating__PointPositionObserving(
    SSciPReceive *self,
    SSciPReceive__root__Operating__PointPositionObserving__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          SSciPReceive__root__Operating__PointPositionObserving__state_struct));
...
void make_state_SSciPReceive__root__Operating__AbilityToMoveObserving(
    SSciPReceive *self,
    SSciPReceive__root__Operating__AbilityToMoveObserving__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          SSciPReceive__root__Operating__AbilityToMoveObserving__state_struct));
...
void make_state_SSciPReceive__root__Operating__MovementFailedObserving(
    SSciPReceive *self,
    SSciPReceive__root__Operating__MovementFailedObserving__state_struct *x) {
  memset(
      x, 0,
      sizeof(
          SSciPReceive__root__Operating__MovementFailedObserving__state_struct));
...
void make_state_SSciPReceive__root__Operating(
    SSciPReceive *self, SSciPReceive__root__state_struct *region) {
  LOG("[SSciPReceive] Entering state Operating in region root");
  region->state = SSciPReceive__root__Operating;
  make_state_SSciPReceive__root__Operating__PointPositionObserving(
      self, &region->Operating.PointPositionObserving);
  make_state_SSciPReceive__root__Operating__AbilityToMoveObserving(
      self, &region->Operating.AbilityToMoveObserving);
  make_state_SSciPReceive__root__Operating__MovementFailedObserving(
      self, &region->Operating.MovementFailedObserving);
};

void make_state_SSciPReceive__root(SSciPReceive *self,
...
void transition_from_SSciPReceive__root__Operating__PointPositionObserving(
    SSciPReceive *self, SSciPReceive__root__state_struct *x) {
...
void transition_from_SSciPReceive__root__Operating__AbilityToMoveObserving(
    SSciPReceive *self, SSciPReceive__root__state_struct *x) {
  ...
  case SSciPReceive__root__Operating__AbilityToMoveObserving__ReceiveAbilityToMoveReport:
    transition_from_SSciPReceive__root__Operating__AbilityToMoveObserving__ReceiveAbilityToMoveReport(
        self, x);
    break;
  }
}
...
void transition_from_SSciPReceive__root__Operating__MovementFailedObserving(
    SSciPReceive *self, SSciPReceive__root__state_struct *x) {
  ...
  case SSciPReceive__root__Operating__MovementFailedObserving__ReceiveMovementFailedReport:
    transition_from_SSciPReceive__root__Operating__MovementFailedObserving__ReceiveMovementFailedReport(
        self, x);
    break;
  }
}

void transition_from_SSciPReceive__root__Operating(
    SSciPReceive *self, SSciPReceive__root__state_struct *x) {
  transition_from_SSciPReceive__root__Operating__PointPositionObserving(self,
                                                                        x);
  transition_from_SSciPReceive__root__Operating__AbilityToMoveObserving(self,
                                                                        x);
  transition_from_SSciPReceive__root__Operating__MovementFailedObserving(self,
                                                                         x);
}

void transition_from_SSciPReceive__root(SSciPReceive *self,
                                        SSciPReceive__root__state_struct *x) {
  switch (x->state) {
