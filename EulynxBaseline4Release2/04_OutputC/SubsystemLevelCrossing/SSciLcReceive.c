...
// Operations
static void Cop2GetMonitoringStatus(SSciLcReceive *self,
                                    ChangendMonitoringStatus__6c2c ParameterChangedMonitoringParameters,
                                    TimerOverrunState__b8ce ParameterTimerOverrun)
{
    if (ParameterChangedMonitoringParameters == ChangendMonitoringStatus__6c2c__MonitoringParameterSet1)
    {
        ...
        self->D62outMsgLcMonitoringStatusChangedMonitoringParameter.IsSignalled = true;
    }
    ...
    if (ParameterTimerOverrun == TimerOverrunState__b8ce__ClosureTimerOverrunOccured)
    {
        self->D61outMsgLcMonitoringStatusClosureTimer.Value =
            SSciLcReceive_D61outMsgLcMonitoringStatusClosureTimerValue__ClosureTimerOverrunOccurred;
        self->D61outMsgLcMonitoringStatusClosureTimer.IsSignalled = true;
    }
    else if (ParameterTimerOverrun == TimerOverrunState__b8ce__NoClosureTimerOverrun)
    {
        self->D61outMsgLcMonitoringStatusClosureTimer.Value =
...
static void Cop3GetFailureState(SSciLcReceive *self, NonCriticalFailureStatusState__b376 ParameterNonCriticalFailure,
...
void transition_from_SSciLcReceive__root__ReceivingLcReports(SSciLcReceive *self, SSciLcReceive__root__state_struct *x)
{
    ...
    if (self->InMsgDetectionElementStatus__aa8b.HasMessage)
    {
        ...
        {
            self->D18outMsgDetectionElementStatus.Value = SSciLcReceive_D18outMsgDetectionElementStatusValue__Failed;
    ...
    if (self->InMsgDetectionElementStatus__aa8b.HasMessage)
    {
        ...
        {
            self->D18outMsgDetectionElementStatus.Value = SSciLcReceive_D18outMsgDetectionElementStatusValue__Occupied;
            self->D18outMsgDetectionElementStatus.IsSignalled = true;
            self->T18outMsgDetectionElementStatus.Trigger = true;
            make_state_SSciLcReceive__root__ReceivingLcReports(self, x);
            return;
    ...
    if (self->InMsgDetectionElementStatus__aa8b.HasMessage)
    {
        ...
        {
            self->D18outMsgDetectionElementStatus.Value = SSciLcReceive_D18outMsgDetectionElementStatusValue__Vacant;
            self->D18outMsgDetectionElementStatus.IsSignalled = true;
            self->T18outMsgDetectionElementStatus.Trigger = true;
            make_state_SSciLcReceive__root__ReceivingLcReports(self, x);
            return;
    ...
    {
        Cop3GetFailureState(self, self->InMsgLcFailureStatus__5440.Value.ReportedNonCriticalFailureState,
    ...
    if (self->InMsgLcFunctionalStatus__ab8c.HasMessage)
    {
        ...
        {
            self->D5outMsgLcFunctionalStatus.Value = SSciLcReceive_D5outMsgLcFunctionalStatusValue__IsolatedLc;
    ...
    if (self->InMsgLcFunctionalStatus__ab8c.HasMessage)
    {
        ...
        {
            self->D5outMsgLcFunctionalStatus.Value = SSciLcReceive_D5outMsgLcFunctionalStatusValue__PreActivated;
            self->D5outMsgLcFunctionalStatus.IsSignalled = true;
            self->T5outMsgLcFunctionalStatus.Trigger = true;
            make_state_SSciLcReceive__root__ReceivingLcReports(self, x);
            return;
    ...
    {
        if (self->InMsgLcFunctionalStatus__ab8c.Value.ReportedActivationlStatusState ==
            FunctionalStatusState__5d12__DeactivatedAndUnprotected)
        {
            self->D5outMsgLcFunctionalStatus.Value =
    ...
    {
        Cop2GetMonitoringStatus(self, self->InMsgLcMonitoringStatus__1d45.Value.ReportedChangedMonitoringParameter,
                                self->InMsgLcMonitoringStatus__1d45.Value.ReportedTimerOverrunState);
...
static void resetOutputs(SSciLcReceive *self)
{
    ...
    self->D61outMsgLcMonitoringStatusClosureTimer.IsSignalled = false;
