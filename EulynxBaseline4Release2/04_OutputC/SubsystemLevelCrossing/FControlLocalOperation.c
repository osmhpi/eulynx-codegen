...
static void evaluateChangeEvents(FControlLocalOperation *self) {
  self->Change484.IsTriggered = IsTriggered(MakeChange(
  ...
  self->Change486.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change490.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
  ...
  self->Change483.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Established));
  self->Change489.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__NoHandover));
  self->Change491.IsTriggered = IsTriggered(MakeChange(
      ...
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__NoHandover));
  self->Change487.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change488.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Initiated));
  self->Change485.IsTriggered = IsTriggered(MakeChange(
      self->D8inHandoverToLocalOperatorState.IsSignalled,
      self->D8inHandoverToLocalOperatorState.Value ==
          FControlLocalOperation_D8inHandoverToLocalOperatorStateValue__Established));
