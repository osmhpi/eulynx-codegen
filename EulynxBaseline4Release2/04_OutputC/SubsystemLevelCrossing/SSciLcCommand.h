...
typedef struct SSciLcCommand
{
    ...
    /// Trigger: False, DataPort: True, In: True, Out: False, External: False
    DataPort(SSciLcCommand_D3inCdLocalOperationHandoverValue, ) D3inCdLocalOperationHandover;

    /// d50in_PDI_Connection_State
    /// Trigger: False, DataPort: True, In: True, Out: False, External: False
    DataPort(SSciLcCommand_D50inPdiConnectionStateValue, ) D50inPdiConnectionState;
    ...
    /// D84in_Con_Use_Local_Operation
    /// Trigger: False, DataPort: True, In: True, Out: False, External: True
    DataPort(bool, ) D84inConUseLocalOperation;
    ...
    MessagePort(Message__CdLocalOperationHandover__2b72) OutCdLocalOperationHandover__2b72;
    MessagePort(Message__CdIsolateLc__add9) OutCdIsolateLc__add9;

    // Change Events
    ChangeEvent Change870;  // t1in_Cd_Activation
    ChangeEvent Change871;  // t1in_Cd_Activation
    ChangeEvent Change1066; // t2in_Cd_Deactivation
    ChangeEvent Change1148; // t3in_Cd_Local_Operation_Handover
    ChangeEvent Change1146; // t3in_Cd_Local_Operation_Handover
    ChangeEvent Change1147; // t3in_Cd_Local_Operation_Handover
    ChangeEvent Change1199; // t4in_Cd_Isolate_LC
    ChangeEvent Change1200; // t4in_Cd_Isolate_LC
