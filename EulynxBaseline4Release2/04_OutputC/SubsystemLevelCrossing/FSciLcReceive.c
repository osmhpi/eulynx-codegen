...
void make_state_FSciLcReceive__root__FallbackMode(FSciLcReceive *self, FSciLcReceive__root__state_struct *region)
{
...
void transition_from_FSciLcReceive__root__FallbackMode(FSciLcReceive *self, FSciLcReceive__root__state_struct *x)
{
...
{
    self->Change433.IsTriggered =
        IsTriggered(MakeChange(self->D53inTimerExpired.IsSignalled,
                               self->D53inTimerExpired.Value == FSciLcReceive_D53inTimerExpiredValue__TimerExpired));
    self->Change342.IsTriggered =
