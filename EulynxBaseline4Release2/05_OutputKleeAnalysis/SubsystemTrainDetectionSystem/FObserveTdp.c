...
void count_transitions_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern(
    int *ctr, FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    int maxSubregionTransitions = 0;
    int tmp;
    ...
    int *ctr, FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    case FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern:
        count_transitions_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithDirection__root__MonitoringTdpWithDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern(
            ctr, self, x);
        break;
    }
}
...
void count_transitions_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern(
    int *ctr, FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    int maxSubregionTransitions = 0;
    int tmp;
    ...
    int *ctr, FObserveTdp *self, FObserveTdp__root__state_struct *x)
{
    ...
    case FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern:
        count_transitions_from_FObserveTdp__root__NotFailed__root__Operational__root__TdpWithoutDirection__root__MonitoringTdpWithoutDirection__root__WaitingDelayOfNotificationOfUninterpretablePattern(
            ctr, self, x);
        break;
    }
}
